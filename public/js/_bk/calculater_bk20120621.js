...
// debug
	...
	function calc(val) {
		...
		if( getPrint() == "ari_print" ){
			print_charge = 6000;
			silk_print = this.vno_of_order * 20
		}
		///campaign用///
...
// リファクタ対象　ここから
	function setColor(){
		...
		switch(itemType) {
			case "strap":
				// Base color
				if (this.vno_of_order < 100 && itemPCS == "1" ){
						document.getElementById('ST_1').style.background = "pink";
				} else if ( this.vno_of_order < 100 && itemPCS == "2" ){
						document.getElementById('ST_8').style.background = "pink";
				} else	if (this.vno_of_order < 300 && itemPCS == "1" ){
						...
						document.getElementById('ST_13').style.background = "pink";
				} else if (this.vno_of_order >= 5000 && itemPCS == "1" ){
						document.getElementById('ST_7').style.background = "pink";
				} else if (this.vno_of_order >= 5000 && itemPCS == "2" ){
						document.getElementById('ST_14').style.background = "pink";
				}
				...
				if(this.vno_of_order < 100){
				...
				} else if (this.vno_of_order >= 100 && this.vno_of_order < 300) {
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
					...
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'ST_C7' ).style.background = "pink";
						}
					}
				}
			break;
			...
			/*case "cleaner_print":
				...
				if (this.vno_of_order < 300){
					document.getElementById('CP_1').style.background = "pink";
				} else if (this.vno_of_order < 500){
					document.getElementById('CP_2').style.background = "pink";
				} else if (this.vno_of_order < 1000){
					document.getElementById('CP_3').style.background = "pink";
				} else if (this.vno_of_order < 3000){
					document.getElementById('CP_4').style.background = "pink";
				} else if (this.vno_of_order < 5000){
					document.getElementById('CP_5').style.background = "pink";
				} else if (this.vno_of_order >= 5000){
					document.getElementById('CP_6').style.background = "pink";
				}*/
				...
				if(this.vno_of_order < 300){
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_P1' ).style.background = "pink";
						}
					}
				} else if (this.vno_of_order >= 300 && this.vno_of_order < 500) {
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_P2' ).style.background = "pink";
						}
					}
				} else if (this.vno_of_order >= 500 && this.vno_of_order < 1000) {
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_P3' ).style.background = "pink";
						}
					}
				} else if (this.vno_of_order >= 1000 && this.vno_of_order < 3000) {
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_P4' ).style.background = "pink";
						}
					}
				} else if (this.vno_of_order >= 3000 && this.vno_of_order < 5000) {
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_P5' ).style.background = "pink";
						}
					}
				} else if (this.vno_of_order >= 5000) {
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_P6' ).style.background = "pink";
						}
					}
				}
			break;
			case "cleaner_rubber":
				...
				if (this.vno_of_order < 300){
					...
					document.getElementById('CR_6').style.background = "pink";
				}
				...
				if(this.vno_of_order < 300){
					...
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'CL_R6' ).style.background = "pink";
						}
					}
				}
			break;
			...
			case "keykaba":
				...
				if(this.vno_of_order < 100){
					...
					for(var i = 4; i <= 8; i ++){
						if(vcolor.value == i){
							document.getElementById( (i - 3) + 'KB_R7' ).style.background = "pink";
						}
					}
				}
			break;
...
function clearColor(){
	...
	for( var i=1; i<=14; i++ ){
		...
		if( i < 7){
			//document.getElementById( 'CP_' + i ).style.background = "white";  //cleaner print
			document.getElementById( 'CR_' + i ).style.background = "white";  //cleaner rubber
		}
		for( var j = 1; j <= 5; j++ ) {
			if( i < 7 ) {
				//document.getElementById( j + 'CL_P' + i ).style.background = "white";  //cleaner print
				document.getElementById( j + 'CL_R' + i ).style.background = "white";  //cleaner rubber
			}
			if( i < 8 ){
				document.getElementById( j + 'ST_C' + i ).style.background = "white";  //strap, coaster,keykaba
