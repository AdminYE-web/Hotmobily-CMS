	var i1_std_1 = [385, 286, 253, 231, 220, 209];
	var i1_std_2 = [396, 297, 264, 242, 231, 220];
	var i1_prm_1 = [396, 297, 264, 242, 231, 220];
	var i1_prm_2 = [407, 308, 275, 253, 242, 231];
	var i1_rcy_1 = [418, 319, 286, 259, 245, 234];
	var i1_rcy_2 = [429, 330, 297, 270, 256, 245];
	...
	function setToInput(){
		...
		// strap
		if ($('input[name=cth_type]:checked').val() == "昇華転写印刷") {
			...
			}else if($('input[name=cth_option]:checked').val() == "リサイクル材"){
				if ($('input[name=cth_size]:checked').val() == "90") {
					if (vno_of_order.value >= 5000) order_pcs = i1_rcy_1[5];
					else if (vno_of_order.value >= 3000) order_pcs = i1_rcy_1[4];
					else if (vno_of_order.value >= 1000) order_pcs = i1_rcy_1[3];
					else if (vno_of_order.value >= 500) order_pcs = i1_rcy_1[2];
					else if (vno_of_order.value >= 300) order_pcs = i1_rcy_1[1];
					else if (vno_of_order.value >= 100) order_pcs = i1_rcy_1[0];
				}else if($('input[name=cth_size]:checked').val() == "100"){
					if (vno_of_order.value >= 5000) order_pcs = i1_rcy_2[5];
					else if (vno_of_order.value >= 3000) order_pcs = i1_rcy_2[4];
					else if (vno_of_order.value >= 1000) order_pcs = i1_rcy_2[3];
					else if (vno_of_order.value >= 500) order_pcs = i1_rcy_2[2];
					else if (vno_of_order.value >= 300) order_pcs = i1_rcy_2[1];
					else if (vno_of_order.value >= 100) order_pcs = i1_rcy_2[0];
				}
			}
		}

		switch($('input[name=cth_type]:checked').val()){
			case "昇華転写印刷": var prd_basic_price = 0;break;
		}
		...
		if($('input[name=cth_size]').length && $('input[name=cth_size]:checked').val()!=undefined){
			if($('input[name=cth_size]:checked').val() == "90"){
				$('#sample-prd-size').text('90x180mm.');
				$('#prd_size').text('90x180mm.');
			}else if($('input[name=cth_size]:checked').val() == "100"){
				$('#sample-prd-size').text('100x180mm.');
