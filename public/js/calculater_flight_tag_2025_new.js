	...
	var ft_1 = [737,554,349,291,234,180];

	// var ft_2 = [693,506,264,214,170,132];
	var ft_2 = [706,529,310,248,198,145];

	// var ft_3 = [638,418,220,187,176,154];
	var ft_3 = [631,451,279,231,185,139];

	// オリジナル刺繍ワッペン・パッチ
	var wp_1 = [737,554,349,291,234,180];
	var wp_2 = [706,529,310,248,198,145];

	// 刺繍キーホルダー
	var kh_1 = [737,554,349,291,234,180];
	var kh_2 = [706,529,310,248,198,145];

	// オリジナル刺繍バッジ
	var bg_1 = [737,554,349,291,234,180];
	var bg_2 = [706,529,310,248,198,145];

	// 刺繍コースター
	var ct_1 = [737,554,349,291,234,180];
	var ct_2 = [706,529,310,248,198,145];
