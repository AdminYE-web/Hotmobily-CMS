...
var i1_std_1 = [322,276,237,188,157,150];
var i1_std_2 = [338,289,250,202,169,164];
	...
	function setToInput(){
		...
		$('#sample-prd-prdt').text($('input[name=cth_type]:checked').val());
		$('#prd_production').text($('input[name=cth_type]:checked').val());
