    ...
    var priceA = [2089, 1976, 1878, 1789, 1700, 1620];
    var priceB = [2173, 2087, 2010, 1921, 1833, 1758];
  ...
  return japanNow >= start && japanNow <= end;
	...
	function setToInput(){
		...
		if(vno_of_order.value != "" && $('input[name=shape_processing]:checked').val() == "レーザー加工") { 
		...
		}else if(vno_of_order.value != "" && $('input[name=shape_processing]:checked').val() == "フルカラー（3DUV印刷）") {
