...
var price_keyholder_standard = [437,358,279,230,183,133,115];
var price_keyholder_premium = [600,400,365,335,257,184,140];

var price_earphone_standard = [437,358,279,230,183,133,115];
var price_earphone_premium = [600,400,365,335,257,184,140];

var price_keykaba_standard = [889,682,474,348,256,191,143];	
var price_keykaba_premium = [988,769,549,408,304,227,167];

var price_cleaner_rubber_standard = [560,410,350,290,240,200,174,156];
var price_cleaner_rubber_premium = [820,590,505,425,356, 271,226,190];

var price_coaster_standard = [1550,1300,1073,668,570,570,570,570,472,391,310,256,221,185,163];
...
var price_phonestand_l_premium = [1326,1064,777,631,479,346,316];

var price_tag_standard = [272,176,168,160,128,108,92];
var price_tag_premium = [532,356,323,295,206,147,112];

var price_pbholder_standard = [869,896,500,373,277,213,178];
var price_pbholder_premium = [1156,1076,655,508,393,318,281];

var price_rubber_frame = [1300,1060,770,650,468,354,297];
...
function setToInput(){
	...
	//cleaner_rubber
		...
		if ($('#pcs1').is(':checked') || $('#pcs4').is(':checked')){
			if (vno_of_order.value >=5000) order_pcs = price_cleaner_rubber_standard[7];
			else if(vno_of_order.value >=3000) order_pcs = price_cleaner_rubber_standard[6];
			else if(vno_of_order.value >=2000) order_pcs = price_cleaner_rubber_standard[5];
		...
		if ($('#pcs2').is(':checked')) {
			if (vno_of_order.value >=5000) order_pcs = price_cleaner_rubber_premium[7];
			else if(vno_of_order.value >=3000) order_pcs = price_cleaner_rubber_premium[6];
			else if(vno_of_order.value >=2000) order_pcs = price_cleaner_rubber_premium[5];
	...
	//coaster
		...
		if ($('#pcs1').is(':checked') || $('#pcs4').is(':checked')){
			...
			else if(vno_of_order.value >=3000) order_pcs = price_coaster_standard[13];
			else if(vno_of_order.value >=1000) order_pcs = price_coaster_standard[12];
			else if(vno_of_order.value >=500) order_pcs = price_coaster_standard[11];
			else if(vno_of_order.value >=300) order_pcs = price_coaster_standard[10];
			else if(vno_of_order.value >=200) order_pcs = price_coaster_standard[9];
			else if(vno_of_order.value >=100) order_pcs = price_coaster_standard[8];

			else if(vno_of_order.value >=90) order_pcs = price_coaster_standard[7];
			else if(vno_of_order.value >=80) order_pcs = price_coaster_standard[6];
			else if(vno_of_order.value >=70) order_pcs = price_coaster_standard[5];
			else if(vno_of_order.value >=60) order_pcs = price_coaster_standard[4];
			else if(vno_of_order.value >=50) order_pcs = price_coaster_standard[3];
			else if(vno_of_order.value >=40) order_pcs = price_coaster_standard[2];
			else if(vno_of_order.value >=30) order_pcs = price_coaster_standard[1];
	...
	//phone stand
		...
		if (($('#pcs1').is(':checked') || $('#pcs4').is(':checked')) && $('input[name=ItemSize]:checked').val()=='小サイズ'){
		...
		if ($('#pcs2').is(':checked') && $('input[name=ItemSize]:checked').val()=='小サイズ') {
		...
		if (($('#pcs1').is(':checked') || $('#pcs4').is(':checked')) && $('input[name=ItemSize]:checked').val()=='大サイズ'){
		...
		if ($('#pcs2').is(':checked') && $('input[name=ItemSize]:checked').val()=='大サイズ') {
	...
	// rubber pbholder
		...
		if ($('#pcs1').is(':checked') || $('#pcs4').is(':checked')) {
			...
			else if (vno_of_order.value >= 3000) order_pcs = price_pbholder_standard[5];
			else if (vno_of_order.value >= 1000) order_pcs = price_pbholder_standard[4];
			else if (vno_of_order.value >= 500) order_pcs = price_pbholder_standard[3];
			else if (vno_of_order.value >= 300) order_pcs = price_pbholder_standard[2];
			else if (vno_of_order.value >= 200) order_pcs = price_pbholder_standard[1];
			else if (vno_of_order.value >= 100) order_pcs = price_pbholder_standard[0];
		}
		if ($('#pcs2').is(':checked')) {
			if (vno_of_order.value >= 5000) order_pcs = price_pbholder_premium[6];
			else if (vno_of_order.value >= 3000) order_pcs = price_pbholder_premium[5];
			else if (vno_of_order.value >= 1000) order_pcs = price_pbholder_premium[4];
			else if (vno_of_order.value >= 500) order_pcs = price_pbholder_premium[3];
			else if (vno_of_order.value >= 300) order_pcs = price_pbholder_premium[2];
			else if (vno_of_order.value >= 200) order_pcs = price_pbholder_premium[1];
			else if (vno_of_order.value >= 100) order_pcs = price_pbholder_premium[0];
		}
	}
	...
	if($('input[name=coating]').length && $('input[name=coating]:checked').val()!=undefined){
		...
		if($('input[name=coating]:checked').val() == "汚れ防止加工なし"){
			...
			coating_charge = Math.floor(90*(1+vat/100));
		}
	}
	...
	if($('#pcs1').length){
		if(($('#pcs1').is(':checked') || $('#pcs4').is(':checked')) && ItemType != "スマホラバークリーナー" && ItemType != "ラバータグ" && ItemType != "ペットボトルホルダー"){
			...
			if($('#ariprint').length && print_umu.checked){ print_charge = (vno_of_order.value)*Math.floor(30*(1+vat/100));}
