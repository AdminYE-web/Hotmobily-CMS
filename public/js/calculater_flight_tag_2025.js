...
var ft_1 = [670, 504, 317, 265, 213, 164];

// var ft_2 = [693,506,264,214,170,132];
var ft_2 = [642, 481, 282, 225, 180, 132];

// var ft_3 = [638,418,220,187,176,154];
var ft_3 = [574, 410, 254, 210, 168, 126];

// オリジナル刺繍ワッペン・パッチ
var wp_1 = [670, 504, 317, 265, 213, 164];
var wp_2 = [642, 481, 282, 225, 180, 132];

// 刺繍キーホルダー
var kh_1 = [670, 504, 317, 265, 213, 164];
var kh_2 = [642, 481, 282, 225, 180, 132];

// オリジナル刺繍バッジ
var bg_1 = [670, 504, 317, 265, 213, 164];
var bg_2 = [642, 481, 282, 225, 180, 132];

// 刺繍コースター
var ct_1 = [670, 504, 317, 265, 213, 164];
var ct_2 = [642, 481, 282, 225, 180, 132];
...
function setToInput() {
	...
	if (vno_of_order.value != "") {
		...
		if ($('input[name=ItemType]').val() == "フライトタグ（刺繍タグキーホルダー）") {
			...
			} else if ($('input[name=ft_type]:checked').val() == "昇華転写") {
				if (vno_of_order.value >= 3000) order_pcs = ft_3[5];
				else if (vno_of_order.value >= 1000) order_pcs = ft_3[4];
				else if (vno_of_order.value >= 500) order_pcs = ft_3[3];
				else if (vno_of_order.value >= 300) order_pcs = ft_3[2];
				else if (vno_of_order.value >= 100) order_pcs = ft_3[1];
				else if (vno_of_order.value >= 50) order_pcs = ft_3[0];
			}
		}
