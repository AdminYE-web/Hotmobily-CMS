// Rubber printed
var price_candy_sticker_standard = [1153, 744, 574, 476, 366, 279];
...
//   }
  ...
  if (vno_of_order.value != "") {
    ...
    if (vno_of_order.value >= 10000)
        order_pcs = price_candy_sticker_standard[5];
    else if (vno_of_order.value >= 6000)
    ...
    document.getElementById("textfield_candy").value = formatMoney(candy_daishe_price);
