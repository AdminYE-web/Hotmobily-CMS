    ...
    // var priceA = [1205, 1056, 999, 941];
    // var priceB = [1000, 1000, 1000, 1000];

	var priceA = [592, 467, 414, 362];
    var priceB = [592, 467, 414, 362];
	...
	function setToInput(){
		...
		if(vno_of_order.value != "" && $('input[name=ItemSize]:checked').val() == "100x150mm") { 
		...
		}else if(vno_of_order.value != "" && $('input[name=ItemSize]:checked').val() == "160x204mm") {
        ...
        $('#sample-air').text($('input[name=air_items]:checked').val());
        $('#prd_air').text($('input[name=air_items]:checked').val());
		...
		TextField9Value = parseInt(TextField7Value) + trace_charge + proto_charge + (opp_price*vno_of_order.value);
		DisPrice = 0;
