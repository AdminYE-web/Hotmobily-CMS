...
<body>
	...
	<div id="container">
		<div class="container">
			...
			<div class="content">
				...
				<h2>ตรวจสอบราคา</h2>
				<p>โปรแกรมคำนวนราคาซองใส่บัตรพนักงานแบบต่างๆทั้งซองใส่บัตรแนวตั้งและซองใส่บัตรแนวนอน โดย<span class="red">เลือกแบบซองใส่บัตรที่ต้อง</span>-> <span class="red">ใส่จำนวน</span> -> <span class="red">กดคำนวนราคา(เลือกแบบซองใส่บัตรเพื่อดูภาพแต่ละซองใส่บัตร)</span></p>
				...
				<div class="btn-ctu"><a href="javascript:void(0)" class="btn-s1" id="cal_case">คำนวนราคา</a></div>
				<span class="red" id="show-price"></span>
			</div>
		</div>
	</div>
	<!--footer-->
	...
	<script type="text/javascript" src="js/calculate.js?v=1.01"></script>
</body>
</html>
