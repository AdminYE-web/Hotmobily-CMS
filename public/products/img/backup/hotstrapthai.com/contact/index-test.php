	...
	<div class="contact" id="container">
		<div class="container">
			...
			<span>ที่อยู่ : 152 อาคารชาร์เตอร์ สแควร์ ถนนสาทรเหนือ แขวงสีลม เขตบางรัก กทม. 10500 <br>
				โทรศัพท์ : <a href="tel:02-637-8995" class="link2">02-637-8995</a>, <a href="tel:02-266-5929" class="link2">02-266-5929</a> (บัญชี) </span><br>
				<span class="blue">เวลาทำการ : จันทร์-ศุกร์ เวลา 08:30-17:30 น.</span><br>
				<a href="http://line.me/ti/p/~youandearth.th" target="_blank"><span class="green">Line id: youandearth.th</span></a></div>
			<div style="clear: both;">&nbsp;</div>
			...
			<!--form mobile-->
			<div class="mobile">
				 <form action="confirm.php" method="post" name="form" id="cont" style="display: -webkit-box;">
					<?php
					$prd = "";$sale = "";$oth="";$urg="";
					if(isset($_SESSION["customer_data"]['subject'])){
						$tmp = $_SESSION["customer_data"]['subject'];
					...
					<table class="tbl-txt tbl-cont">
						<tr>
							<td class="td3"><span class="red">*</span><?php lang("subject",$_SESSION["lang"]) ?></td></tr>
						<tr>
							<td class="td4">
								<label class="label-radio">
									<?php lang("about_prd",$_SESSION["lang"]) ?>
								...
								<label class="label-radio">
									<?php lang("others",$_SESSION["lang"]) ?>
									<input type="radio" name="subject" value="other" style="width: 70%; margin: auto;" <?=$oth?>>
									<span class="checkmark"></span>
								</label>
								<input type="text" name="other"  style="width: 70%;" value="<?=(isset($_SESSION["customer_data"]['other']))?$_SESSION["customer_data"]['other']:"";?>" placeholder="<?php lang("typing",$_SESSION["lang"]) ?>"><br/>
								<label class="label-radio">
									<?php lang("urgent",$_SESSION["lang"]) ?>
									<input type="checkbox" name="urgent" value="1" <?=$urg?>>
									<span class="checkmark"></span>
						...
						<tr>
							<td class="td3"><span class="red">*</span><?php lang("name",$_SESSION["lang"]) ?></td></tr>
						<tr>
							<td class="td4"><input type="text" name="name" value="<?=(isset($_SESSION["customer_data"]['name']))?$_SESSION["customer_data"]['name']:"";?>" placeholder="<?php lang("name",$_SESSION["lang"]) ?>" required><br/></td>
						</tr>
						<tr>
							<td class="td3"><span class="red">*</span><?php lang("company",$_SESSION["lang"]) ?></td></tr>
						<tr>
							<td class="td4"><input type="text" name="company" value="<?=(isset($_SESSION["customer_data"]['company']))?$_SESSION["customer_data"]['company']:"";?>" placeholder="<?php lang("company",$_SESSION["lang"]) ?>" required><br/></td>
						</tr>
						<tr>
							<td class="td3"><span class="red">*</span><?php lang("email",$_SESSION["lang"]) ?></td></tr>
						<tr>
							<td class="td4"><input type="email" name="email" value="<?=(isset($_SESSION["customer_data"]['email']))?$_SESSION["customer_data"]['email']:"";?>" placeholder="<?php lang("email",$_SESSION["lang"]) ?>" required><br/></td>
						</tr>
						<tr>
							<td class="td3"><span class="red">*</span><?php lang("phone",$_SESSION["lang"]) ?></td></tr>
						<tr>
							<td class="td4"><input type="text" name="phone" value="<?=(isset($_SESSION["customer_data"]['phone']))?$_SESSION["customer_data"]['phone']:"";?>" placeholder="<?php lang("phone",$_SESSION["lang"]) ?>" required><br/></td>
						</tr>
						<tr>
							<td class="td3"><?php lang("fax",$_SESSION["lang"]) ?></td></tr>
						<tr>
							<td class="td4"><input type="text" name="fax" value="<?=(isset($_SESSION["customer_data"]['fax']))?$_SESSION["customer_data"]['fax']:"";?>" placeholder="<?php lang("fax",$_SESSION["lang"]) ?>"><br/></td>
						</tr>
						<tr>
							<td class="td3">แนบไฟล์(ขนาดไม่เกิน 2 mb.)<br/><span class="red">(เลือกไฟล์และกดปุ่ม upload)</span></td></tr>
						<tr>
							<td class="td4">
								<div class="row">
    								<div class="col-8" style="padding: 0; text-align: center;"><input type="file" name="file[]"></div>
     								<div class="col-4" style="padding: 0; text-align: center;"> <input type="button" id="submit-btn" value="upload" onclick="upload();"></div>
									<span id="result"><?php if(!empty($_SESSION["customer_data"]['tmpfile_cont'])||!empty($_SESSION['filename_cont'])){
						            foreach($_SESSION["customer_data"]['tmpfile_cont'] as $key => $value) {
						            echo $value." <input type='button' value='ลบ' onclick='remove(".$key.")'><br/>";}}?></span>
						        </div>								
							</td>
						</tr>
						<tr>
							<td class="td3"><span class="red">*</span><?php lang("message",$_SESSION["lang"]) ?><span class="green">(หากต้องการใบเสนอราคากรุณาระบุขนาด, สีและแบบตัวล็อคที่ต้องการขอบคุณครับ)</span></td></tr>
						<tr>
							<td class="td4"><textarea name="message" id="txt-area" required><?=(isset($_SESSION["customer_data"]['message']))?$_SESSION["customer_data"]['message']:"";?></textarea></td>
						</tr>
						<tr>
