                ...
                <div class="content">
                    ...
                    <div class="row-bs" style="justify-content: space-evenly;">
                        <div class="col-md-2 col-3"> 
                            <img src="img/neckset-pic1.jpg" class="img_center w-neck">                           
                            <div class="cap-text">
                                <img src="img/neckset-pic-cap.png" class="img_center w-cap">
                                <div class="centered">สายคล้องคอ</div>
                            </div>
                        </div>                        
                        <div class="col-1 d-none d-md-block">
                            <img src="img/neckset-pic-plus.png" class="img_center w-plus">
                        </div>
                        <div class="col-md-2 col-3"> 
                            <img src="img/neckset-pic2.jpg" class="img_center w-neck">
                            <div class="cap-text">
                                <img src="img/neckset-pic-cap.png" class="img_center w-cap">
                                <div class="centered">ตะขอมาตรฐาน</div>
                            </div>
                        </div>
                        <div class="col-1 d-none d-md-block">
                            <img src="img/neckset-pic-plus.png" class="img_center w-plus">
                        ...
                        <div class="col-md-2 col-3"> 
                            <img src="img/neckset-pic3.jpg" class="img_center w-neck">
                            <div class="cap-text">
                                <img src="img/neckset-pic-cap.png" class="img_center w-cap">
                        ...
                        <div class="col-md-2 col-3">
                            <img src="img/neckset-pic4.jpg" class="img_center w-neck">
                            <div class="cap-text">
                                <img src="img/neckset-pic-cap.png" class="img_center w-cap">
                                ...
                                <table class="zui-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="red f_tbl">3,120 บาท</span><br>156.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">3,680 บาท</span><br>122.67 บาท/เส้น</td>
                                            <td><span class="red f_tbl">4,800 บาท</span><br>96.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">6,700 บาท</span><br>67.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">10,000 บาท</span><br>50.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">12,200 บาท</span><br>40.67 บาท/เส้น</td>
                                            <td><span class="red f_tbl">16,000 บาท</span><br>32.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">23,000 บาท</span><br>23.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">42,000 บาท</span><br>21.00 บาท/เส้น</td>
                                            <td><span class="red f_tbl">59,000 บาท</span><br>19.67 บาท/เส้น</td>
                                        </tr>
                                        <tr>
