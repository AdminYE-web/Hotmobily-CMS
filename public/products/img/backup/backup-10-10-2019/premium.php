...
<head>
	...
	<link href="css/neckset.css" rel="stylesheet">
	<style type="text/css">
			...
			<div class="pd-main">
				...
				<div class="content">
					...
					*ขึ้นอยู่กับคลิปและตัวยึดที่ใช้ หากเป็นขนาดพิเศษ เช่น เชือกขนาด 20 mm และ 25 mm ไม่สามารถเลือกได้</p>
					...
					<div class="row-bs" style="justify-content: space-evenly;">
						<div class="col"> 
							<img src="img/neckpremium-1.jpg" class="img_center w-neck">                           
							<div class="cap-text">
								<img src="img/neckset-cap-red.png" class="img_center w-cap">
								<div class="centered">สายคล้องคอ</div>
							</div>
						</div>                        
						<div class="col d-none d-md-block">
							<img src="img/plus-red.png" class="img_center w-plus">
						</div>
						<div class="col"> 
							<img src="img/neckpremium-2.jpg" class="img_center w-neck">
							<div class="cap-text">
								<img src="img/neckset-cap-red.png" class="img_center w-cap">
								<div class="centered">บอลปรับระดับ</div>
							</div>
						</div>
						<div class="col d-none d-md-block">
							<img src="img/plus-red.png" class="img_center w-plus">
						...
						<div class="col"> 
							<img src="img/neckpremium-3.jpg" class="img_center w-neck">
							<div class="cap-text">
								<img src="img/neckset-cap-red.png" class="img_center w-cap">
								<div class="centered">สกรีนเรซิ่น 2 จุด</div>
							</div>
						</div>
						<div class="col d-none d-md-block">
							<img src="img/plus-red.png" class="img_center w-plus">
						...
						<div class="col">
							<img src="img/neckpremium-4.jpg" class="img_center w-neck">
							<div class="cap-text">
								<img src="img/neckset-cap-red.png" class="img_center w-cap">
								<div class="centered">ซองใส่บัตรแบบอ่อน</div>
							</div>
						</div>
						<div class="col d-none d-md-block">
							<img src="img/plus-red.png" class="img_center w-plus">
						...
						<div class="col">
							<img src="img/neckpremium-5.jpg" class="img_center w-neck">
							<div class="cap-text">
								<img src="img/neckset-cap-red.png" class="img_center w-cap">
								<div class="centered">บริการจัดส่งฟรี</div>
							</div>
						</div>
					</div>
						...
						<div class="zui-scroller scrollbar" id="style-1">
							<div class="force-overflow">
								<table class="zui-table">
									<thead>
										<tr>
											<th class="zui-sticky-col" style="background: #fff; font-size: 15px;">สกรีน <span class="red">1</span> สี</th>
											<th>20 เส้น</th>
											<th>30 เส้น</th>
											<th>50 เส้น</th>
											<th>100 เส้น</th>
									...
									<tbody>
										<tr>
											...
											<td><span class="red f_tbl">3,720 บาท</span><br>186.00 บาท/เส้น</td>
											<td><span class="red f_tbl">4,580 บาท</span><br>152.67 บาท/เส้น</td>
											<td><span class="red f_tbl">6,300 บาท</span><br>126.00 บาท/เส้น</td>
											<td><span class="red f_tbl">8,900 บาท</span><br>89.00 บาท/เส้น</td>
											<td><span class="red f_tbl">15,800 บาท</span><br>79.00 บาท/เส้น</td>
											<td><span class="red f_tbl">21,500 บาท</span><br>71.67 บาท/เส้น</td>
											<td><span class="red f_tbl">28,500 บาท</span><br>57.00 บาท/เส้น</td>
											<td><span class="red f_tbl">42,000 บาท</span><br>42.00 บาท/เส้น</td>
											<td><span class="red f_tbl">82,000 บาท</span><br>41.00 บาท/เส้น</td>
											<td><span class="red f_tbl">122,000 บาท</span><br>40.67 บาท/เส้น</td>
										</tr>
										<tr>
											<td class="zui-sticky-col">ขนาด <span class="red">15</span> mm.</td>
											<td><span class="red f_tbl">4,060 บาท</span><br>203.00 บาท/เส้น</td>
											<td><span class="red f_tbl">5,090 บาท</span><br>169.67 บาท/เส้น</td>
											<td><span class="red f_tbl">7,150 บาท</span><br>143.00 บาท/เส้น</td>
											<td><span class="red f_tbl">10,300 บาท</span><br>103.00 บาท/เส้น</td>
											<td><span class="red f_tbl">18,600 บาท</span><br>93.00 บาท/เส้น</td>
											<td><span class="red f_tbl">25,400 บาท</span><br>84.67 บาท/เส้น</td>
											<td><span class="red f_tbl">33,500 บาท</span><br>67.00 บาท/เส้น</td>
											<td><span class="red f_tbl">51,000 บาท</span><br>51.00 บาท/เส้น</td>
											<td><span class="red f_tbl">100,000 บาท</span><br>50.00 บาท/เส้น</td>
											<td><span class="red f_tbl">149,000 บาท</span><br>49.67 บาท/เส้น</td>
										</tr>
									</tbody>
								</table>
							</div>
					...
					<div class="row-bs">
						...
						<p>พาร์ทโยโย่หมาะสำหรับนำมาใช้กับบัตรพนักงาน หรือบัตร Security card นอกจากจะคล้องกับสายคล้องคอพนักงานได้แล้ว ยังสามารถนำมาติดกับกระเป๋าเสื้อได้อีกด้วย
							โยโย่หลากหลายสี ส่วนกลางของพาร์ทนั้นทำมาจากอีพ๊อกซี่ เรซิ่นสามารถสกีนโลโก้แบบซับลิเมชั่นลงไปได้ หรือจะไม่ใส่โลโก้ก็ได้เช่นกันและสามารถสั่งแยกจากเชือกก็สามารถทำได้ขั้นต่ำเพียง 20 ชิ้น <a href="javascript:void(0)" onclick="togg('yoyo')" class="link2">ดูข้อมูลเพิ่มเติม</a>
						</p>
						<div id="div_yoyo" class="div_t">
							...
							<div class="txt-price">
								...
								3) ราคาที่สั่งรวมกับสายคล้องคออาจจะมีค่าใช่จ่ายเพิ่มเติม
							</div>
						</div>
						<div class="btn-ctu">
							<a href="/orders/" class="btn-s1">สั่งซื้อสินค้า</a>
						...
						<div class="row-bs" id="box-show">
							<div class="col-sm-4 col-12">
								<div style="padding: 0 5px;">
									<img src="img/s_red1.jpg"><br/>สกรีนโลโก้คมชัดสามารถพิมพ์เครื่องหมายเล็กๆ เช่น ® หรือ TM ได้
								</div>
							</div>
							<div class="col-sm-4 col-12">
								<div style="padding: 0 5px;">
									<img src="img/s_red2.jpg"><br/>สกรีนโดยการยิง
								</div>
							</div>
							<div class="col-sm-4 col-12">
								<div style="padding: 0 5px;">
									<img src="img/s_red3.jpg"><br/>สกรีนแบบเรียบ
								</div>
							</div>
						</div>
						...
						<div class="row-bs" id="box-show2">
							<div class="col-sm-6 col-12" style="padding-bottom: 10px;">
								<div style="padding: 0 5px;">
									<img src="img/print_sample745_1.jpg" style="padding-bottom: 10px;"><br/>ภาพอ้างอิงการสกรีน 2 สี
								</div>
							</div>
							<div class="col-sm-6 col-12" style="padding-bottom: 10px;">
								<div style="padding: 0 5px;">
									<img src="img/print_sample745_2.jpg" style="padding-bottom: 10px;"><br/>ภาพอ้างอิงการสกรีน 5 สี
								</div>
							</div>
						</div>
