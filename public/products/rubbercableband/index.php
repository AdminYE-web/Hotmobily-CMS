...
$_SESSION['fd_name'] = 'rubbercableband';
?>
...
<head>
  ...
  <meta name="keywords" content="ケーブルバンド,オリジナルノベルティ制作,オリジナルグッズ制作,オリジナルデザイン,法人,個人">
  <meta name="description" content="オリジナルデザインでラバーケーブルバンドを制作いたします。法人様も個人様も大歓迎。自社のロゴや社名、オリジナルのキャラクターやイラストなどでケーブルバンドを制作。イベントでの配布ノベルティや店頭での販売グッズなど、幅広い用途でご利用頂けます。">
  <meta name="robots" content="index,follow" />
  <title>オリジナルケーブルバンド</title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1><?= lang('ケーブルバンドをオリジナルデザインで制作！汚れ防止加工も可能！') ?></h1>
      <div class="social-time">
        <span class="time-content"><?= lang('更新日') ?> 2026年8月3日</span>
      </div>
      <img src="images/cable_banner2.webp">
      <div>&nbsp;</div>
      <div class="flex-container">
        <div class="flex-item item">
          <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
            <swiper-slide><img onclick="openSimpleModal(this)" src="images/Top_redbike.webp"></swiper-slide>
            <swiper-slide><img onclick="openSimpleModal(this)" src="images/Top_catbike.webp"></swiper-slide>
            <swiper-slide><img onclick="openSimpleModal(this)" src="images/Top_backside.webp"></swiper-slide>
          </swiper-container>
        ...
        <div class="flex-item item" style="display:grid;line-height: 2;">
          <p>「自分たちのロゴやキャラクターでケーブルバンドを作りたい！」</p>
          <p>「ちょっとしたオリジナルグッズを店頭に置いて、お客様に手に取ってもらいたい！」</p>
          <p>そんなご要望に、私たちが応えます！</p><br/>

          <p>社名・店名・ロゴ・キャラクターなどをデザインしたラバー製ケーブルバンドは、ブランディングやプロモーションにぴったり。</p>
          <p>実用的で手頃な価格のアイテムなので、気の利いたデザインの製品を店頭に置いておけば、手に取って頂けるかもしれません。</p><br/>

          <p>私たちは、ラバー製品豊富な実績を持つ自社工場で一貫生産。</p>
          <p>安心・安全の確かな品質のラバーケーブルバンドを、業界最安クラスでご提供します。</p><br/>

          <p>人気の100個製作なら、48,000円（税込）といつでもお得！</p>
          <p>業界最短7営業日出荷だから、お急ぎの方にも安心です。</p><br/>

          <p>さらに、独自技術で汚れ防止加工も可能！</p>
          <p>大切なオリジナルデザインをより長くキレイに保てるように、当社独自の汚れ防止加工も承っています！</p><br/>
      ...
      <div style="clear:both;"></div>
        ...
        <div>
            <p class="new-text">いざラバーケーブルバンドをオリジナルのデザインで製作しようとして、「何に注意すればいいのかな？」「どんなデザインが製作可能なのかな？」などの不安や疑問に悩んでいる方もいますよね。</p><br>
            <p class="new-text">そんな方のために、ラバー製品をオリジナルデザインで製作するときの注意点や、失敗しないためのポイントなどを完全ガイドページで解説しています。</p><br>
            <p class="new-text">オリジナルのラバーケーブルバンドを満足のいく仕上がりで製作するために、ぜひともお役立てください。</p>
            <br>
      ...
      <div style="clear:both;"></div>
      <h2><?= lang('当店制作のラバーケーブルバンド') ?></h2>
      <div class="flex-container">
        <div class="flex-item item" style="margin-bottom:15px;">
          <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
            <swiper-slide>
              <a href="images/sample_cat01.webp" data-lightbox="sample_2" data-title="" style="text-decoration:none;">
                <img src="images/sample_cat01.webp?v=1.01">
              </a>
            </swiper-slide>
            <swiper-slide>
              <a href="images/sample_cat02.webp" data-lightbox="sample_2" data-title="" style="text-decoration:none;">
                <img src="images/sample_cat02.webp?v=1.01">
              </a>
            </swiper-slide>
        </div>
        <div class="flex-item item" style="margin-bottom:15px;">
          <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
            <swiper-slide>
              <a href="images/sample_bluebike01.webp" data-lightbox="sample_3" data-title="" style="text-decoration:none;">
                <img src="images/sample_bluebike01.webp?v=1.01">
              </a>
            </swiper-slide>
            <swiper-slide>
              <a href="images/sample_bluebike02.webp" data-lightbox="sample_3" data-title="" style="text-decoration:none;">
                <img src="images/sample_bluebike02.webp?v=1.01">
              </a>
            </swiper-slide>
        </div>
        ...
        <div class="flex-item item" style="margin-bottom:15px;">
          <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
            <swiper-slide>
              <a href="images/sample_redbike01.webp" data-lightbox="sample_4" data-title="" style="text-decoration:none;">
                <img src="images/sample_redbike01.webp?v=1.01">
              </a>
            </swiper-slide>
            <swiper-slide>
              <a href="images/sample_redbike02.webp" data-lightbox="sample_4" data-title="" style="text-decoration:none;">
                <img src="images/sample_redbike02.webp?v=1.01">
              </a>
            </swiper-slide>
        </div>
        <div class="flex-item item" style="margin-bottom:15px;">
          <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
            <swiper-slide>
              <a href="images/sample_sport01.webp" data-lightbox="sample_5" data-title="" style="text-decoration:none;">
                <img src="images/sample_sport01.webp?v=1.01">
              </a>
            </swiper-slide>
            <swiper-slide>
              <a href="images/sample_sport02.webp" data-lightbox="sample_5" data-title="" style="text-decoration:none;">
                <img src="images/sample_sport02.webp?v=1.01">
              </a>
            </swiper-slide>
        </div>
      </div>
      <hr>
      <h2><?= lang('ケーブルバンドとはどんなもの？') ?></h2>
      <p class="new-text">
      ケーブルバンドは、乱雑になりがちな電源コードやUSBケーブルなどをすっきりまとめられる便利なアイテムです。自社のロゴや社名、イラストを入れたオリジナルデザインで制作が可能。イベントでの配布グッズや店頭に置くオリジナルグッズなどのかたちで活用できるアイテムです。当社制作のラバー製ケーブルバンドは、柔軟性と耐久性に優れ、繰り返し使用可能。汚れ防止加工を施せば、キレイな状態で長く使えます。
      </p>
      <img src="images/cables.webp" width="100%">
      <div style="clear:both;">&nbsp;</div>
      <p class="new-text">
      裏面に留め具としてスナップが付いており、軽い力で留めることが可能です。
      </p>
      <img src="images/cableband_backside.webp" width="100%">
      <hr />
      ...
      <hr>
      <h2>当店ラバーケーブルバンドの強み</h2>
      <div>
        <h2 style="font-size: 21px;letter-spacing: 0.05em;line-height: 150%;">ラバー製品の実績多数！</h2>
        <p class="new-text">当店はこれまで、ラバーストラップやラバーキーホルダー、ラバーコースターなど、数多くのラバー製品を制作してまいりました。ラバーのプロである当店が、確かな品質のラバーケーブルバンドをお客様のもとにお届けいたします。</p>
        <div>&nbsp;</div>
        <h2 style="font-size: 21px;letter-spacing: 0.05em;line-height: 150%;">汚れ防止加工で長くキレイに使用可能！</h2>
        <p class="new-text">デスクまわりや持ち運びの際に使われるラバーケーブルバンドは、手垢やホコリが付着しやすいアイテムです。</p>
        <p class="new-text">「できるだけ長く清潔に使いたい」とご希望の方は、ぜひオプションの汚れ防止加工をお選びください。</p><br/>
            <div style="text-align: right;">
                <a href="https://hotmobily.jp/faq/details/rubberstrap/q4" class="new-text">汚れ防止加工の詳細はこちら</a>
            </div>
        <br>
        <p class="new-text">汚れがついても、ハンドソープと水でさっと落とせるため、製品の見た目を長くきれいに保てます。</p>
        <p class="new-text">また、一般的な汚れ防止加工は硬くて折れ曲がりにくいものが多い中、当社のラバー製品は柔軟性を損なわず、しなやかにケーブルの動きにフィットします。</p><br/>
        <p class="new-text">実用性と美観の両立を求める法人様に、最適な仕上がりです。</p>
        <div>&nbsp;</div>
      ...
      <div class="flex-container">
        ...
        <a href="/products/new-template/template-cableband.zip" class="resource-button" style="color: #233c4a">
      ...
      <div class="tbl_price_tg" style="position:relative;">
        ...
        制作プランは、スタンダード、スタンダード（スピード発送）、プレミアムの3つがあります。<br/><br/>
      ...
      <div style="overflow: unset!important;">
        <div class="fixed-contrainer">
          <h3 class="red">【<?= lang('ラバーケーブルバンド') ?>】</h3>
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;"><input type="text" name="ItemType" id="strap" value="ラバーケーブルバンド" /></div>
          <?php
          switch ($ItemPCS) {
            case "スタンダード":
          ...
          <div class="estimate-content" id="step1">
            ...
            <div>
                ...
                <div class="modal__inner modal1" style="height: fit-content;"><label class="modal__close" for="modal-4"></label>最下層の厚みは、通常2mmでございます。ハイインパクトの、製品単価はスタンダード+20％増、プレミアム+10％増、となります。
                </div>
                </div>
                <div class="part-container">
                <div class="part-content"><label class="part-name"><input type="radio" id="normal_size" name="ItemSize" value="通常（90*90/2mm厚）" <?php echo $tickness0_checked ?> onclick="clearValue();" /><?= lang('通常（2mm厚）') ?> <span class="checkmark"></span></label></div>
  ...
  <script type="text/javascript" language="javascript">
    ...
    $(function() {
      ...
      $('.tbl_price_deli.loading').load("../getdate_disp2023_v2", function(data) {
