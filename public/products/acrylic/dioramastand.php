...
<head>
    ...
    <meta name="keywords" content="ジオラマアクリルスタンド,ジオラマアクスタ">
    <meta name="description"
        content="ジオラマアクリルスタンドをオリジナルデザインで製作！推し活、同人グッズ、キャラグッズに最適。1個から製作可能、印刷を守る保護フィルム付き。複数パーツの組み合わせで世界観や臨場感を立体的に演出。アクスタを超えた自由度で表現の幅が広がります。">
    <meta name="robots" content="index,follow" />
    <title>ジオラマアクリルスタンド製作！推し活、同人グッズ、キャラグッズに</title>
    <link rel="canonical" href="https://hotmobily.jp/products/acrylic/dioramastand">
...
<body id="top">
    ...
    <div id="wrapper">
        ...
        <div id="content_wrapper" class="scrollingPanel">
            ...
            ?>
            <div id="">
                <h1 class="h1-new">ジオラマアクリルスタンド（2026年版）</h1>
            ...
            <div class="container">
                <div class="product-gallery" id="">
                    ...
                    <div class="pdp-v2-main-viewport">
                        <div class="pdp-v2-image-strip" id="pdp-v2-js-strip">
                            ...
                            <div class="pdp-v2-main-link" data-index="0">
                                ...
                                <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand01.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="1">
                                ...
                                <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand02.webp"
                            ...
                            <!-- <div class="pdp-v2-main-link" data-index="2">
                                ...
                                <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand03.jpg"
                            ...
                            <!-- <div class="pdp-v2-main-link" data-index="3">
                                ...
                                <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand04.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="2">
                                ...
                                <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand05.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="3">
                                ...
                                <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand06.webp"
                    ...
                    <div class="pdp-v2-thumb-grid" id="pdp-v2-js-grid-pc">
                        ...
                        <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand05.webp" alt="ラバーストラップ制作事例（ロゴ）"
                            class="pdp-v2-thumb-item" data-index="2" loading="lazy">
                        <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand06.webp"
                            alt="ラバーストラップ制作事例（キャラクターと文字）" class="pdp-v2-thumb-item" data-index="3" loading="lazy">
                    </div>
                ...
                <div class="product-details" id="">
                    <div class="price-box">
                        <p class="lpc"><span class="text-orange">参考単価：</span>1個588円</p>
                    </div>

                    <div class="price-box">
                        <p class="lpc"><span class="text-orange">100個合計金額：</span>58,800円</p>
                    </div>
                    ...
                    <h2 class="promo-title" style="color: #cc3f44; !important;">
                        立体感で世界観を高度に演出！ハイクオリティのジオラマアクスタ</h2>

                    <div class="info-card">
                        <h3 class="lpc">最安単価円398（税込）！</h3>
                        <a onclick="GotoDiv(3)" href="javascript:void(0)"><img
                                src="/products/acrylic/img/dioramastand/diorama-acrylicstand-banner01.webp" alt="業界最短7日出荷"
                    ...
                    <div class="info-card">
                        <h3 class="lpc">複数パーツを設置可能！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(6)"><img
                                src="/products/acrylic/img/dioramastand/diorama-acrylicstand-banner02.webp" alt="業界最安値価格" width="660"
                                height="auto" loading="lazy"></a>
                        <p class="new-text">
                            台座の上に複数のパーツを設置可能。従来のアクスタを超えた自由度で表現の可能性が広がります。
                        </p>
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text" onclick="GotoDiv(6)"
                                style="color: black;">パーツの詳細</a>
                        </div>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(7)"><img
                                src="/products/acrylic/img/dioramastand/diorama-acrylicstand-banner03.webp" alt="汚れ防止加工" width="660"
                                height="auto" loading="lazy"></a>
                        <p class="new-text">当店のジオラマアクリルスタンドは、保護フィルムで印刷を保護する仕様。爪が当たったり落としたりしても印刷がはがれません。</p>
                        <div style="text-align:right;">
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="type-toggle" class="accordion-header" id="type-g">
                            <span class="fw-bold">複数のパーツを設置可能！立体感で世界観を高度に演出！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                   <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand-banner04.webp" alt="" loading="lazy">
                                </div>
                                <br>
                                <div>
                                    <p class="new-text">ジオラマアクスタは、複数のアクリルパーツを台座に設置できるアクリルスタンドです。キャラクターや背景、小物、ロゴ、装飾パーツなどを組み合わせて台座の上に設置することで、舞台設定やストーリー、空気感まで立体的に表現することができます。</p>
                                    <br>
                                    <p class="new-text">たとえば、風景や建物などの背景パーツを奥に、キャラクターパーツを手前に、小物やモチーフを周囲に配置することで、奥行きを感じさせるディスプレイが完成。台座にもデザインを印刷できるので、床や地面、作品のロゴなどを台座に印刷し、世界観の完成度をより高めることができます。キャラクターだけではなく、キャラクターのいる世界そのものがその場所に存在しているような臨場感を演出することが可能です。</p>
                                    <br>
                                    <p class="new-text">背景とキャラクターの組み合わせだけでなく、複数のキャラクターたちの組み合わせ、アイドルやアーティストの写真での製作ももちろん可能。キャラクターたちの関係性やアニメのワンシーンを前面に押し出したジオラマアクスタや、アイドル・アーティストのファン向けのグッズ製作にもぴったりです。</p>
                                    <br>
                                    <p class="new-text">なお、設置可能なアクリルパーツ数は以下です。</p>
                                    <br>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="price-toggle" class="accordion-header" id="price-g">
                            <span class="fw-bold">製作料金とサイズ別のパーツ個数</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">
                                    印刷面を選択してください。サイズ別の製作単価表が表示されます。
                                </p>
                                <br>
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <td>150×200mm<?= lang('以内') ?></td>
                                                <td>200×270mm<?= lang('以内') ?></td>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                    </table>
                                ...
                                <br>
                                <p class="new-text">台座上に設置可能なパーツの個数は、サイズによって異なります。サイズ別の設置可能なパーツ個数は以下です。</p>
                                <br>
                                <table class="accessory-table">
                                    <thead>
                                        <tr>
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                ...
                                <br><br>
                                <a class="new-text" href="https://hotmobily.jp/contact/index.php">無料サンプルの送付をリクエスト</a>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="https://hotmobily.jp/products/acrylic/cutline_white"><img style="width: 100%;" src="/products/acrylic/img/dioramastand/diorama-acrylicstand08 (2).webp" alt="" loading="lazy"></a>
                                </div>
                                <br>
                                <div>
                                    <p class="new-text">ジオラマアクリルスタンドの製作にあたって、カットパスや白押さえなど、専用の入稿データの作成にお悩みの方もいるでしょう。当店では無料のデータ作成補助サービスをご用意。お客様の代わりに入稿データを無料で作成いたします。イラストや写真の画像（JPG、PNG）、PDFなどをお送りください。</p>
                                    <br>
                                    <a href="https://hotmobily.jp/products/acrylic/cutline_white" class="new-text">データ作成補助の詳細</a>
                                    <br><br>
                                    <p class="new-text">また、カットパス・白押さえにもこだわりがありじぶんで入稿データを作成したい方向けに、テンプレートとデータ作成ガイドをご用意しております。</p>
                                    <br>
                                    <a class="new-text"  href="/products/acrylic/template/diorama-acrylicstand-template20260630.zip" target="_blank" download>入稿データテンプレート</a>
                                    <br>
                                    <br>
                ...
                <div>
                    ...
                    <div style="overflow: unset!important;">
                        <div class="fixed-contrainer">
                            <h3 class="red">【<?= lang('ジオラマアクリルスタンド') ?>】</h3>
                        ...
                        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                            <div style="display: table-column;">
                                <input type="text" name="ItemType" id="strap" value="ジオラマアクリルスタンド" />
                            ...
                            <div class="estimate-content" id="step1">
                                ...
                                <input type="radio" name="acy_delivery" value="10営業日" checked style="display:none;">
                                <h3><?= lang('サイズ') ?></h3>
                                <div class="part-container">
                                    <div class="part-content">
                                        <label class="part-name"><input type="radio" name="acy_size" value="100" onclick="getPartData();" <?= $size50 ?>>100x100mm<?= lang('以内') ?> <span class="checkmark"></span></label>
                                    </div>
                                    <div class="part-content">
                                        <label class="part-name"><input type="radio" name="acy_size" value="150" onclick="getPartData()" <?= $size75 ?>>150x200mm<?= lang('以内') ?> <span class="checkmark"></span></label>
                                    </div>
                                    <div class="part-content">
                                        <label class="part-name"><input type="radio" name="acy_size" value="200" onclick="getPartData()" <?= $size100 ?>>200x270mm<?= lang('以内') ?> <span class="checkmark"></span></label>
                                    </div>
                                </div>
                                <input type="radio" name="acy_cat" value="ノーマルタイプ" checked style="display:none;">
                                <h3><?= lang('印刷面') ?></h3>
                                <div class="part-container">
                                    <div class="part-content">
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand-banner05.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    他社とは一線を画す当店のジオラマアクリルスタンド（ジオラマアクスタ）の強みのひとつとして、お客様の大切なデザインを保護する保護フィルムがあります。
                                </p>
                                <br>
                                <p class="new-text">一般的なジオラマアクリルスタンド（ジオラマアクスタ）は保護フィルムがなく、固いものがこすれたり爪で引っかいたりすると、印刷されたデザインがはがれる恐れがあります。しかし、当店のジオラマアクリルスタンド（ジオラマアクスタ）は印刷デザインを保護フィルムで覆っています。このため、印刷がむき出しにならず保護フィルムによって保護され、印刷がはがれる恐れがありません。</p>
                                <br>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="rainbow02-toggle" class="accordion-header">
                            <span class="fw-bold">ワンランク上の推し活グッズに！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand07.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    ジオラマアクリルスタンドは、一般的なアクリルスタンドよりもワンランク上の推し活グッズとして最適です。
                                </p>
                                <br>
                                <p class="new-text">アニメや漫画の人気キャラクターたちを並べたり、ひとりのキャラクターと背景や小物を組み合わせたりすることで、広がりと特別感のある演出が可能になります。キャラクターだけでなく、アイドルやアーティストのジオラマアクリルスタンドの製作ももちろん可能です。ステージのデザインの台座にアイドルグループのメンバーたちを並べたり、ライブ会場のようなデザインの背景とアーティストの写真を組み合わせたりして、ファン向けの臨場感あるジオラマアクリルスタンドを製作することができます。</p>
                                <br>
                                <p class="new-text">他にも、ジオラマアクリルスタンドの特色を利用したさまざまな可能性があります。</p>
                                <br>
                                <h3 class="h3-new fw-bold">あの名シーンの再現に</h3>
                                <p class="new-text">たとえばバトル漫画であれば、印象的なバトルシーンの演出にジオラマアクリルスタンドはぴったりです。ライバルのふたりが全力でぶつかり合うシーンや、登場人物たちの未来に関わる決戦シーンなどを、立体感と臨場感たっぷりに再現できます。</p>
                                <br>
                                <h3 class="h3-new fw-bold">キャラクターたちのコラボに</h3>
                                <p class="new-text">人気キャラクターたちのコラボレーションの演出にも、ジオラマアクリルスタンドが役立ちます。街並みなどを背景にメインキャラクターたちの日常を描いたジオラマアクスタや、敵キャラたちの意外な一面を描いたジオラマアクスタなど、可能性は無限大！作品の枠を超えたコラボなども考えられて、夢が広がりますね！</p>
                                <br>
                                <h3 class="h3-new fw-bold">あの名ライブの再現に</h3>
                                <p class="new-text">ファンたちの記憶に残っているアイドルやアーティストの名ライブをジオラマアクスタに！背景の設置や台座のデザインも可能なので、ライブ会場とアイドル・アーティストのパフォーマンスを再現したジオラマアクスタをファンに届けることができます。</p>
                                <br>
                                <h3 class="h3-new fw-bold">アイドル・アーティストたちの意外なコラボ！</h3>
                                <p class="new-text">普段ファンたちの前ではあまり交流がないアイドル・アーティストの意外なコラボを演出したジオラマアクスタを製作してみるのもありかもしれません。パフォーマンスの様子でもよし、座談会の様子でもよし。垣根を超えたコラボレーションで、新たな可能性が広がります。</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="one-toggle" class="accordion-header">
                            <span class="fw-bold">世界観の演出にこだわった同人グッズ製作に！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/dioramastand/diorama-acrylicstand06 (1).webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    世界観の演出にこだわった同人グッズ製作なら、ジオラマアクリルスタンドを強くおすすめできます。複数のパーツを設置可能な点や、立体感と奥行きのあるデザイン、台座もデザイン可能な点が、表現の可能性を大きく広げ、こだわりの世界観の演出を可能にします。
                                </p>
                                <br>
                                <h3 class="h3-new fw-bold">キャラクターのストーリーを深掘り！</h3>
                                <p class="new-text">好きなキャラクターを中央に置き、そのキャラクターと関係の深い風景や小物と組み合わせれば、キャラクターのストーリーを深掘りしたジオラマアクリルスタンドを製作できます。あなたの解釈、あなたのこだわりを詰め込んだ同人グッズ製作に！</p>
                                <br>
                                <h3 class="h3-new fw-bold">オリジナルのワンシーンを演出！</h3>
                                <p class="new-text">「こんなシーンがあったかもしれない！」という想像を形に。関係性の深いキャラクターたちがふたりきりで出かけている様子や、手に汗握るバトルシーンなどを、ジオラマアクスタの立体感と臨場感で演出。背景の風景や台座もデザインできるので、二人がどんな場所で何をしたのかまで表現できます。あなたの思い描いた「こんなシーンがあったもしれない！」を形にできます。</p>
                                <br>
                                <h3 class="h3-new fw-bold">敢えてキャラクターを出さない演出</h3>
                                <p class="new-text">推しのキャラクターの自室を思わせる部屋のようなデザインの背景と台座、キャラクターを連想させる小物やロゴのみを設置し、敢えてキャラクターそのものを出さない演出もありかもしれません。キャラクターがいないことが、かえって見る人の想像力を掻き立てるエモいジオラマアクスタも製作可能です。デザインする人の力量が試されますね！</p>
                                <br>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="plan-section">
                                ...
                                <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/dioramastand/diorama-acrylicstand08 (1).webp"
                                                    alt="Poster 1" />
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="cnc-toggle" class="accordion-header">
                            <span class="fw-bold">完全自社生産のジオラマアクスタ</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="https://hotmobily.jp/products/acrylic/ownfactory"><img
                                            src="/products/acrylic/img/dioramastand/diorama-acrylicstand07 (1).webp"
                                            alt="Poster 1" /></a>
                            ...
                            <div class="plan-section">
                                <table class="table_rubber" cellpadding="5" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td><?= lang('名称') ?></td>
                                            <td style="text-align: left;"><?= lang('ジオラマアクリルスタンド') ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('素材') ?></td>
                                        ...
                                        <tr>
                                            <td><?= lang('サイズ') ?></td>
                                            <td style="text-align: left;">
                                                <?= lang('100X100mm / 150x200mm / 200x270mm (台座を除く本体部分)') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('色数') ?></td>
                                        ...
                                        <tr>
                                            <td>納期</td>
                                            <td style="text-align: left;">10営業日</td>
                                        </tr>
...
-->
    ...
    <script type="text/javascript" src="/products/acrylic/js/calculate-dioramastand.js?v=<?php echo filemtime(__DIR__ . '/js/calculate-dioramastand.js'); ?>" defer></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            const imageList = [
                "/products/acrylic/img/dioramastand/diorama-acrylicstand01.webp",
                "/products/acrylic/img/dioramastand/diorama-acrylicstand02.webp",
                "/products/acrylic/img/dioramastand/diorama-acrylicstand05.webp",
                "/products/acrylic/img/dioramastand/diorama-acrylicstand06.webp"
            ];
