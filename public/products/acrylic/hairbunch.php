...
// *************************************************************
$product_name = "【ホットモバイリー】オリジナルアクリルヘアゴム";
$product_description = "オリジナルアクリルヘアゴムをオーダーメイドで製作。最短6営業日で出荷可能。小ロット1個から製作。最安単価168円。ヘアゴムを好きなデザインで手軽に低価格で1個から作成できる！";
$product_image_url = "https://hotmobily.jp/products/acrylic/img/hb-01.webp";
$product_sku = "HM-AH-2024";
$product_price = 168;
$product_currency = "JPY";
$product_availability = "InStock";
$product_url = "https://hotmobily.jp/products/acrylic/hairbunch";
...
<head>
  ...
  <meta name="keywords" content="アクリル,ヘアゴム,オリジナル,製作,作成,アクキー,剥がれない,1個から">
  <meta name="description" content="オリジナルのヘアゴム、アクリルアクセサリーが1個から注文可。剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現">
  <title>オリジナルのヘアゴム、アクリルアクセサリーが1個から注文可。剥がれない印刷。丈夫なアクキー。</title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1>オリジナルのヘアゴム、アクリルアクセサリーが1個から注文可。剥がれない印刷。丈夫なアクキー(2026年版)</h1>
      <div class="social-time">
        <span class="social-content">
          <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのヘアゴム、アクリルアクセサリーが1個から注文可。剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/hairbunch" title="Share by Email" target="_blank">シェアする</a><a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのヘアゴム、アクリルアクセサリーが1個から注文可。剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/hairbunch" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
          <a href="https://www.facebook.com/share.php?u=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fhairbunch" target="_blank"><i class="fab fa-facebook-square"></i></a>
          <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fhairbunch&amp;text=オリジナルのヘアゴム、アクリルアクセサリーが1個から注文可。剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現" target="_blank"><i class="fab fa-twitter-square"></i></a>
        </span>
          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_01" src="img/hb-01.webp" data-zoom-image="img/hb-01.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_02" src="img/hb-02.webp" data-zoom-image="img/hb-02.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_03" src="img/hb-03.webp" data-zoom-image="img/hb-03.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_04" src="img/hb-04.webp" data-zoom-image="img/hb-04.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
            </div>
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="img/hb-01.webp" width="93" height="58" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="img/hb-02.webp" width="93" height="58" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="img/hb-03.webp" width="93" height="58" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="img/hb-04.webp" width="93" height="58" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
        ...
        <div class="flex-item item">
          <table class="table_rubber" style="padding: 0 ;">
            ...
            <tr>
              ...
              <td class="">既製品：50種類のデータから選択可 <br> オリジナル印刷：お客様の入稿データを使用し、印刷します <br>
      ...
      <!-- <div class="flex-container">
        <div class="flex-item item">
          <div class="btn-container item_btn" style="display: flex;justify-content: space-between;">
            <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_hair.zip">
              <span>テンプレート</span>
            </a>
        ...
        <div class="flex-item item">
          <div class="btn-container item_btn" style="display: flex;justify-content: space-between;">
            ...
            <a class="btn-a btn-yellow" href="/contact/?item=アクリルヘアバンド">
              <span>無料サンプル</span>
            </a>
          </div>
        </div>
      ...
      <br><br>
      <a class="new-text" href="/contact/?item=アクリルヘアバンド" >無料サンプルの送付をリクエスト</a>
        ...
        <div class="modal-content data">
          ...
          <table class="table_rubber">
            <tbody>
              <tr>
                <td>
                  <a class="btn-a btn-yellow" href="/products/data-acrylic-hairbunch.php" target="_blank">
      ...
      <a class="new-text" href="/products/acrylic/template/template-acrylic_hair.zip" download>入稿データテンプレートをダウンロード</a>
      <br>
      <br>
      ...
      <div class="videoWrapper">
        <img src="img/ak-yt.webp" data-src="pnKcyfuh4Rw" class="iframe" width="100%" height="434">
        <div class="playbtn">
          <div class="tri"></div>
        </div>
      </div>
        ...
        <div class="swiper-container swiper2">
          <div class="swiper-wrapper swiper-bt">
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-1a.webp" data-lightbox="270721-1" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-1a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-1b.webp" data-lightbox="270721-1" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-15a.webp" data-lightbox="270721-15" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-15a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-15b.webp" data-lightbox="270721-15" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-9a.webp" data-lightbox="270721-9" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-9a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-9b.webp" data-lightbox="270721-9" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-2a.webp" data-lightbox="270721-2" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-2a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-2b.webp" data-lightbox="270721-2" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-3a.webp" data-lightbox="270721-3" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-3a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-3b.webp" data-lightbox="270721-3" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-4a.webp" data-lightbox="270721-4" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-4a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-4b.webp" data-lightbox="270721-4" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-5a.webp" data-lightbox="270721-5" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-5a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-5b.webp" data-lightbox="270721-5" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-6a.webp" data-lightbox="270721-6" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-6a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-6b.webp" data-lightbox="270721-6" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-7a.webp" data-lightbox="270721-7" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-7a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-7b.webp" data-lightbox="270721-7" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-8a.webp" data-lightbox="270721-8" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-8a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-8b.webp" data-lightbox="270721-8" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-10a.webp" data-lightbox="270721-10" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-10a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-10b.webp" data-lightbox="270721-10" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-11a.webp" data-lightbox="270721-11" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-11a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-11b.webp" data-lightbox="270721-11" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-12a.webp" data-lightbox="270721-12" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-12a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-12b.webp" data-lightbox="270721-12" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-13a.webp" data-lightbox="270721-13" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-13a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-13b.webp" data-lightbox="270721-13" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/hair270721-14a.webp" data-lightbox="270721-14" style="text-decoration:none;" data-title="T.様 2021年1月">
                <img data-src="/products/acrylic/img/hair270721-14a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/acrylic/img/hair270721-14b.webp" data-lightbox="270721-14" data-title="T.様 2021年1月"></a>
            </div>
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/130.webp" data-lightbox="acrylic-a10" style="text-decoration:none;" data-title="">
                <img data-src="/gallery/img-acrylic/2023-acrylic-gallery/130.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/131.webp" data-lightbox="acrylic-a10" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/132.webp" data-lightbox="acrylic-a11" style="text-decoration:none;" data-title="">
                <img data-src="/gallery/img-acrylic/2023-acrylic-gallery/132.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/133.webp" data-lightbox="acrylic-a11" data-title=""></a>
            </div>
          </div>
        </div>
      ...
      <!-- <a href="https://hotmobily.jp/products/data-acrylic.php" target="_blank"><img class="lazy" data-src="img/banner_design_data.webp" width="100%" height="388" style="max-width:770px"></a> -->
      ...
      <div style="overflow: unset!important;">
        ...
        <div class="step-container line1" style="padding: 5px;border: 1px solid lightgray;margin-bottom: 5px;">
          ...
          <div class="step-box line2" style="text-align: center;">
            <img src="/products/images/HM_part1-2.webp" id="sample-part-pic" class="picpro lazy" width="320" height="320"><br />
            <span id="sample-part-name">アタッチメント:なし</span>
          </div>
          <div class="step-box line2" style="text-align: center;">
            <img src="img/coming-soon.webp" style="display: none;" id="sample-paper-pic" class="picpro lazy" width="500" height="500"><br />
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="アクリルヘアバンド" />
            <input type="hidden" id="ms_mode" value="<?php echo (isset($_GET['mode']) ? $_GET['mode'] : "") ?>">
            <input type='hidden' value='片面印刷' name='acy_screen'>
          </div>
          <?php
          //Setup delivery data
          switch ($acy_delivery) {
      ...
      <div>
        <div style="margin-bottom: 10px;">
          ...
          <div id="panel1" class="a-detail new-text">
            アクリルヘアバンドの注文画面はカート形式となっております。この場合、まずAデザインのご注文をカートに入れていただき、その後「買い物を続ける」ボタンをクリックしてください。アクリル製品一覧画面に移行しますので、再度アクリルヘアバンドのページに行き、注文画面からBデザインのご注文をカートに入れてください。カートに2つの注文が入っていることをご確認後「購入へ」ボタンをクリックし、ご購入のステップにお進みください。例えば、表面のデザインは同じで、裏面のデザインだけが異なる場合も、別々の注文として2件のご注文をカートに入れていただく必要がございます。
          </div>
        </div>
        <div style="margin-bottom: 10px;">
          <div class="quest">Q</div>
          ...
          <div id="panel2" class="a-detail new-text">
            アクリルヘアゴムを作成する際、デザインのデータ以外に、カットパスと白押さえのデータが必要となります。カットバスとは、どのようにアクリルヘアゴムをカットするかのデータです。白押さえとは、アクリルヘアゴムを印刷する際、白色部分は印刷されませんので、透明となります。一旦白色以外の部分を印刷した後、指定された部分のみ白色印刷を行います。カットパスと白押さえの詳細は、<a href="https://hotmobily.jp/products/data-acrylic-umbrella.php">入稿データ作成</a>のページをご覧ください。
          </div>
        </div>
        <div style="margin-bottom: 10px;">
          <div class="quest">Q</div>
  ...
  <script type="text/javascript" src="<?= $cal_acrylic_bunch_js ?>"></script>
            ...
            <?php echo $json_ld_output; ?>, {
                ...
                "itemListElement": [{
                    ...
                    },
                    {
                        ...
                        "position": 3,
                        "name": "アクリルヘアバンド",
                        "item": "https://hotmobily.jp/products/acrylic/hairbunch"
                    }
                ]
            }
        ]
