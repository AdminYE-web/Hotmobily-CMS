...
// *************************************************************
$product_name = "【ホットモバイリー】オリジナル再生材料アクリルキーホルダー";
$product_description = "オリジナル再生材料アクリルキーホルダーをオーダーメイドで製作。最短6営業日で出荷可能。小ロット1個から製作できます。最安188円。エコでサステナブルな地球に優しいグッズ製作に最適";
$product_image_url = "https://hotmobily.jp/products/images/recycle600x600-01.webp";
$product_sku = "HM-RSAK-2025";
$product_price = 168;
$product_currency = "JPY";
$product_availability = "InStock";
$product_url = "https://hotmobily.jp/products/acrylic/recycle.php";
...
<head>
  ...
  <meta name="keywords" content="<?= lang('再生材料アクリル,リサイクルアクリル,サステナブル,エコ,キーホルダー,オリジナル,名入れ,製作,作成,アクキー,剥がれない,1個から') ?>">
  <meta name="description" content="<?= lang('オリジナルの再生材料アクリルキーホルダー（リサイクルアクリルキーホルダー）が1個から注文可。サステナブルなアクキーで地球環境に貢献。剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現') ?>">
  <title><?= lang('再生材料アクリルキーホルダー') ?></title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <div id="" class="">
        <h1 class=""><?= lang('再生材料アクリルキーホルダーをご制作！ サステナブルで環境にやさしい！') ?></h1>
        <div class="social-time ">
          <span class="social-content">
            <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0A光の角度で色が変わる！オーロラアクリルキーホルダー剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/aurora.php" title="Share by Email" target="_blank"><?= lang('シェアする') ?></a><a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0A光の角度で色が変わる！オーロラアクリルキーホルダー剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/aurora.php" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
            ...
            <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2faurora.php&amp;text=光の角度で色が変わる！オーロラアクリルキーホルダー剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現" target="_blank"><i class="fab fa-twitter-square"></i></a>
          </span>
      ...
      <div id="">
        <img src="/products/images/banner_recycle-acrylic.webp" alt="オリジナルアクリルキーホルダー(アクキー)の製作。1個から注文可。保護フィルムで、印刷が剥がれません(2024年版)" width="771" height="390" loading="eager" />
      </div>
      ...
      <div class="" id="">
        <div class="flex-container">
          ...
          <div class="flex-item item">
            <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
              <swiper-slide><img onclick="openSimpleModal(this)" src="/products/images/recycle500x500-01.webp?dd=<?php echo date('is') ?>" loading="lazy"></swiper-slide>
              <swiper-slide><img onclick="openSimpleModal(this)" src="/products/images/recycle500x500-02.webp?dd=<?php echo date('is') ?>" loading="lazy"></swiper-slide>
              <swiper-slide><img onclick="openSimpleModal(this)" src="/products/images/recycle500x500-03.webp?dd=<?php echo date('is') ?>" loading="lazy"></swiper-slide>
              <swiper-slide><img onclick="openSimpleModal(this)" src="/products/images/recycle500x500-04.webp?dd=<?php echo date('is') ?>" loading="lazy"></swiper-slide>
            </swiper-container>
          </div>
          <div class="flex-item item new-text" style="display:grid;align-content: center;line-height: 2;">
            <h2 style="margin-top: 0px;"><?= lang('サステナブル素材でオリジナルアクキーをご制作！SDGSに貢献！') ?></h2><br>
            <p class="new-text">
            あなたのオリジナルアクリルキーホルダーを、再生材でご制作！限りある資源の消費を抑え、Co2排出量を削減するサステナブルなアクリルキーホルダーです！ <br> <br> 一般的なアクリルキーホルダーと同じ価格で、SDGsに貢献できます。
            </p>
          </div>
        ...
        <h2><?= lang('再生材料アクリルキーホルダーの制作事例') ?></h2>
        <div class="ex-row">
            ...
            <div class="swiper-container swiper2">
                <div class="swiper-wrapper swiper-bt">
                    ...
                    <div class="prodate">植物と女の子</div>
                    <a href="/products/images/recycle600x600-01.webp" data-lightbox="acrylic_swiper15" style="text-decoration:none;" data-title="">
                        <img loading="lazy" src="/products/images/recycle600x600-01.webp" class="picpro" width="229" height="229">
                        <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                        </div>
                    </a>
                    <a href="/products/images/recycle600x600-02.webp" data-lightbox="acrylic_swiper15" data-title=""></a>
                    </div>

                    <div class="swiper-slide">
                    <div class="prodate">着物の女性</div>
                    <a href="/products/images/recycle600x600-03.webp" data-lightbox="acrylic_swiper16" style="text-decoration:none;" data-title="">
                        <img loading="lazy" src="/products/images/recycle600x600-03.webp" class="picpro" width="229" height="229">
                        <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                        </div>
                    </a>
                    <a href="/products/images/recycle600x600-04.webp" data-lightbox="acrylic_swiper16" data-title=""></a>
                    </div>

                    <div class="swiper-slide">
                    <div class="prodate">SDGs</div>
                    <a href="/products/images/recycle600x600-05.webp" data-lightbox="acrylic_swiper1" style="text-decoration:none;" data-title="">
                        <img loading="lazy" src="/products/images/recycle600x600-05.webp" class="picpro" width="229" height="229">
                        <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                        </div>
                    </a>
                    <a href="/products/images/recycle600x600-06.webp" data-lightbox="acrylic_swiper1" data-title=""></a>
                    </div>

                    <div class="swiper-slide">
                    <div class="prodate">猫の写真</div>
                    <a href="/products/images/recycle600x600-07.webp" data-lightbox="acrylic_swiper17" style="text-decoration:none;" data-title="">
                        <img loading="lazy" src="/products/images/recycle600x600-07.webp" class="picpro" width="229" height="229">
                        <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                        </div>
                    </a>
                    <a href="/products/images/recycle600x600-08.webp" data-lightbox="acrylic_swiper17" data-title=""></a>
                    </div>

                    <div class="swiper-slide">
                    <div class="prodate">ユニコーンイラスト</div>
                    <a href="/products/images/recycle600x600-09.webp" data-lightbox="acrylic_swiper18" style="text-decoration:none;" data-title="">
                        <img loading="lazy" src="/products/images/recycle600x600-09.webp" class="picpro" width="229" height="229">
                        <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                        </div>
                    </a>
                    <a href="/products/images/recycle600x600-10.webp" data-lightbox="acrylic_swiper18" data-title=""></a>
                    </div>
        ...
        <h2><?= lang('再生材料アクリルキーホルダーとは？') ?></h2>
        <div>
            <p class="new-text">再生材料アクリルとは、アクリル製品の製造時に出た端材を、粉砕・再パレット化を経て再利用して製造するアクリルです。当店が使用している再生材料アクリルは、アクリル製品の製造時に出た端材を使った<font color="red">100パーセント再生材</font>となっています。</p>
            <br>
            <div>
                <img loading="lazy" src="/products/images/recycle-process.webp" alt="" width="771" height="390" />
            </div>
            <br>
            <p class="new-text">上記のようにして製造された再生材料アクリル板を利用して、再生材料アクリルキーホルダーを製作します。</p><br>
            <p class="new-text">一般的なアクリルキーホルダーは、石油から新しく製造したアクリル板を使用して製作されます。新しくアクリル板を製造する際には、石油が消費されるうえに、製造に伴ってCo2が排出されます。それに対し、再生材料アクリルキーホルダーはアクリルの端材を活用するので、次の2つの大きなメリットがあります。</p>
            <br>
            <p class="new-text">・石油という限りある資源を節約できる</p>
            <p class="new-text">・Co2排出を抑えることができる</p>
            
            <br>
            <p class="new-text">再生材料アクリルと一般的なアクリルの見た目の違いは、微粒子の有無です。キーホルダーの形に加工しデザインを印刷する前のアクリルは、微粒子がごくわずかに見受けられます。下の写真の左側が再生材料アクリル板、右側が一般的なアクリル板です。再生材料アクリル板の赤い丸で囲まれた部分をよくよく見ると、わずかに微粒子が見えるのがわかるでしょうか（クリックして写真を拡大すると、よりわかりやすいと思います）。ただし、強い光を当ててよくよく見ないとわからない、本当にごく小さな微粒子です。普通に眺めるだけでは見えません。</p>
            <br>
            ...
            <div>
                <div class="swiper-container swiper3">
                    <div class="swiper-wrapper swiper-bt">
                        <div class="swiper-slide">
                            <!-- <div class="prodate">植物と女の子</div> -->
                            <a href="/products/images/comparison_recycle03.webp" data-lightbox="acrylic_swiper199" style="text-decoration:none;" data-title="">
                                <img loading="lazy" src="/products/images/comparison_recycle03.webp" class="picpro2" width="771" height="auto">
                                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                                </div>
                            </a>
                        </div>
        ...
        <div style="clear: both;"></div>
        <h2><?= lang('再生材料アクリルキーホルダーの特徴') ?></h2>
        <p class="new-text">再生材料アクリルキーホルダーには、次の3つの特徴があります。</p>
        <h2 class="feature1 new-text">環境にやさしく、未来をつくるサステナブルな素材</h2>
        <p style="padding-top: 10px!important;" class="new-text">アクリル製品の製造時に出た端材を再利用し、粉砕・再パレット化して新たに生まれ変わった再生材料アクリルを使用。限りある資源を無駄にせず、廃棄物を減らすことで地球環境にやさしい製品づくりを実現しました。「作ること」そのものが、エコでサステナブルな社会への一歩につながります。</p>
        ...
        <h2 class="feature2 new-text">一般的なアクリルキーホルダーと変わらない安心の仕上がり</h2>
        <p style="padding-top: 10px!important;" class="new-text">再生素材を使っているとは思えないほど、透明感や発色は一般のアクリルとほとんど変わりません。デザインの再現性も一般的なアクリルキーホルダーと変わらず、鮮やかなプリントや細やかなカットも美しく仕上がります。環境配慮とクオリティを両立した、これからの時代にふさわしいキーホルダーです。</p><br>
        <div class="poster-grid">
            <div class="poster-item">
                <div>
                    <div style="text-align:center;">
                        <p class="new-text">再生アクキー</p>
                    </div>
                    <img loading="lazy" onclick="openSimpleModal2(this)" src="/products/images/recycle_model.webp" alt="Poster 1" />
            ...
            <div class="poster-item">
                <div style="text-align:center;">
                    <p class="new-text">一般的なアクキー</p>
                </div>
                <img loading="lazy" onclick="openSimpleModal2(this)" src="/products/images/normal_model.webp" alt="Poster 2" />
                <div class="camera-left" style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">📷<?= lang('クリックすると拡大します') ?>
                </div>
            </div>
        </div>

        <h2 class="feature3 new-text">SDGSへの取り組みを「形」で伝えることができるプロダクト</h2>
        <p style="padding-top: 10px!important;" class="new-text">再生材料アクリルキーホルダーは、企業やブランドが持つ「環境意識」「社会貢献」をわかりやすく発信できるアイテム。展示会・イベント・ノベルティとして配布すれば、SDGsへの姿勢を効果的にアピールできます。「選ばれる理由」に「エコ」という新たな価値を加え、ブランドイメージをより強く印象づけます。</p>
      <hr>
      ...
      <div>
        ...
        <div>
          <br>
          <p class="new-text">オーロラアクリルキーホルダーは、光の角度によってブルーやピンク、イエローなど、まるでオーロラのように色が変わるオーロラアクリルキーホルダーです。</p><br>
      ...
      <br><br>
      <a class="new-text" href="/contact/?item=再生材料アクリルキーホルダー" >無料サンプルの送付をリクエスト</a>
      ...
      <a class="new-text" href="/products/acrylic/template/template-recycle-acrylic.zip" download>入稿データテンプレートをダウンロード</a>
      <br>
      <br>
          ...
          <div class="row">
            <div class="mt-10-part">
              <a href="/products/images/HM_part5.webp" data-lightbox="img-part-set-5" data-title="<strong>【銀色ナスカン】</strong>銀色のナスカンです。片手で開閉出来ますので、小さいお子様でも簡単にご利用頂けます。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part5.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part6.webp" data-lightbox="img-part-set-6" data-title="<strong>【星型ナスカン】</strong>星型のナスカンです。アクセントのあるパーツです。記念品などでもご利用頂けます。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part6.webp" width="229" height="229">
              </a><br>
              <div>+22円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part7.webp" data-lightbox="img-part-set-7" data-title="<strong>【ハート型ナスカン】</strong>ハート型のナスカンです。キャラクター系のデザインに合わせてもかわいいパーツです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part7.webp" width="229" height="229">
              </a><br>
              <div>+22円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part14.webp" data-lightbox="img-part-set-14" data-title="<strong>【ボールチェーンシルバー】</strong>銀色のボールチェーンです。追加料金なく手配できるボールチェーンです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part14.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part4.webp" data-lightbox="img-part-set-4" data-title="<strong>【金色ナスカン】</strong>金メッキをしたナスカンです。高級感のあるデザインにぴったりです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part4.webp" width="229" height="229">
              </a><br>
              <div>+22円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part15.webp" data-lightbox="img-part-set-15" data-title="<strong>【リング小+チェーン】</strong>最も小さいキーリングです。小物系のデザインにご利用頂けます。 リング 外径：23mm　内径：20mm">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part15.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part18.webp" data-lightbox="img-part-set-18" data-title="<strong>【リング小+回転カン】</strong>最も小さいキーリングです。丈夫な回転カン仕様です。 リング 外径：23mm　内径：20mm">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part18.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part16.webp" data-lightbox="img-part-set-16" data-title="<strong>【リング中+チェーン】</strong>最も一般的なサイズのキーリングです。 リング 外径：30mm　内径：25mm">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part16.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part19.webp" data-lightbox="img-part-set-19" data-title="<strong>【リング中+回転カン】</strong>最も一般的なサイズのキーリングです。丈夫な回転カン仕様です。 リング 外径：30mm　内径：25mm">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part19.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part17.webp" data-lightbox="img-part-set-17" data-title="<strong>【リング大+チェーン】</strong>最も大きいキーリングです。大きいサイズのデザインに適しています。 リング 外径：33mm　内径：29mm">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part17.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part20.webp" data-lightbox="img-part-set-20" data-title="<strong>【リング大+回転カン】</strong>最も大きいキーリングです。丈夫な回転カン仕様です。 リング 外径：33mm　内径：29mm">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part20.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part8.webp" data-lightbox="img-part-set-8" data-title="<strong>【半月型ナスカン】</strong>半月型のナスカンです。しっとりとした印象のナスカンです。大人向けのデザインの場合、お勧めです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part8.webp" width="229" height="229">
              </a><br>
              <div>+22円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part1.webp" data-lightbox="img-part-set-1" data-title="<strong>【通常松葉+カニカン】</strong>製品本体と松葉を切り離すことができますので、携帯電話等への取り付けが容易になります。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part1.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part2.webp" data-lightbox="img-part-set-2" data-title="<strong>【ゴム松葉+カニカン】</strong>松葉紐が伸縮します。製品本体と松葉を切り離すことができますので、携帯電話等への取り付けが容易になります。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part2.webp" width="229" height="229">
              </a><br>
              <div>+0円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part3.webp" data-lightbox="img-part-set-3" data-title="<strong>【通常松葉+カニカン+スマホプラグ】</strong>通常松葉+カニカンの紐の先端にスマホプラグがついています。イヤホンジャックに挿入して使用できます。また、製品本体と松葉を切り離すことができますので、携帯電話等への取り付けが容易になります。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part3.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part9.webp" data-lightbox="img-part-set-9" data-title="<strong>【ボールチェーン黄色】</strong>黄色のボールチェーンです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part9.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part10.webp" data-lightbox="img-part-set-10" data-title="<strong>【ボールチェーン赤色】</strong>赤色のボールチェーンです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part10.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part11.webp" data-lightbox="img-part-set-11" data-title="<strong>【ボールチェーン青色】</strong>青色のボールチェーンです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part11.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part12.webp" data-lightbox="img-part-set-12" data-title="<strong>【ボールチェーンピンク色】</strong>ピンク色のボールチェーンです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part12.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
            ...
            <div class="mt-10-part">
              <a href="/products/images/HM_part13.webp" data-lightbox="img-part-set-13" data-title="<strong>【ボールチェーン緑色】</strong>緑色のボールチェーンです。">
                <img loading="lazy" class="picpro lazy" data-src="/products/images/HM_part13.webp" width="229" height="229">
              </a><br>
              <div>+11円</div>
      ...
      <div style="overflow: unset!important;">
        <div class="fixed-contrainer">
          <h3 class="red">【<?= lang('再生材料アクリルキーホルダー') ?>】</h3>
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="再生材料アクリルキーホルダー" />
      ...
      <table class="table_rubber" style="padding: 0 ;">
        <tr>
          ...
          <td class=""><?= lang('再生材料アクリルキーホルダー') ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class=""><?= lang('印刷面をフィルム保護。再生材料アクリルを使用。CNCカット。') ?></td>
        </tr>
        <tr>
          <td class="TableLeft"><?= lang('納期') ?></td>
  ...
  <script type="text/javascript" src="/products/acrylic/js/calculate_recycle.js?v=<?php echo date('is') ?>"></script>
            ...
            <?php echo $json_ld_output; ?>, {
                ...
                "itemListElement": [{
                    ...
                    },
                    {
                        ...
                        "position": 3,
                        "name": "再生材料アクリルキーホルダー",
                        "item": "https://hotmobily.jp/products/acrylic/recycle.php"
                    }
                ]
            }
        ]
