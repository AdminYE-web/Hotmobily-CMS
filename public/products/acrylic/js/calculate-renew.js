/**
 * calculate-renew.js
 * Acrylic Keychain (アクリルキーホルダー) — DB-based price calculator.
 * Replaces hardcoded price arrays with AJAX calls to ajax_calculate_price.php.
 *
...
function cal_c(v) {
    ...
    $.ajax({
        type: "POST",
        url: "/products/acrylic/ajax_calculate_price.php",
        dataType: "json",
        data: {
...
function writePriceTable(plus) {
    ...
    $.ajax({
        type: "POST",
        url: "/products/acrylic/ajax_price_table.php",
        dataType: "json",
        data: {
            delivery: days,
            screen: screen
