...
function cal_c(v) {
	...
	var paper = $('input[name="acy_paper_select"][type="checkbox"]:checked').val();
...
{
	$.get("https://hotmobily.jp/products/acrylic/part-base-rainbow.php", { c: "passed",s: $('input[name="acy_size"]:checked').val() } , function(data){
