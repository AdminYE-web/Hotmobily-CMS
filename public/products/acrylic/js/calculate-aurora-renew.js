/**
 * calculate-aurora-renew.js
 * Aurora Acrylic Keychain (オーロラアクリルキーホルダー) — DB-based price calculator.
 * Replaces hardcoded price arrays with AJAX calls to ajax_calculate_price_aurora.php.
 *
...
function cal_c(v) {
    ...
    $.ajax({
        type: "POST",
        url: "/products/acrylic/ajax_calculate_price_aurora.php",
        dataType: "json",
        data: {
...
function writePriceTable(plus) {
    ...
    $.ajax({
        type: "POST",
        url: "/products/acrylic/ajax_price_table_aurora.php",
        dataType: "json",
        data: {
            delivery: days,
            screen: screen
...
$(function () {
    writePriceTable();
    // Aurora acrylic uses same parts as acrylic keychain
