        ...
        startZoom: function () {
            ...
            function getWindowLensStyle() {
                ...
                return 'background-position: 0px 0px;width: ' + String((self.options.zoomWindowWidth) / self.widthRatio) + 'px;' +
                    ...
                    'width:' + String((lensWidth) / self.widthRatio) + 'px;' +
                    'height:' + String((lensHeight) / self.widthRatio) + 'px;' +
...
$('a.ord-btn').click(function (e) {
    e.preventDefault()
    $("html, body").animate({
        scrollTop: $("#est-content").offset().top
    },600);
    return false;
});
$('a.est-btn').click(function (e) {
    e.preventDefault()
    $("html, body").animate({
        scrollTop: $("#est-content").offset().top
    },1200);
