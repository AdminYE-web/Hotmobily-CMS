...
// *************************************************************
$product_name = "【ホットモバイリー】オリジナルアクリルコースター（クリアコースター）";
$product_description = "オリジナルアクリルコースター（クリアコースター）をオーダーメイドで製作。最短6営業日で出荷可能。小ロット1個から製作。最安単価267円。手軽に低価格で1個から作成できるコースターとしておすすめ";
$product_image_url = "https://hotmobily.jp/products/acrylic/img/coaster-01.webp";
$product_sku = "HM-AC-2024";
$product_price = 267;
$product_currency = "JPY";
$product_availability = "InStock";
$product_url = "https://hotmobily.jp/products/acrylic/coaster";
...
<head>
  ...
  <meta name="keywords" content="アクリル,コースター,オリジナル,名入れ,製作,作成">
  <meta name="description" content="オリジナルのアクリルコースター（クリアコースター）が製作できます。形状も印刷も自由自在。印刷が剥がれない特殊加工。激安価格で、小ロット1個から注文可。短納期を実現">
  <meta name="robots" content="index,follow">
  <title>オリジナルのアクリルコースター（クリアコースター）が製作できます。形状も印刷も自由自在。小ロット1個から注文可。</title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1>オリジナルのアクリルコースター（クリアコースター）が製作できます。形状も印刷も自由自在。小ロット1個から注文可(2026年版)</h1>
      <div class="social-time">
        <span class="social-content">
          <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのアクリルコースター（クリアコースター）が製作できます。形状も印刷も自由自在。印刷が剥がれない特殊加工。激安価格で、小ロット1個から注文可。短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/coaster" title="Share by Email" target="_blank">シェアする</a><a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのアクリルコースター（クリアコースター）が製作できます。形状も印刷も自由自在。印刷が剥がれない特殊加工。激安価格で、小ロット1個から注文可。短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/coaster" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
          <a href="https://www.facebook.com/share.php?u=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fcoaster" target="_blank"><i class="fab fa-facebook-square"></i></a>
          <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fcoaster&amp;text=オリジナルのアクリルコースター（クリアコースター）が製作できます。形状も印刷も自由自在。印刷が剥がれない特殊加工。激安価格で、小ロット1個から注文可。短納期を実現" target="_blank"><i class="fab fa-twitter-square"></i></a>
        </span>
          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_01" src="img/coaster-01.webp" data-zoom-image="img/coaster-01.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_02" src="img/coaster-02.webp" data-zoom-image="img/coaster-02.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_03" src="img/coaster-03.webp" data-zoom-image="img/coaster-03.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_04" src="img/coaster-04.webp" data-zoom-image="img/coaster-04.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
            </div>
            ...
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="img/coaster-01.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="img/coaster-02.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="img/coaster-03.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="img/coaster-04.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
        ...
        <div class="flex-item item">
          <table class="table_rubber" style="padding: 0 ;">
            ...
            <tr>
              ...
              <td class="">オプションで選択可。<br>既製品：50種類のデータから選択可<br>
                オリジナル印刷：お客様の入稿データを使用し、印刷します<br>
              </td>
            </tr>
            <tr>
              <td class="TableLeft">試作品</td>
              <td class="">20枚以上のご注文から可能です</td>
            </tr>
            <tr>
      ...
      <!-- <div class="flex-container">
        <div class="flex-item item">
          <div class="btn-container item_btn" style="display: flex;justify-content: space-between;">
            <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_coaster.zip">
              <span>テンプレート</span>
            </a>
        ...
        <div class="flex-item item">
          <div class="btn-container item_btn" style="display: flex;justify-content: space-between;">
            ...
            <a class="btn-a btn-yellow" href="/contact/?item=アクリルコースター（クリアコースター）">
              <span>無料サンプル</span>
            </a>
          </div>
        </div>
      ...
      <br><br>
      <a class="new-text" href="/contact/?item=アクリルコースター" >無料サンプルの送付をリクエスト</a>
        ...
        <div class="modal-content data">
          ...
          <table class="table_rubber">
            <tbody>
              <tr>
                <td>
                  <a class="btn-a btn-yellow" href="/products/data-acrylic-coaster.php" target="_blank">
      ...
      <a class="new-text" href="/products/acrylic/template/template-acrylic_coaster.zip" download>入稿データテンプレートをダウンロード</a>
      <br>
      <br>
      ...
      <div class="videoWrapper">
        <img src="img/ak-yt.webp" data-src="AFD6wqJvCuo" class="iframe" width="100%" height="434">
        <div class="playbtn">
          <div class="tri"></div>
        </div>
      </div>
        ...
        <div class="swiper-container swiper2">
          <div class="swiper-wrapper swiper-bt">
            <div class="swiper-slide">
              <div class="prodate">QRコードをプリント</div>
              <a href="/products/acrylic/img/acrylic-coaster-1.webp" data-lightbox="acrylic-a1" style="text-decoration:none;" data-title="株式会社日本交易WEB部門to様 2020年8月">
                <img src="/products/acrylic/img/acrylic-coaster-1.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/acrylic-coaster-1b.webp" data-lightbox="acrylic-a1" data-title="株式会社日本交易WEB部門to様 2020年8月"></a>
              <a href="/products/acrylic/img/acrylic-coaster-1c.webp" data-lightbox="acrylic-a1" data-title="株式会社日本交易WEB部門to様 2020年8月"></a>
            </div>
            <div class="swiper-slide">
              <div class="prodate">暖かみのあるテイスト</div>
              <a href="/products/acrylic/img/acrylic-coaster-2a.webp" data-lightbox="acrylic-2" style="text-decoration:none;" data-title="I.様 2021年10月ご注文">
                <img src="/products/acrylic/img/acrylic-coaster-2a.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/acrylic-coaster-2b.webp" data-lightbox="acrylic-2" data-title="I.様 2021年10月ご注文"></a>
            </div>
            <div class="swiper-slide">
              <div class="prodate">カラフルな猫のイラスト</div>
              <a href="/products/acrylic/img/acrylic-coaster-3a.webp" data-lightbox="acrylic-3" style="text-decoration:none;" data-title="I.様 2021年10月ご注文">
                <img src="/products/acrylic/img/acrylic-coaster-3a.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/acrylic-coaster-3b.webp" data-lightbox="acrylic-3" data-title="I.様 2021年10月ご注文"></a>
            </div>
            <div class="swiper-slide">
              <div class="prodate">動物のデザイン</div>
              <a href="/products/acrylic/img/acrylic-coaster-4a.webp" data-lightbox="acrylic-4" style="text-decoration:none;" data-title="I.様 2021年10月ご注文">
                <img src="/products/acrylic/img/acrylic-coaster-4a.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/acrylic-coaster-4b.webp" data-lightbox="acrylic-4" data-title="I.様 2021年10月ご注文"></a>
            </div>
            <div class="swiper-slide">
              <div class="prodate">犬のイラスト</div>
              <a href="/products/acrylic/img/acrylic-coaster-5a.webp" data-lightbox="acrylic-5" style="text-decoration:none;" data-title="I.様 2021年10月ご注文">
                <img src="/products/acrylic/img/acrylic-coaster-5a.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/acrylic-coaster-5b.webp" data-lightbox="acrylic-5" data-title="I.様 2021年10月ご注文"></a>
            </div>
          </div>
        </div>
      ...
      <!-- <div class="exc_pro1 ex-row">
				<div class="swiper-slide">
					<div class="prodate">2020年8月ご注文</div>
					<a href="/products/acrylic/img/acrylic-coaster-1.webp" data-lightbox="acrylic-a1" style="text-decoration:none;" data-title="株式会社日本交易WEB部門to様 2020年8月">
						<img src="/products/acrylic/img/acrylic-coaster-1.webp" class="picpro" width="229" height="229">
						<div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します	</div>
					</a>
      ...
      <!--<div class="swiper-button-prev"></div>
				<div class="swiper-container swiper2">
					<div class="swiper-wrapper swiper-bt">
						<div class="swiper-slide">
							<a href="/products/acrylic/img/acrylic-coaster-1.jpg" data-lightbox="acrylic-a1" style="text-decoration:none;" data-title="株式会社日本交易WEB部門to様 2020年8月20日掲載">
								<img src="/products/acrylic/img/acrylic-coaster-1.jpg" class="picpro">
								<div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します	</div>
							</a>
							<a href="/products/acrylic/img/acrylic-coaster-1b.jpg" data-lightbox="acrylic-a1" data-title="株式会社日本交易WEB部門to様 2020年8月20日掲載"></a>
							<a href="/products/acrylic/img/acrylic-coaster-1c.jpg" data-lightbox="acrylic-a1" data-title="株式会社日本交易WEB部門to様 2020年8月20日掲載"></a>
						</div>												
					</div>							
				</div>  							
				<div class="swiper-button-next"></div>
				<div style="text-align: center; margin: 15px auto 0; display: none;">   
					<a href="/gallery/acrylic_key"><img class="btn_z" src="/products/images/but3-02.png?v=1.03" width="266"></a>
				</div>		
				<div class="read-more1"><a href="#" class="btn"><img class="btn_z" src="/products/images/but3-02.png?v=1.03" width="266"></a></div>-->
      <!-- </div> -->
      <hr>
      <div style="clear:both;"></div>
      <h2>代表的な本数での価格表</h2>
      <p class="new-text">納期と印刷面を選択してください。サイズ別の製作単価表が表示されます。ここは価格表のみです。<a href="#est-content">見積・注文</a>はこちらです。</p>
      <h3>納期</h3>
      ...
      <div style="overflow: unset!important;">
        <div class="fixed-contrainer">
          <h3 class="red">【アクリルコースター（クリアコースター）】</h3>
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="アクリルコースター" />
          ...
          <div class="estimate-content" id="step1">
            ...
            <div class="part-container">
              <div class="part-content">
                <label class="part-name"><input type="radio" name="acy_size" value="90" onclick="check_val('next');" <?= $size90 ?>>90mmx90mm. <span class="checkmark"></span></label>
              </div>
            </div>
            <h3>数量</h3>
            <div class="part-container">
      ...
      <div>
        <div style="margin-bottom: 10px;">
          ...
          <div id="panel1" class="a-detail new-text">
            アクリルコースター（クリアコースター）の注文画面はカート形式となっております。この場合、まずAデザインのご注文をカートに入れていただき、その後「買い物を続ける」ボタンをクリックしてください。アクリル製品一覧画面に移行しますので、再度アクリルコースター（クリアコースター）のページに行き、注文画面からBデザインのご注文をカートに入れてください。カートに2つの注文が入っていることをご確認後「購入へ」ボタンをクリックし、ご購入のステップにお進みください。例えば、表面のデザインは同じで、裏面のデザインだけが異なる場合も、別々の注文として2件のご注文をカートに入れていただく必要がございます。
          </div>
        </div>
        <div style="margin-bottom: 10px;">
          <div class="quest">Q</div>
  ...
  <script type="text/javascript" src="<?= $cal_acrylic_coaster_js ?>"></script>
            ...
            <?php echo $json_ld_output; ?>, {
                ...
                "itemListElement": [{
                    ...
                    },
                    {
                        "@type": "ListItem",
                        "position": 3,
                        "name": "アクリルコースター（クリアコースター）",
                        "item": "https://hotmobily.jp/products/acrylic/coaster"
                    }
                ]
            }
        ]
