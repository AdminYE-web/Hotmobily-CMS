...
// *************************************************************
$product_name = "【ホットモバイリー】オリジナルアクリルクリップ（アクリルバッジ）";
$product_description = "オリジナルアクリルクリップ（アクリルバッジ）をオーダーメイドで製作。最短6営業日で出荷可能。小ロット1個から製作。最安単価168円。安価に作成できるバッジアイテムとして最適";
$product_image_url = "https://hotmobily.jp/products/acrylic/img/acyl-bg01.webp";
$product_sku = "HM-ABG-2024";
$product_price = 168;
$product_currency = "JPY";
$product_availability = "InStock";
$product_url = "https://hotmobily.jp/products/acrylic/badge";
...
<head>
  ...
  <meta name="keywords" content="アクリルクリップ（アクリルバッジ）,オリジナル,名入れ,製作,作成,アクキー,剥がれない,1個から">
  <meta name="description" content="オリジナルのアクリルクリップ（アクリルバッジ）が1個から注文可。剥がれない印刷。激安価格で、小ロット、短納期を実現">
  <meta name="robots" content="index,follow">
  <title>アクリルクリップ（アクリルバッジ）の製作。1個から注文可。保護フィルムで、印刷が剥がれません。</title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1>アクリルクリップ（アクリルバッジ）の製作。1個から注文可。保護フィルムで、印刷が剥がれません(2026年版)</h1>
      <div class="social-time">
        <span class="social-content">
          <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのアクリルクリップ（アクリルバッジ）が製作できます。剥がれない印刷。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/badge" title="Share by Email" target="_blank">シェアする</a><a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのアクリルクリップ（アクリルバッジ）が製作できます。剥がれない印刷。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/badge" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
          ...
          <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fbadge&amp;text=オリジナルのアクリルクリップ（アクリルバッジ）が製作できます。剥がれない印刷。激安価格で、小ロット、短納期を実現" target="_blank"><i class="fab fa-twitter-square"></i></a>
        </span>
          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_01" src="img/acyl-bg01.webp" data-zoom-image="img/acyl-bg01.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_02" src="img/acyl-bg02.webp" data-zoom-image="img/acyl-bg02.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_03" src="img/acyl-bg03.webp" data-zoom-image="img/acyl-bg03.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_04" src="img/acyl-bg04.webp" data-zoom-image="img/acyl-bg04.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
            </div>
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="img/acyl-bg01.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="img/acyl-bg02.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="img/acyl-bg03.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="img/acyl-bg04.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
      ...
      <!-- <div class="flex-container">
        ...
        <div class="flex-item item">
          <div class="btn-container item_btn" style="display: flex;justify-content: space-between;">
            ...
            <a class="btn-a btn-yellow" href="/contact/?item=アクリルクリップ（アクリルバッジ）">
              <span>無料サンプル</span>
            </a>
          </div>
        </div>
      ...
      <br><br>
      <a class="new-text" href="/contact/?item=アクリルクリップ" >無料サンプルの送付をリクエスト</a>

      <div id="download_templete" class="download_templete">
        <div class="modal-content">
          <span class="close">&times;</span>
          <h3>アクリルクリップ（アクリルバッジ）【Illustrator／Photoshop】</h3>
          <table class="table_rubber">
            <tbody>
              <tr>
                <td>50×50mm</td>
                <td>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_clip_50mm_20250320.ai">
                    <div><img src="img/ai-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_clip_50mm_20250320.psd">
              ...
              <tr>
                <td>75×75mm</td>
                <td>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_clip_75mm_20250320.ai">
                    <div><img src="img/ai-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_clip_75mm_20250320.psd">
                    <div><img src="img/psd-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                </td>
              </tr>
              <tr>
                <td>100×100mm</td>
                <td>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_clip_100mm_20250320.ai">
                    <div><img src="img/ai-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-acrylic_clip_100mm_20250320.psd">
                    <div><img src="img/psd-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                </td>
              </tr>
        ...
        <div class="modal-content data">
          ...
          <table class="table_rubber">
            <tbody>
              <tr>
                <td>
                  <a class="btn-a btn-yellow" href="/products/data-acrylic-badge.php" target="_blank">
      ...
      <a class="new-text" href="/products/acrylic/template/template-acrylic-clip.zip" download>入稿データテンプレートをダウンロード</a>
      <br>
      <br>
        ...
        <div class="swiper-container swiper2">
          <div class="swiper-wrapper swiper-bt">
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/138.webp" data-lightbox="acrylic-6" style="text-decoration:none;" data-title="">
                <img src="/gallery/img-acrylic/2023-acrylic-gallery/138.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/139.webp" data-lightbox="acrylic-6" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/140.webp" data-lightbox="acrylic-7" style="text-decoration:none;" data-title="">
                <img src="/gallery/img-acrylic/2023-acrylic-gallery/140.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/141.webp" data-lightbox="acrylic-7" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/142.webp" data-lightbox="acrylic-8" style="text-decoration:none;" data-title="">
                <img src="/gallery/img-acrylic/2023-acrylic-gallery/142.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/143.webp" data-lightbox="acrylic-8" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/144.webp" data-lightbox="acrylic-8" style="text-decoration:none;" data-title="">
                <img src="/gallery/img-acrylic/2023-acrylic-gallery/144.webp" class="picpro">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/145.webp" data-lightbox="acrylic-8" data-title=""></a>
            </div>
          </div>
        </div>
      ...
      <!-- <a href="/products/data-acrylic-badge.php" target="_blank"><img src="img/banner_design_data.webp" width="100%" height="388" style="max-width:770px;"></a> -->
      ...
      <div style="overflow: unset!important;">
        <div class="fixed-contrainer">
          <h3 class="red">【アクリルクリップ（アクリルバッジ）】</h3>
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="アクリルクリップ" />
          ...
          <div class="estimate-content" id="step2">
            ...
            <div class="flex-container">
              <div class="preview-container">
                <div class="preview-sub flex-container">
                  <?php
                  include('part-badge.php');
                  $i = 0;
                  for ($i = 0; $i < count($attachment); $i++) {
                    echo '
										<div class="flex-item">
										<label class="part-name">
										<input type="radio" name="acy_part" value="' . $attachment[$i]["part_name"] . '" onclick="getPartData3(\'' . $attachment[$i]["part_name"] . '\')" ' . ($acy_part == $attachment[$i]["part_name"] ? 'checked' : '') . '>
      ...
      <div>
        <div style="margin-bottom: 10px;">
          ...
          <div id="panel1" class="a-detail new-text">
            アクリルクリップ（アクリルバッジ）の注文画面はカート形式となっております。この場合、まずAデザインのご注文をカートに入れていただき、その後「買い物を続ける」ボタンをクリックしてください。アクリル製品一覧画面に移行しますので、再度アクリルクリップ（アクリルバッジ）のページに行き、注文画面からBデザインのご注文をカートに入れてください。カートに2つの注文が入っていることをご確認後「購入へ」ボタンをクリックし、ご購入のステップにお進みください。例えば、表面のデザインは同じで、裏面のデザインだけが異なる場合も、別々の注文として2件のご注文をカートに入れていただく必要がございます。
          </div>
        </div>
        <div style="margin-bottom: 10px;">
          <div class="quest">Q</div>
            ...
            <?php echo $json_ld_output; ?>, {
                ...
                "itemListElement": [{
                    ...
                    },
                    {
                        "@type": "ListItem",
                        "position": 3,
                        "name": "アクリルクリップ（アクリルバッジ）",
                        "item": "https://hotmobily.jp/products/acrylic/badge"
                    }
                ]
            }
        ]
