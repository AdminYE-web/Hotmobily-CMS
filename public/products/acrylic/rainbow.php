...
// *************************************************************
$product_name = "【ホットモバイリー】オリジナルレインボーアクリルキーホルダー";
$product_description = "オリジナルレインボーアクリルキーホルダーをオーダーメイドで製作。最短6営業日で出荷可能。小ロット1個から製作できます。最安188円。虹色にきらめく演出で記念品に最適";
$product_image_url = "https://hotmobily.jp/products/images/crystal_rainbow_03s.webp";
$product_sku = "HM-RAK-2025";
$product_price = 188;
$product_currency = "JPY";
$product_availability = "InStock";
$product_url = "https://hotmobily.jp/products/acrylic/rainbow.php";
...
<head>
  ...
  <title><?= lang('光を反射して虹色に！レインボーアクリルキーホルダー') ?></title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <div id="" class="">
        <h1 class=""><?= lang('光を反射して虹色に！レインボーアクリルキーホルダー！') ?></h1>
        <div class="social-time ">
          <span class="social-content">
            <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0A光を反射して虹色に！レインボーアクリルキーホルダー！剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/rainbow.php" title="Share by Email" target="_blank"><?= lang('シェアする') ?></a><a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0A光を反射して虹色に！レインボーアクリルキーホルダー！剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/rainbow.php" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
            <a href="https://www.facebook.com/share.php?u=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2frainbow.php" target="_blank"><i class="fab fa-facebook-square"></i></a>
            <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2frainbow.php&amp;text=光を反射して虹色に！レインボーアクリルキーホルダー！剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現" target="_blank"><i class="fab fa-twitter-square"></i></a>
          </span>
      ...
      <div id="">
        <img src="/products/images/banner_rainbow_v2s.webp" alt="オリジナルアクリルキーホルダー(アクキー)の製作。1個から注文可。保護フィルムで、印刷が剥がれません(2024年版)" width="771" height="390" />
      </div>
      ...
      <div class="" id="">
        <div class="flex-container">
          ...
          <!-- <div class="flex-item item">
            ...
            <swiper-slide><img src="/products/images/rainbow_v2_01.webp?dd=<?php echo date('is') ?>"></swiper-slide>
              <swiper-slide><img src="/products/images/rainbow_v2_02.webp?dd=<?php echo date('is') ?>"></swiper-slide>
              <swiper-slide><img src="/products/images/crystal_rainbow_01s.webp?dd=<?php echo date('is') ?>"></swiper-slide>
              <swiper-slide><img src="/products/images/crystal_rainbow_02s.webp?dd=<?php echo date('is') ?>"></swiper-slide>
            </swiper-container>
          </div> -->
          <div class="flex-item item new-text" style="display:grid;align-content: center;line-height: 2;">
            <h2 style="margin-top: 0px;"><?= lang('オリジナルのデザインで、レインボーアクキーをご制作！') ?></h2><br>
            <p class="new-text">
                光を反射して虹色に光るアクリルキーホルダーを、あなたのデザインでご制作！ノーマルタイプとクリスタルタイプの2種類をご用意！<br><br>
              大ロットなら1個188円（税込）からの激安価格！さらに1個だけのご注文も可能です！<br><br>
              オリジナルのキャラクターやロゴ、思い出の写真などが、光を反射して虹色に輝く特別なアクキーに。同人グッズや社名入りノベルティなど幅広くご利用頂けます。<br><br>
            </p>
          </div>
      ...
      <h2><?= lang('レインボーアクリルキーホルダーの特徴') ?></h2>
      <p class="new-text">レインボーアクリルキーホルダーには、一般的なアクリルキーホルダーとは異なる次のような特徴があります。</p>
      <h2 class="feature1 new-text">動きのある輝きで、どんな場面でも印象的に</h2>
      <p style="padding-top: 10px!important;" class="new-text">バッグやポーチに揺れるたびに、レインボーの輝きが生まれ、まるで動いているかのような表情を演出します。歩く、光を浴びる、写真を撮る——そのすべての瞬間で表情を変えるキーホルダーは、日常に彩りと遊び心を添える存在に。使う人自身が主役になるような、存在感と華やかさを兼ね備えたアイテムです。</p>
      <h2 class="feature2 new-text">オリジナルデザインがより際立つ「光の演出」</h2>
      <p style="padding-top: 10px!important;" class="new-text">デザインまわりの透明なアクリル部分が、レインボー加工により光を反射して華やかな虹色の色彩を映し出します。どんなイラストやロゴでも、光と色彩の演出の効果でワンランク上の完成度へ。ただ印刷されたデザインではなく、光・色彩・デザインが組み合わさったプレミアムな逸品をご提供します。</p>
      <h2 class="feature3 new-text">特別感のあるギフト・記念品にも最適</h2>
      <p style="padding-top: 10px!important;" class="new-text">レインボー加工の虹色の輝きは、限定品や記念品としての高級感を際立たせます。 イベントグッズや周年記念アイテム、ファンへのプレゼントとしても人気が高く、手にした瞬間に「特別なものをもらった」と感じてもらえる仕上がりです。デザインだけでなく「光の魔法」で想いを伝えるギフトに最適です。</p>
      <hr>
      <div style="clear: both;"></div>


        <h2><?= lang('ノーマルタイプとクリスタルタイプの2種類をご用意！') ?></h2>
        <div class="new-text">
            <p>レインボーアクリルキーホルダーは、ノーマルタイプとクリスタルタイプの2種類をご用意しております。タイプによって、レインボーの光の出方が異なります。</p>
            <br>

            <div class="row-slider">
                <div class="flex-item item">
                    <div style="text-align:center;">ノーマルタイプ</div>
                    <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
                        <swiper-slide><img onclick="openSimpleModal(this)" src="/products/images/rainbow_v2_01s.webp?dd=<?php echo date('is') ?>"></swiper-slide>
                    </swiper-container>
                ...
                <div class="flex-item item">
                    <div style="text-align:center;">クリスタルタイプ</div>
                    <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true">
                        <swiper-slide><img onclick="openSimpleModal(this)" src="/products/images/crystal_rainbow_01s.webp?dd=<?php echo date('is') ?>"></swiper-slide>
                    </swiper-container>
                    <div class="camera-left" style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">📷<?= lang('クリックすると拡大します') ?>
                    </div>
                </div>
            ...
            <br>
            <p>どちらをお選び頂いても、料金は変わりません。注文フォームでのご注文の際に、お好みの方をお選びください。</p>
        ...
        <div class="swiper-container swiper2">
          <div class="swiper-wrapper swiper-bt">
            ...
            <div class="swiper-slide">
              <div class="prodate">バレリーナ</div>
              <a href="/products/images/rainbow_ballerina01.webp" data-lightbox="acrylic_swiper15" style="text-decoration:none;" data-title="">
                <img src="/products/images/rainbow_ballerina01.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/images/rainbow_ballerina02.webp" data-lightbox="acrylic_swiper15" data-title=""></a>
            </div>

            <div class="swiper-slide">
              <div class="prodate">クリスマスの女の子</div>
              <a href="/products/images/rainbow_girl01.webp" data-lightbox="acrylic_swiper16" style="text-decoration:none;" data-title="">
                <img src="/products/images/rainbow_girl01.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/images/rainbow_girl02.webp" data-lightbox="acrylic_swiper16" data-title=""></a>
            </div>

            <div class="swiper-slide">
              <div class="prodate">ケモ耳の女の子</div>
              <a href="/products/images/rainbow_kemo01.webp" data-lightbox="acrylic_swiper1" style="text-decoration:none;" data-title="">
                <img src="/products/images/rainbow_kemo01.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/images/rainbow_kemo02.webp" data-lightbox="acrylic_swiper1" data-title=""></a>
            </div>

            <div class="swiper-slide">
              <div class="prodate">女性の写真</div>
              <a href="/products/images/crystal_rainbow_03s.webp" data-lightbox="acrylic_swiper20" style="text-decoration:none;" data-title="">
                <img src="/products/images/crystal_rainbow_03s.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/images/crystal_rainbow_04s.webp" data-lightbox="acrylic_swiper20" data-title=""></a>
            </div>

            <div class="swiper-slide">
              <div class="prodate">猫耳の女の子</div>
              <a href="/products/images/crystal_rainbow_05s.webp" data-lightbox="acrylic_swiper21" style="text-decoration:none;" data-title="">
                <img src="/products/images/crystal_rainbow_05s.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/images/crystal_rainbow_06s.webp" data-lightbox="acrylic_swiper21" data-title=""></a>
            </div>

            <div class="swiper-slide">
              <div class="prodate">猫イラスト</div>
              <a href="/products/images/crystal_rainbow_07s.webp" data-lightbox="acrylic_swiper22" style="text-decoration:none;" data-title="">
                <img src="/products/images/crystal_rainbow_07s.webp" class="picpro" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="/products/images/crystal_rainbow_08s.webp" data-lightbox="acrylic_swiper22" data-title=""></a>
            </div>
      ...
      <div>
        <div class="videoWrapper">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/gQU7fL28xhk?si=HU1xpCcmXoicNkfF" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
          <!-- <img src="/products/images/banner_default.jpg" data-src="pnKcyfuh4Rw" class="iframe" width="770" height="434">
                <div class="playbtn">
                <div class="tri"></div>
                </div> -->
        </div>
        <div>
          <br>
          <p class="new-text">レインボーアクリルキーホルダーは、太陽の光や室内のライトに照らされると表面が虹のようにきらめき、見る角度によって異なる色合いを見せるアクリルキーホルダーです。</p><br>
          <p class="new-text">お客様ご自身のキャラクター、ロゴ、イラスト、写真などで、特別感のある推し活グッズやイベント記念品を製作することができます。シンプルなデザインであっても、レインボーの反射効果が加わることで一気に存在感がアップ。思わず目を引く特別な仕上がりに！</p>
        </div>
      </div>
      ...
      <br><br>
      <a class="new-text" href="/contact/?item=レインボーアクリルキーホルダー" >無料サンプルの送付をリクエスト</a>
      ...
      <a class="new-text" href="/products/acrylic/template/template-rainbow-acrylic.zip" download>入稿データテンプレートをダウンロード</a>
      <br>
      <br>
      ...
      <div style="overflow: unset!important;">
        <div class="fixed-contrainer">
          <h3 class="red">【<?= lang('レインボーアクリルキーホルダー') ?>】</h3>
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="レインボーアクリルキーホルダー" />
          ...
          <div class="estimate-content" id="step1">
            ...
            <div class="part-container">
              <div class="part-content">
                <label class="part-name"><input type="radio" name="shape_processing" value="ノーマルタイプ" > ノーマルタイプ <span class="checkmark"></span></label>
              </div>
              <div class="part-content">
                <label class="part-name"><input type="radio" name="shape_processing" value="クリスタルタイプ"  >クリスタルタイプ <span class="checkmark"></span></label>
              </div>
      ...
      <table class="table_rubber" style="padding: 0 ;">
        <tr>
          ...
          <td class=""><?= lang('レインボーアクリルキーホルダー') ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class=""><?= lang('印刷面をフィルム保護。レインボーホログラム加工。CNCカット') ?></td>
        </tr>
        <tr>
          <td class="TableLeft"><?= lang('納期') ?></td>
  ...
  <script type="text/javascript" src="/products/acrylic/js/calculate_rainbow-v2.js?v=<?php echo date('is') ?>"></script>
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function() {
      ...
      const imageList = [{
          src: "/products/images/rainbow_v2_01.webp",
          targetId: "processing"
        },
        {
          src: "/products/images/rainbow_v2_02.webp",
          targetId: "special"
        },
        {
          src: "/products/images/crystal_rainbow_01s.webp",
          targetId: "plans"
        },
        {
          src: "/products/images/crystal_rainbow_02s.webp",
          targetId: "production"
        },
            ...
            <?php echo $json_ld_output; ?>, {
                ...
                "itemListElement": [{
                    ...
                    },
                    {
                        "@type": "ListItem",
                        "position": 3,
                        "name": "レインボーアクリルキーホルダー",
                        "item": "https://hotmobily.jp/products/acrylic/rainbow.php"
                    }
                ]
            }
        ]
