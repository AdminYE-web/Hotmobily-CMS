...
<body id="top">
    ...
    <div id="wrapper">
        ...
        <div id="content_wrapper" class="scrollingPanel">
            ...
            <div class="container">
                ...
                <div class="product-details" id="">
                    ...
                    <div class="info-card">
                        ...
                        <p class="new-text">最安単価がたったの550円（税込）！大ロットほど単価が安くなりお得です。</p>
            ...
            <div id="front-print">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="front-print-toggle" class="accordion-input" checked>
                        <label for="front-print-toggle" class="accordion-header" id="front-print-g">
                            <span class="fw-bold">フロントパーツにもデザインを印刷可能！</span>
                            <span class="icon"></span>
                        </label>
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">ご希望であれば、フロントパーツにもデザインを印刷することが可能です。</p>

                                <div class="blister-photo-grid">
                                    <div class="blister-photo-item">
                                        <div class="blister-photo-title">フロントパーツ印刷あり</div>
                                        <div class="blister-photo-box">
                                            <span>Photo</span>
                                            <!-- <img src="/products/acrylic/img/blister/photo1.webp" alt="フロントパーツ印刷あり"> -->
                                        </div>
                                    </div>

                                    <div class="blister-photo-item">
                                        <div class="blister-photo-title">フロントパーツ印刷なし</div>
                                        <div class="blister-photo-box">
                                            <span>Photo</span>
                                            <!-- <img src="/products/acrylic/img/blister/photo2.webp" alt="フロントパーツ印刷なし"> -->
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <p class="new-text">なお、フロントパーツ印刷ありの場合、フロントパーツ印刷料金が33円（税込／単価）が発生します。</p>
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                ...
                                <br>
                                <p class="new-text">200個を超える個数のご注文は <a href="https://hotmobily.jp/contact/">個別にお問い合わせ</a> ください。</p>
                                <br>
                                <p class="new-text">サイズは以下をご確認ください。</p>

                                <div class="blister-size-photo-row">

                                    <div class="mt-10-part blister-size-photo">
                                        <div class="blister-photo-title">Sサイズ</div>

                                        <a href="/products/images/HM_part5.webp"
                                            data-lightbox="blister-size-s"
                                            data-title="<strong>Sサイズ</strong>">
                                            <div class="blister-photo-box">
                                                <span>Photo</span>
                                                <!-- ถ้ามีรูปจริง ให้เปิด img นี้ -->
                                                <!-- <img class="picpro lazy" data-src="/products/images/HM_part5.webp" width="229" height="229" loading="lazy"> -->
                                            </div>
                                        </a>

                                        <a href="/products/images/HM_part5.webp"
                                            data-lightbox="blister-size-s-zoom"
                                            data-title="<strong>Sサイズ</strong>"
                                    ...
                                    <div class="mt-10-part blister-size-photo">
                                        <div class="blister-photo-title">Mサイズ</div>

                                        <a href="/products/images/HM_part5.webp"
                                            data-lightbox="blister-size-m"
                                            data-title="<strong>Mサイズ</strong>">
                                            <div class="blister-photo-box">
                                                <span>Photo</span>
                                                <!-- <img class="picpro lazy" data-src="/products/images/HM_part5.webp" width="229" height="229" loading="lazy"> -->
                                            </div>
                                        ...
                                        <a href="/products/images/HM_part5.webp"
                                            data-lightbox="blister-size-m-zoom"
                                            data-title="<strong>Mサイズ</strong>"
                                            style="font-size: 10px">
                                            📷<?= lang('クリックすると拡大します') ?>
                                        </a>
                                    ...
                                    <div class="mt-10-part blister-size-photo">
                                        <div class="blister-photo-title">Lサイズ</div>

                                        <a href="/products/images/HM_part5.webp"
                                            data-lightbox="blister-size-l"
                                            data-title="<strong>Lサイズ</strong>">
                                            <div class="blister-photo-box">
                                                <span>Photo</span>
                                                <!-- <img class="picpro lazy" data-src="/products/images/HM_part5.webp" width="229" height="229" loading="lazy"> -->
                                            </div>
                                        ...
                                        <a href="/products/images/HM_part5.webp"
                                            data-lightbox="blister-size-l-zoom"
                                            data-title="<strong>Lサイズ</strong>"
                                            style="font-size: 10px">
                                            📷<?= lang('クリックすると拡大します') ?>
                                        </a>
                                ...
                                <br>
                                <p class="new-text">フロントパーツにデザインを印刷する場合の料金（税込／単価）は以下です。</p>
                                <br>
                               <table
    ...
    <tbody>
        <tr>
            <td style="width: 50%; border: 1px solid #999;">フロントパーツ印刷料金</td>
            <td style="width: 50%; border: 1px solid #999;">33円</td>
        </tr>
    </tbody>
</table>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/blister/blisteracrylic-banner05.webp" alt="" width="100%" loading="lazy">
                                </div>
                                <br>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                ...
                                <div>
                                    <div style="display: flex">
                                        <div class="delivery">
                                            <span class="btn-a std-btn"><?= lang('31～50個の注文'); ?></span>
                                        </div>
                                        <div class="delivery">
                                            <div class="tb_02" style="color: #006ab1; padding: 2px 5px">
                                                <?= lang('12営業日後出荷'); ?>
                ...
                <div style="overflow: unset!important;">
                    ...
                    <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                        ...
                        <div class="estimate-content" id="step1">
                            ...
                            <input type="hidden" name="acy_delivery" value="10営業日">

                            <h3><?= lang('サイズ') ?></h3>
                            <div class="part-container">
                                <div class="part-content">
<label class="part-name"><input type="radio" name="acy_size" value="Sサイズ" <?= $sizeS ?>><?= lang('Sサイズ') ?> <span class="checkmark"></span></label>                                </div>
                                <div class="part-content">
<label class="part-name"><input type="radio" name="acy_size" value="Mサイズ" <?= $sizeM ?>><?= lang('Mサイズ') ?> <span class="checkmark"></span></label>                                </div>
                                <div class="part-content">
<label class="part-name"><input type="radio" name="acy_size" value="Lサイズ" <?= $sizeL ?>><?= lang('Lサイズ') ?> <span class="checkmark"></span></label>                                </div>
                            </div>
...
-->
    ...
    <script type="text/javascript">
        ...
        function fetchHolidayData(productDays, successCallback) {
    console.log('[AJAX START]', productDays);
    ...
    $.ajax({
        ...
        success: function(data) {
            console.log('[AJAX SUCCESS]', productDays, data);

            var sortedData = data.sort();
            console.log('[AJAX SORTED]', productDays, sortedData);

            console.log('[CALL CALLBACK]', productDays, typeof successCallback);

            if (typeof successCallback === 'function') {
                successCallback(sortedData);
            } else {
                console.error('[CALLBACK IS NOT FUNCTION]', productDays, successCallback);
            }
        },

        error: function(xhr, status, error) {
            console.error('[AJAX ERROR]', productDays);
    ...
    console.log('[12days FUNCTION CALLED]', date);

    var str = date;
    var l = str.length - 1;
    var date_l = new Date(str[l]);
    var f = new Date(new Date().toLocaleString("en-US", { timeZone: "Asia/Tokyo" }));
    var dayOfWeekStrJP = ["日", "月", "火", "水", "木", "金", "土"];

    if (isNaN(date_l.getTime())) {
        console.error('[12days] invalid date:', date);
        return;
    }
    ...
    var startHtml =
        add_digi(parseInt(f.getMonth() + 1)) +
        "<span style='font-size:18px;'>月</span>" +
        add_digi(f.getDate()) +
        "<span style='font-size:18px;'>日(" + dayOfWeekStrJP[f.getDay()] + ")</span> " +
        add_digi(f.getHours()) + ":" + add_digi(f.getMinutes());

    var endHtml =
        add_digi(parseInt(date_l.getMonth() + 1)) +
        "<span style='font-size:18px;'>月</span>" +
        add_digi(date_l.getDate()) +
        "<span style='font-size:18px;'>日(" + dayOfWeekStrJP[date_l.getDay()] + ")</span>";

    $('#date_create_12day_1').html(startHtml);
    $('#date_create_12day_2').html(endHtml);

    // ด้านบน 出荷目安（通常納期）
    $('#date_create2x1').html(endHtml);

    console.log('[12days endHtml]', endHtml);
    console.log('[after set #date_create2x1]', $('#date_create2x1').html());
}
    ...
    console.log('#date_create2x1 exists:', $('#date_create2x1').length);

    fetchHolidayData("10days", productionDate10Days);
    fetchHolidayData("11days", productionDate11Days);
    fetchHolidayData("12days", productionDate12Days);
    fetchHolidayData("15days", productionDate15Days);
    fetchHolidayData("16days", productionDate16Days);
