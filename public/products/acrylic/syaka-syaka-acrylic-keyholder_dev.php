...
<head>
    ...
    <style>
        ...
        #date_create_11day_1,#date_create_11day_2, #date_create_12day_1,#date_create_12day_2, #date_create_15day_1,#date_create_15day_2, #date_create_16day_1,#date_create_16day_2{
            font-size: 22px;
            font-weight: bold;
            color: red;
            letter-spacing: -1px; 
            ...
            <div class="container">
                <div class="product-gallery" id="">
                    ...
                    <div class="pdp-v2-thumb-grid" id="pdp-v2-js-grid-pc">
                         <img src="/products/acrylic/img/syaka/syakasyaka_acrylic01.webp" alt="ラバーストラップ制作事例（ロゴ）" width="600" height="600"
                            class="pdp-v2-thumb-item" data-index="0" loading="lazy">
                        <img src="/products/acrylic/img/syaka/syakasyaka_acrylic02.webp" width="600" height="600"
                            alt="ラバーストラップ制作事例（文字デザイン）" class="pdp-v2-thumb-item" data-index="1" loading="lazy">
                        <img src="/products/acrylic/img/syaka/syakasyaka_acrylic03.webp" width="600" height="600"
                            alt="ラバーストラップ制作事例（キャラクター）" class="pdp-v2-thumb-item" data-index="2" loading="lazy">
                        <img src="/products/acrylic/img/syaka/syakasyaka_acrylic04.webp" width="600" height="600"
                            alt="ラバーストラップ制作事例（女の子キャラ）" class="pdp-v2-thumb-item" data-index="3" loading="lazy">
                      
                             <img src="/products/acrylic/img/syaka/syakasyaka_acrylic05.webp" width="600" height="600"
                            alt="ラバーストラップ制作事例（ケモ耳女の子キャラ）" class="pdp-v2-thumb-item pdp-v2-active-state" data-index="4">
                        <img src="/products/acrylic/img/syaka/syakasyaka_acrylic06.webp?v=1" width="600" height="600"
                ...
                <div class="product-details" id="">
                    ...
                    <div class="info-card">
                        ...
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text" onclick="GotoDiv(9)"
                                >詰め替えの詳細</a>
                        </div>
                    </div>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <a class="btn-a btn-yellow"
                                            href="download/download.php?fname=syakasyaka_acrylic_template.zip"
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/syaka/70mm_banner-02.webp" alt="" loading="lazy">
                                </div>
                                <br>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="poster-grid">
                                        <div class="poster-item">
                                            <div class="text-center" style="text-align:center;"><p class="new-text">金色ハトメ</p></div>
                                            <div>
                                        ...
                                        <div class="poster-item">
                                            <div class="text-center" style="text-align:center;"><p class="new-text">銀色ハトメ</p></div>
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
