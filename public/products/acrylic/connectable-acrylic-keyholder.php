...
<head>
    ...
    <meta name="keywords" content="2連アクリルキーホルダー">
    <meta name="description"
        content="2連アクリルキーホルダー製作！最大5個までパーツを繋げられるオリジナルの連結アクリルキーホルダー（アクキー）を1個から製作可能！カニカン金具で付け替えやカスタムも自由自在。印刷が剥がれない安心の保護フィルム付き。同人グッズや推し活、ノベルティに">
    <meta name="robots" content="index,follow" />
    <title>2連アクリルキーホルダー製作|3連・4連・5連も可|オリジナル</title>
    <link rel="canonical" href="https://hotmobily.jp/products/acrylic/connectable-acrylic-keyholder">
...
<body id="top">
    ...
    <div id="wrapper">
        ...
        <div id="content_wrapper" class="scrollingPanel">
            ...
            ?>
            <div id="">
                <h1 class="h1-new">2連アクリルキーホルダー（2連アクキー）【2026年版】</h1>
            ...
            <div class="container">
                <div class="product-gallery" id="">
                    ...
                    <div class="pdp-v2-main-viewport">
                        <div class="pdp-v2-image-strip" id="pdp-v2-js-strip">
                            ...
                            <div class="pdp-v2-main-link" data-index="0">
                                ...
                                <img src="/products/acrylic/img/connectable/050526_artboard 13 copy.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="1">
                                ...
                                <img src="/products/acrylic/img/connectable/050526_artboard 22.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="2">
                                ...
                                <img src="/products/acrylic/img/connectable/connectable acrylic keychains_11.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="3">
                                ...
                                <img src="/products/acrylic/img/connectable/connectable acrylic keychains_12.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="4">
                                ...
                                <img src="/products/acrylic/img/connectable/connectable acrylic keychains_13.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="5">
                                ...
                                <img src="/products/acrylic/img/connectable/connectable acrylic keychains_4.webp?v=1"
                    ...
                    <div class="pdp-v2-thumb-grid" id="pdp-v2-js-grid-pc">
                        <img src="/products/acrylic/img/connectable/050526_artboard 13 copy.webp" alt="シャカシャカアクリルキーホルダーの製作事例" width="189" height="189"
                            class="pdp-v2-thumb-item" data-index="0" loading="lazy">
                        <img src="/products/acrylic/img/connectable/050526_artboard 22.webp" width="189" height="189"
                            alt="開いたシャカシャカアクリルキーホルダー" class="pdp-v2-thumb-item" data-index="1" loading="lazy">
                        <img src="/products/acrylic/img/connectable/connectable acrylic keychains_11.webp" width="189" height="189"
                            alt="グレーのシャカシャカアクリルキーホルダー" class="pdp-v2-thumb-item" data-index="2" loading="lazy">
                        <img src="/products/acrylic/img/connectable/connectable acrylic keychains_12.webp" width="189" height="189"
                            alt="シャカシャカアクリルキーホルダーのパーツ" class="pdp-v2-thumb-item" data-index="3" loading="lazy">
                        <img src="/products/acrylic/img/connectable/connectable acrylic keychains_13.webp" width="189" height="189"
                            alt="ピンクのシャカシャカアクリルキーホルダー" class="pdp-v2-thumb-item pdp-v2-active-state" data-index="4">
                        <img src="/products/acrylic/img/connectable/connectable acrylic keychains_4.webp?v=1" width="189" height="189"
                ...
                <div class="product-details" id="">
                    <div class="price-box">
                        <p class="lpc"><span class="text-orange">参考単価：</span>1個396円（税込）</p>
                    </div>

                    <div class="price-box">
                        <p class="lpc"><span class="text-orange">100個合計金額：</span>39,600円（税込）</p>
                    </div>
                    ...
                    <div class="">
                        <small class="note">※出荷目安は本日原稿が確定した場合の日付です。<a href="javascript:void(0)" onclick="GotoDiv(2)">納期の詳細はこちら</a></small><br>
                        <!-- <small class="note">※上記よりも早くお届けする6営業日後出荷コースもございます。<a href="javascript:void(0)" class=""
                                onclick="GotoDiv(2)">納期詳細はこちら</a></small> -->
                    </div>

                    <h2 class="promo-title" style="color: #cc3f44; !important;">3連・4連・5連も可能！表現の幅が広がる連結アクキー！</h2>

                    <div class="info-card">
                        <h3 class="lpc">最安単価300円（税込）！</h3>
                        <a onclick="GotoDiv(3)" href="javascript:void(0)"><img
                                src="/products/acrylic/img/connectable/connectible key chain_300_more.webp" alt="業界最短7日出荷"
                                width="660" height="100%" loading="lazy"></a>
                        <p class="new-text">大ロット製作ほどお得！片面印刷1,000個製作の場合で1個あたりの製作料金が300円（税込）になります。</p>
                    ...
                    <div class="info-card">
                        <h3 class="lpc">バリエーション豊富！3連・4連・5連も可能！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(10)"><img
                                src="/products/acrylic/img/connectable/Connectable-Acrylic-Keychains1.webp" alt="業界最安値価格" width="660"
                                height="100%" loading="lazy"></a>
                        <p class="new-text">
                            アクリルパーツ3つ・4つ・5つの連結も可能です。豊富なバリエーションが世界観を彩ります！
                        </p>
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text" onclick="GotoDiv(10)">連結の詳細</a>
                        </div>
                    </div>

                    <div class="info-card">
                        <h3 class="lpc">印刷がはがれない！保護フィルムで印刷を保護！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(8)"><img
                                src="/products/acrylic/img/connectable/protection_connectible key chain_more.webp" alt="汚れ防止加工" width="660"
                                height="100%" loading="lazy"></a>
                        <p class="new-text">当店の連結キーホルダーのアクリルパーツは、すべて保護フィルムで印刷を保護しています。印刷がはがれる心配がありません。</p>
                        <div style="text-align:right;">
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="connectable-toggle" class="accordion-header" id="video-g">
                            <span class="fw-bold">アクリルパーツを5個まで連結可能！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/connectable/Connectable-Acrylic-Keychains1-2.webp" alt="" width="100%" loading="lazy">
                                </div>
                                <br>
                                <div>
                                    <p class="new-text">お好みのデザインを自由に組み合わせて、オリジナルの2連アクリルキーホルダー（連結アクリルキーホルダー）を作ってみませんか？</p>
                                    <br>
                                    <p class="new-text">1つのキーホルダーに複数のアクリルパーツを繋げることで、表現の幅がぐっと広がる大人気のアイテムです。ホットモバイリーでは、最大5個までお好きな形状・デザインのアクリルパーツを連結させて製作することが可能です！連結キーホルダーには、次のような魅力があります！</p>

                                    <h3 class="h3-new fw-bold">世界観やストーリーを表現できる！</h3>
                                    <p class="new-text">メインのキャラクターに、そのキャラのセリフや持ち物のパーツを組み合わせることで、グッズにストーリー性を持たせることができます。他にも、関係性のある複数のキャラクターを連ねたり、漫画やアニメのストーリーのキーとなるアイテムを連ねたり、さまざまな方法で世界観やストーリーを表現できます。</p>

                                    <h3 class="h3-new fw-bold">お気に入りを1つに詰め込める！</h3>
                                    <p class="new-text">ペットのいろいろな表情、物語の名シーン、お店の看板ロゴと看板メニューのセットなど、アイデア次第で組み合わせは無限大です。自分のお気に入り、あるいはファンに人気のアイテムたちを1つのキーホルダーに詰め込むことができます！</p>

                                    <h3 class="h3-new fw-bold">複数のパーツの動きがキュート！</h3>
                                    <p class="new-text">連結された複数のパーツがカチャカチャと揺れる動きは、単体のキーホルダーにはない大きな魅力です。カバンやポーチに付ければ、存在感を発揮して目を引くこと間違いなし！自社の社名やロゴ、キャラクターなどで製作すれば、一般的なアクリルキーホルダーよりも高いブランディング効果を期待できます。</p>
            ...
            <div id="acc-price">
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">2連アクリルキーホルダー（アクリルパーツ2個）の単価表です。</p>
                                <p class="new-text">納期と印刷面を選択してください。サイズ別の製作単価表が表示されます。ここは価格表のみです。<a href="javascript:void(0)" class="new-text" onclick="GotoDiv(1)">見積・注文はこちら</a>です。</p>
                                <br>
                                <h3><?= lang('納期') ?></h3>
                                ...
                                <div class="part-container">
                                    <div class="part-content" style="display: flex">
                                        ...
                                        <label class="part-name"><input type="radio" name="prc_screen" value="2" onclick="writePriceTable();" /><?= lang('両面印刷') ?>
                                            <span class="checkmark"></span></label>
                                    </div>
                                </div>
                                <br />
                                ...
                                <br>
                                <p class="new-text">3連アクリルキーホルダー（アクリルパーツ3個）・4連アクリルキーホルダー（アクリルパーツ4個）・5連アクリルキーホルダー（アクリルパーツ5個）をご注文の場合には、下記の通りアクリルパーツ追加代金が発生します。</p>
                                ...
                                <br>
                                <p class="new-text">製作には、AI形式の入稿データ（デザインデータ）が必要です。ご自身でデータを作成するのは難しい方向けに、無料のデータ作成補助サービス をご用意しております。お送り頂いたイラストや写真を元に、入稿データ作成を代行いたします。</p>
                                <br>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <a class="btn-a btn-yellow"
                                            href="/products/acrylic/template/template_renketsu_acrylic_ol.zip"
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                ...
                                <br>
                                <p class="new-text">制作開始日時は、デザインや仕様の確認が完了し、制作開始となった日時を指します。ご注文後、製品のデザインや仕様等についてのご連絡を当店営業からお客様へメールでお送りいたしますので、ご確認をお願いいたします。</p>
                                <br>
            ...
            <br>
            <div id="acc-connection">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="connection-toggle" class="accordion-input" checked>
                        <label for="connection-toggle" class="accordion-header">
                            <span class="fw-bold">接続パーツ</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div style="display: grid;gap: 8px;padding: 10px 0;background: #fff;grid-template-columns: repeat(2, 1fr);">
                                <div style="width: 100%;">
                                    <div style="text-align:center;">カニカン</div>
                                    <a href="/products/acrylic/img/connectable/connection-01-page.webp" data-lightbox="img-color-set-1" style="width: 100%;display: block;color: black;text-decoration: none!important;">
                                        <p class="fw-bold" style="text-align: center;"></p>
                                        <img src="/products/acrylic/img/connectable/connection-01-page.webp" alt="" loading="lazy" style="width: 100%;">
                                        <p>📷クリックすると拡大します</p>
                                    </a>
                                </div>
                                <div style="width: 100%;">
                                    <div style="text-align:center;">Oリング</div>
                                    <a href="/products/acrylic/img/connectable/connection-02-page.webp" data-lightbox="img-color-set-2" style="width: 100%;display: block;color: black;text-decoration: none!important;">
                                        <p class="fw-bold" style="text-align: center;"></p>
                                        <img src="/products/acrylic/img/connectable/connection-02-page.webp" alt="" loading="lazy" style="width: 100%;">
                                        <p>📷クリックすると拡大します</p>
                                    </a>
                                </div>
                            </div>
                            <br>
                            <p class="new-text">カニカンはアクリルパーツの付け外しができますが、Oリングはできません。アクリルパーツを付け外しできるようにしたい方は、接続パーツにカニカンをご選択ください。</p>
                        </div>
                    </div>
                </div>
            </div>
            <!--End Accordion Connection-->
            ...
            <div id="order-form">
                ...
                <div style="overflow: unset!important;">
                    <div class="fixed-contrainer">
                        <h3 class="red">【<?= lang('2連アクリルキーホルダー') ?>】</h3>
                    ...
                    <div class="step-container line1" style="padding: 5px;border: 1px solid lightgray;margin-bottom: 5px;">
                        ...
                        <div class="step-box line2" style="text-align: center;">
                            <!-- <img class="lazy" data-src="img/coming-soon.webp" style="display: none;" id="sample-part2-pic" class="picpro" width="500" height="500"><br /> -->
                            <!-- <span id="sample-part2-name"></span> -->
                        </div>
                    </div>
                    ...
                    <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                        <div style="display: table-column;">
                            <input type="text" name="ItemType" id="strap" value="2連アクリルキーホルダー" />
                        ...
                        <div class="estimate-content" id="step1">
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_cat" value="アクリルパーツ2個" onclick="" <?php echo (isset($acy_cat) ? ($acy_cat == "アクリルパーツ2個" ? "checked" : "") : "checked") ?>>アクリルパーツ2個<span class="checkmark"></span></label>
                                </div>
                                <div class="part-content ">
                                    <label class="part-name"><input type="radio" name="acy_cat" value="アクリルパーツ3個" onclick="" <?php echo (isset($acy_cat) ? ($acy_cat == "アクリルパーツ3個" ? "checked" : "") : "") ?>>アクリルパーツ3個<span class="checkmark"></span></label>
                                </div>
                                <div class="part-content ">
                                    <label class="part-name"><input type="radio" name="acy_cat" value="アクリルパーツ4個" onclick="" <?php echo (isset($acy_cat) ? ($acy_cat == "アクリルパーツ4個" ? "checked" : "") : "") ?>>アクリルパーツ4個<span class="checkmark"></span></label>
                                </div>
                                <div class="part-content ">
                                    <label class="part-name"><input type="radio" name="acy_cat" value="アクリルパーツ5個" onclick="" <?php echo (isset($acy_cat) ? ($acy_cat == "アクリルパーツ5個" ? "checked" : "") : "") ?>>アクリルパーツ5個<span class="checkmark"></span></label>
                                </div>
                            </div>
                            ...
                            <div class="acy_delivery">
                                ...
                                <div class="part-container">
                                    <div class="part-content">
                                        <label class="part-name"><input type="radio" name="acy_delivery" value="10営業日" onclick="" <?= $delivery_10 ?>>10<?= lang('営業日') ?><span class="checkmark"></span></label>
                                    </div>
                                    <div class="part-content ">
                                        <label class="part-name" <?= $delivery_disabled ?>><input type="radio" name="acy_delivery" value="6営業日" onclick="" <?= $delivery_6 ?> <?= $planDisabled ?>>6<?= lang('営業日') ?> <span class="checkmark"></span></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_size" value="50" <?= $size50 ?>>50x50mm. <span class="checkmark"></span></label>
                                </div>
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_size" value="75" <?= $size75 ?>>75x75mm. <span class="checkmark"></span></label>
                                </div>
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_size" value="100" <?= $size100 ?>>100x100mm. <span class="checkmark"></span></label>
                                </div>
                            </div>
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_screen" value="片面印刷" <?php echo (isset($acy_screen) ? ($acy_screen == "片面印刷" ? "checked" : "") : "checked") ?>><?= lang('片面印刷') ?> <span class="checkmark"></span></label>
                                </div>
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_screen" value="両面印刷" <?php echo (isset($acy_screen) ? ($acy_screen == "両面印刷" ? "checked" : "") : "") ?>><?= lang('両面印刷') ?> <span class="checkmark"></span></label>
                                </div>
                            </div>
                        ...
                        <div class="part-container">
                            ...
                            <div class="flex-container">
                                <div class="preview-container">
                                    ...
                                    <label class="part-name">
                                    <input type="radio" name="acy_part_connectable" value="' . $attachment_connectable[$i]["part_name"] . '" onclick="getPartDataC(\'' . $attachment_connectable[$i]["part_name"] . '\')" ' . ($acy_part_connectable == $attachment_connectable[$i]["part_name"] ? 'checked' : '') . '>
                                    ...
                                    <div class="error" id="part-connectable-error" style="text-align: center;"></div>
                                </div>
                            </div>
                                ...
                                <div class="flex-item">
                                    ...
                                    <table class="table_rubber">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="TableLeft"><?= lang('アクリルパーツ') ?></td>
                                                <td class="" id="prd_part_con" style="text-align: left;"></td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="flex-item">
                                    ...
                                    <table class="table_rubber total_price_tbl">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="TableLeft">アクリルパーツ追加代金</td>
                                                <td class=""><input id="prd_price_acrylic_part" type="text" name="prd_price_acrylic_part" readonly>円</td>
                                            </tr>
                                            <tr>
                                                <td class="TableLeft"><?= lang('アタッチメント') ?></td>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="custom-toggle" class="accordion-header">
                            <span class="fw-bold">アクリルパーツをカスタマイズ可能！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/connectable/banner connectible key chain_custom.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">2連アクリルキーホルダー（連結キーホルダー）は、ただ「複数のパーツがつながっている」だけではありません。最大の強みは、製作した後にパーツを自由に付け替えたり、順番を入れ替えたりできる「圧倒的なカスタマイズ性」にあります。</p>
                                <br>
                                <p class="new-text">パーツの接続部分に簡単に着脱できる金具（カニカンなど）を採用しているため、お持ちのパーツをその日の気分やシーンに合わせて、お客様自身の手でいつでも自由に組み替えることが可能です。この「後からカスタムできる」という特徴が、商品に以下のような新しい価値と魅力を生み出します。</p>

                                <h3 class="h3-new fw-bold">1. その日の気分で「着せ替え」を楽しむ</h3>
                                <p class="new-text">「今日はシンプルにメインのキャラクターだけをすっきりと持ち歩きたい」「明日はお出かけだから、お気に入りのパーツを全部繋げて華やかにしよう！」といった、日常のシーンに合わせた使い分けが可能です。1つのキーホルダーでありながら、パーツの組み合わせ次第で何通りもの表情を見せてくれるため、飽きることなく長く愛用していただけます。</p>
                                <br>

                                <h3 class="h3-new fw-bold">2. 新しいパーツを「買い足して育てる」コレクターズアイテムに</h3>
                                <p class="new-text">クリエイター様の物販グッズやアニメ・ゲームのキャラクターグッズとして展開する場合、この仕様は強力な武器になります。例えば、最初に「ベースとなるキャラクター」を販売し、その後のイベントやシーズンごとに「季節限定の衣装パーツ」や「新しいアイテムパーツ」をカプセルトイやブラインド仕様で追加販売する、といった展開が可能です。</p>
                                <br>
                                <p class="new-text">ファンにとっては「集めれば集めるほど、自分好みにキーホルダーを成長させられる」という、コレクションする楽しさやワクワク感を強力に刺激するアイテムとなります。</p>
                                <br>

                                <h3 class="h3-new fw-bold">3. レイアウトも自由自在！縦繋ぎから並列繋ぎまで</h3>
                                <p class="new-text">パーツを縦に長く1列に繋げるだけでなく、繋ぎ方を変えてボリューム感を出したり、特定のパーツだけを取り外して別のポーチのファスナーチャームとして使ったりと、使い方のアイデアは無限大です。愛犬やご家族の写真を使ったグッズなら、「新しい家族が増えたからパーツを1個追加する」といった、思い出とともにアップデートしていくような使い方も素敵です。</p>
                                <br>
                                <p class="new-text">「売って終わり」「作って終わり」にさせない、自由度MAXの付け替えカスタム機能。手に取ったお客様が思わず笑顔になるような、遊び心あふれるオリジナルグッズを一緒に作ってみませんか？</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/connectable/banner-connectable-dojin.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">イラストやキャラクターに込めた強いこだわり、そして作品の世界観を、たった1つのグッズの中にぎゅっと凝縮してみませんか？</p>
                                <br>
                                <p class="new-text">2連アクリルキーホルダー（連結キーホルダー）は、個人のクリエイター様や同人作家様の「もっと作品の世界観を表現したい！」「普通のグッズじゃ物足りない！」という熱い想いに応える、理想的なアイテムです。1枚のイラストだけでは描ききれなかった物語やキャラクターの魅力を、複数のパーツを繋げることで立体的かつエモく演出できます。</p>
                                <br>
                                <p class="new-text">メインのキャラクターパーツに、そのキャラを象徴するアイテム、セリフの吹き出し、ロゴなどを繋げることで、グッズ自体に深いストーリー性が生まれます。「このキャラなら、絶対にこの小物を持ち歩いているはず！」という、作者だからこそ作れるコアなこだわりを形にして、ファンに届けることができます。</p>
                                <br>
                                <p class="new-text">また、関係性の深い複数のキャラクターたちを連ねるのも、キャラクターたちの魅力やストーリーを伝えるのにぴったりです。ライバル関係にある二人やいつも一緒に活動している三人組などを1つの連結キーホルダーにすることで、キャラクターたちとその背景、ストーリーを1つの連結キーホルダーで表現することができます。</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/connectable/banner connectible key chain_oshi.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">アニメファンやアイドルファンに届ける推し活グッズとしても、2連アクリルキーホルダー（連結キーホルダー）は高い人気を誇ります。</p>
                                <br>
                                <p class="new-text">人気キャラクターとそのセリフ、アイテムなどを組み合わせた連結キーホルダーは、ファンの心をつかむこと間違いなし。他にも、作品のメインキャラクターたちを並べたり、キャラクターたちを象徴するロゴなどを連ねたりすることもできます。</p>
                                <br>
                                <p class="new-text">アイドルグループであれば、メンバーたちの立ち姿をそれぞれアクリルパーツにして連結させたり、過去のライブやコンサートのワンシーンをアクリルパーツにして連ねたりすることで、ファンに喜ばれる特別な推し活グッズを製作できます。</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="plan-section">
                                <table class="table_rubber" cellpadding="5" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td><?= lang('名称') ?></td>
                                            <td style="text-align: left;"><?= lang('2連アクリルキーホルダー') ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('素材') ?></td>
                                        ...
                                        <tr>
                                            <td><?= lang('サイズ') ?></td>
                                            <td style="text-align: left;">
                                                <?= lang('50X50mm / 75X75mm / 100X100mm') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('色数') ?></td>
                                        ...
                                        <tr>
                                            <td>特徴</td>
                                            <td style="text-align: left;">印刷面をフィルム保護。CNCカット。アクリルパーツを5個まで連結可能。</td>
                                        </tr>
                                        <tr>
                                            <td>納期</td>
...
-->
    ...
    <script type="text/javascript" src="/products/acrylic/js/calculate-connectable.js?v=<?php echo date('is'); ?>" defer></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            const imageList = [
                "/products/acrylic/img/connectable/050526_artboard 13 copy.webp",
                "/products/acrylic/img/connectable/050526_artboard 22.webp",
                "/products/acrylic/img/connectable/connectable acrylic keychains_11.webp",
                "/products/acrylic/img/connectable/connectable acrylic keychains_12.webp",
                "/products/acrylic/img/connectable/connectable acrylic keychains_13.webp",
                "/products/acrylic/img/connectable/connectable acrylic keychains_4.webp"
            ];
            ...
            fetchHolidayData("12days", productionDate);
            fetchHolidayData("アクリルキーホルダー", prd_date1);
            fetchHolidayData("アクリルキーホルダー exp", prd_date2);
