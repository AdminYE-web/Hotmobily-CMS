...
<head>
    ...
    <meta name="keywords" content="モニターアクリルスタンド,モニターアクスタ">
    <meta name="description"
        content="ニュータイプアクスタのモニターアクスタ！モニター上にもデスクにも設置可能！アニメ・漫画・VTuberなどの推し活グッズ、同人グッズとしておすすめ。透明アクリルを活かしたオリジナルグッズを製作。1個から製作可能。印刷を守る保護フィルム付き">
    <meta name="robots" content="index,follow" />
    <title>モニターアクスタ製作｜モニターに飾れるオリジナルアクスタ｜1個から製作可</title>
    <link rel="canonical" href="https://hotmobily.jp/products/acrylic/monitor">
...
<body id="top">
    ...
    <div id="wrapper">
        ...
        <div id="content_wrapper" class="scrollingPanel">
            ...
            ?>
            <div id="">
                <h1 class="h1-new">モニターアクリルスタンド【モニターアクスタ/モニター用アクリルスタンド】</h1>
            ...
            <div class="container">
                <div class="product-gallery" id="">
                    ...
                    <div class="pdp-v2-main-viewport">
                        <div class="pdp-v2-image-strip" id="pdp-v2-js-strip">
                            ...
                            <div class="pdp-v2-main-link" data-index="0">
                                ...
                                <img src="/products/acrylic/img/monitor/monitor-acrylic-stand01.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="1">
                                ...
                                <img src="/products/acrylic/img/monitor/monitor-acrylic-stand02.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="2">
                                ...
                                <img src="/products/acrylic/img/monitor/monitor-acrylic-stand03.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="3">
                                ...
                                <img src="/products/acrylic/img/monitor/monitor-acrylic-stand04.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="4">
                                ...
                                <img src="/products/acrylic/img/monitor/monitor-acrylic-stand05.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="5">
                                ...
                                <img src="/products/acrylic/img/monitor/monitor-acrylic-stand06.webp"
                    ...
                    <div class="pdp-v2-thumb-grid" id="pdp-v2-js-grid-pc">
                        ...
                        <img src="/products/acrylic/img/monitor/monitor-acrylic-stand05.webp" alt="ラバーストラップ制作事例（ロゴ）"
                ...
                <div class="product-details" id="">
                    <div class="price-box">
                        <p class="lpc"><span class="text-orange">参考単価：</span>1個581円</p>
                    </div>

                    <div class="price-box">
                        <p class="lpc"><span class="text-orange">100個合計金額：</span>58,100円</p>
                    </div>
                    ...
                    <h2 class="promo-title" style="color: #cc3f44; !important;">
                        PCディスプレイに引っかけて設置！モニターアクスタ</h2>

                    <div class="info-card">
                        <h3 class="lpc">最安単価円398（税込）！</h3>
                        <a onclick="GotoDiv(6)" href="javascript:void(0)"><img
                                src="/products/acrylic/img/monitor/monitor-acrylicstand-banner02.webp" alt="業界最短7日出荷"
                                width="660" height="auto" loading="lazy"></a>
                        <p class="new-text">最安単価がたったの398円（税込）！大ロットほど単価が安くなりお得です。</p>
                    ...
                    <div class="info-card">
                        <h3 class="lpc">モニターに取り付けできるニュータイプアクスタ！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(3)"><img
                                src="/products/acrylic/img/monitor/monitor-acrylicstand-banner01.webp" alt="業界最安値価格" width="660"
                                height="auto" loading="lazy"></a>
                        <p class="new-text">
                            モニター上部に取り付け可能なニュータイプのアクリルスタンド！デスク周りでのディスプレイに◎
                        </p>
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text" onclick="GotoDiv(3)"
                                style="color: black;">モニターアクスタの詳細</a>
                        </div>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(7)"><img
                                src="/products/acrylic/img/monitor/monitor-acrylicstand-banner03.webp" alt="汚れ防止加工" width="660"
                                height="auto" loading="lazy"></a>
                        <p class="new-text">当店のモニターアクスタは、保護フィルムで印刷を保護する仕様。爪が当たったり落としたりしても印刷がはがれません。</p>
                        <div style="text-align:right;">
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="type-toggle" class="accordion-header" id="type-g">
                            <span class="fw-bold">モニターに取り付け可能なニュータイプのアクリルスタンド！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="https://hotmobily.jp/products/acrylic/cutline_white"><img src="/products/acrylic/img/monitor/monitor-acrylicstand-banner04.webp" alt="" loading="lazy"></a>
                                </div>
                                <br>
                                <div>
                                    <p class="new-text">お気に入りのキャラクターやイラスト、推しのアイドルやアーティスト、ペットの写真などを、デスクの上だけでなくPCモニターの上にも飾れる新しいアクリルグッズが「モニターアクスタ」です。通常のアクリルスタンドのようにデスクや棚に置いて楽しめるのはもちろん、モニターの上部のフチに設置できるのが大きな魅力。作業中の視界にさりげなく推しやオリジナルキャラクターを飾れるため、オフィスのデスク周りや在宅ワーク環境、ゲーミングルーム、推し活スペースの装飾にもぴったりです。</p>
                                    <br>

                                    <p class="new-text">また、モニターアクスタは、「飾る場所がない」「デスクをもっと楽しくしたい」「定番のアクスタとは違うオリジナルグッズを作りたい」といったニーズに応えられます。デスク上にもモニター上にも飾れる2WAY感覚のアクリルスタンドとして、推し活グッズやキャラクターグッズのラインナップに加えることで、見た目のかわいさだけでなく、使う楽しさまで届けられます。</p>
                                ...
                                <div>
                                    <div class="poster-grid">
                                        <div class="poster-item">
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/monitor/monitor-acrylic-stand07.webp"
                                                    alt="Poster 1" />
                                        ...
                                        <div class="poster-item">
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/monitor/monitor-acrylic-stand08.webp"
                                                    alt="Poster 2" />
                                                <div class="camera-left"
                                                    style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                                    📷<?= lang('クリックして拡大') ?>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="data_creation-toggle" class="accordion-header" id="data_creation-g">
                            <span class="fw-bold">背面パーツの種類</span>
                            <span class="arrow-dove"></span>
                        </label>
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">モニターアクスタをモニターに固定する役割を持つ背面パーツは2種類あります。ご注文の際にお選びください。左が小サイズ、右が大サイズ・印刷ありです。</p>
                                <br>
                                <div>
                                    <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                        src="/products/acrylic/img/monitor/monitor-acrylicstand09.png"
                                        alt="Poster 2" />
                                    <div class="camera-left"
                                        style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                        📷<?= lang('クリックして拡大') ?>
                                ...
                                <div>
                                    <div class="poster-grid">
                                        <div class="poster-item">
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/monitor/monitor-acrylic-stand10.webp"
                                                    alt="Poster 1" />
                                                <div class="camera-left"
                                                    style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                                    📷<?= lang('クリックして拡大') ?>
                                        ...
                                        <div class="poster-item">
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/monitor/monitor-acrylic-stand11.webp"
                                                    alt="Poster 2" />
                                                <div class="camera-left"
                                                    style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                                    📷<?= lang('クリックして拡大') ?>
                                    ...
                                    <br>
                                    <p class="new-text">なお、大サイズ・印刷ありをご希望の場合には、追加料金が発生します。詳細は制作料金をご確認ください。</p>
                                </div>
            ...
            <div id="acc-price">
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">納期と印刷面を選択してください。サイズ別の製作単価表が表示されます。ここは価格表のみです。見積・注文はこちらです。</p>
                                ...
                                <br>
                                <p class="new-text">なお、大サイズ・印刷ありの背面パーツをご希望の場合には、33円（税込／単価）が発生します。</p>
                                <br>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="https://hotmobily.jp/products/acrylic/cutline_white"><img src="/products/acrylic/img/monitor/monitor-acrylicstand-banner08.webp" alt="" loading="lazy"></a>
                                </div>
                                <br>
                                <div>
                                    <p class="new-text">モニターアクリルスタンドの製作にあたって、カットパスや白押さえなど、アクリルグッズ製作で欠かせない専用の入稿データの作成にお悩みの方もいるでしょう。当店では無料のデータ作成補助サービスをご用意。お客様の代わりに入稿データを無料で作成いたします。イラストや写真の画像（JPG、PNG）、PDFなどをお送りください。</p>
                                    <br>
                                    ...
                                    <br><br>
                                    <a href="https://hotmobily.jp/lp/acrylic-guide.php?sec=data" class="new-text">データ作成ガイド</a>
                                    <!-- <div>
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <a class="btn-a btn-yellow"
                                            href="/products/acrylic/template/monitor_acrylicstand_template_cmyk_2306.zip"
            ...
            <div id="acc-shipping">
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">出荷日の目安は以下です。</p>
                                <br>
                                ...
                                <br>
                                <a class="new-text" href="https://hotmobily.jp/contact/index.php" target="_blank">無料サンプルの送付をリクエスト</a>
                                <br>
                ...
                <div>
                    ...
                    <div style="overflow: unset!important;">
                        <div class="fixed-contrainer">
                            <h3 class="red">【<?= lang('モニターアクリルスタンド）') ?>】</h3>
                        ...
                        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                            <div style="display: table-column;">
                                <input type="text" name="ItemType" id="strap" value="モニターアクリルスタンド" />
                                ...
                                <div class="flex-container">
                                    <div class="preview-container">
                                        <div class="preview-sub flex-container">
                                            ...
                                            $target_file = __DIR__ . "/part-base-monitor.php";
                                            if (file_exists($target_file)) {
                                                include($target_file);
                                            }
                                    ...
                                    <div class="flex-item">
                                        ...
                                        <table class="table_rubber">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="TableLeft"><?= lang('背面パーツ') ?></td>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="rainbow01-toggle" class="accordion-header">
                            <span class="fw-bold">モニターアクリルスタンドのパーツ構成</span>
                            <span class="arrow-dove"></span>
                        </label>

                        <div class="accordion-content">
                            <div class="flex-container_2">
                                <div class="flex-item_2 item">
                                     <div>
                                    <img onclick="openSimpleModal(this, 1)"
                                        src="/products/acrylic/img/monitor/monitor-acrylic-stand12.webp"
                                        alt="Poster 1" />
                                    <div class="camera-left"
                                        style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                        📷<?= lang('クリックすると拡大します') ?>
                                ...
                                <div class="flex-item item new-text" style="display:grid;align-content: center;line-height: 2;">
                                    <p>モニターアクリルスタンドは、次の5つのパーツで構成されています。</p><br>
                                    <p>
                                        1.本体 <br>
                                       2.背面パーツ <br>
                                       3.台座 <br>
                                        4.前面パーツ <br>
                                        5.固定ゴム（ひとつのモニターアクスタにつき2つ同封） 
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div id="use">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="rainbow01-toggle_2" class="accordion-input" checked>
                        <label for="rainbow01-toggle_2" class="accordion-header">
                            <span class="fw-bold">モニターアクリルスタンドの取り付け方法</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                           <div class="flex-container_2">
                                <div class="flex-item_2 item">
                                     <div>
                                    <img onclick="openSimpleModal(this, 1)"
                                        src="/products/acrylic/img/monitor/monitor-acrylic-stand13.webp"
                                        alt="Poster 1" />
                                    <div class="camera-left"
                                        style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                        📷<?= lang('クリックすると拡大します') ?>
                                ...
                                <div class="flex-item item new-text" style="display:grid;align-content: center;line-height: 2;">
                                    <p>モニターの上にモニターアクスタを置き、前面パーツと背面パーツを、それぞれモニターの前側と後ろ側に合わせてください。その後、固定ゴムの位置を調節して、背面パーツが動かないように固定してください。</p><br>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="\products\acrylic\img\monitor\monitor-acrylicstand-banner05.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    当店のモニターアクリルスタンド（モニターアクスタ）の強みのひとつとして、お客様の大切なデザインを保護する保護フィルムがあります。
                                </p>
                                <br>
                                <p class="new-text">一般的なモニターアクスタ（モニターアクスタ）は保護フィルムがなく、固いものがこすれたり爪で引っかいたりすると、印刷されたデザインがはがれる恐れがあります。しかし、当店のモニターアクスタは印刷デザインを保護フィルムで覆っています。このため、印刷がむき出しにならず保護フィルムによって保護され、印刷がはがれる恐れがありません。</p>
                                <br>
                                <a class="new-text" href="https://hotmobily.jp/products/acrylic/filmcoating">保護フィルムの詳細</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="one-toggle" class="accordion-header">
                            <span class="fw-bold">デスクまわりの推し活グッズに！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="\products\acrylic\img\monitor\monitor-acrylicstand-banner06.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    お気に入りのキャラクターや推しを、もっと身近に、もっと楽しく飾れるグッズとして注目したいのがモニターアクスタです。モニターアクスタは、デスクや棚の上に置くだけでなく、PCモニターの上部にも取り付けできるニュータイプのアクリルスタンド。仕事中や勉強中、ゲーム中など、日常的に目に入りやすいデスクまわりに推しを飾れるため、推し活グッズやオリジナルキャラクターグッズとして高い満足感を演出できます。透明アクリルならではの透明感と光沢、ダイカットのかわいらしさに加えて、モニターに引っ掛けられるユニークな構造が魅力です。
                                </p>
                                <br>
                                <h3 class="h3-new fw-bold">アニメや漫画のキャラクターをモニターアクスタに</h3>
                                <p class="new-text">アニメや漫画のキャラクターグッズとして、モニターアクスタはとても相性の良いアイテムです。キャラクターのバストアップ（上半身）のイラストやデフォルメイラストのアクリルスタンドにすることで、普段使うデスクまわりをキャラクターで彩る。通常のアクスタのように机の上に飾れるのはもちろん、PCモニターの上に設置すれば、作業スペースを圧迫しにくく、視界の中に自然とキャラクターが入るのもポイントです。</p>
                                <br>
                                <h3 class="h3-new fw-bold">アイドルやVTuber、アーティストの推し活グッズとして</h3>
                                <p class="new-text">モニターアクスタは、アイドル、VTuber、配信者、アーティストの推し活グッズとしてもおすすめです。デスクで作業をしているとき、配信を見ているとき、オンラインイベントに参加しているときなど、いつものPC環境に推しを飾れるため、ファンの日常に寄り添うグッズになります。通常のアクリルスタンドよりも設置場所の自由度が高く、モニター上にもデスク上にも飾れるため、限られたスペースでも楽しみやすいのが魅力です。</p>
                                <br>
                                <h3 class="h3-new fw-bold">猫ちゃんやワンちゃんもデスクまわりに</h3>
                                <p class="new-text">モニターアクスタは、キャラクターや人物だけでなく、猫ちゃんやワンちゃんなどのペットグッズにもぴったりです。お気に入りの写真をアクリルスタンドにすることで、かわいいペットの姿をデスクまわりに飾ることができます。PCモニターの上にちょこんと設置したり、キーボード横やモニター下のスペースに置いたりすれば、仕事中や勉強中の癒しアイテムとして楽しめます。</p>
            ...
            <div id="dojin">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="one-toggle_two" class="accordion-input" checked>
                        <label for="one-toggle_two" class="accordion-header">
                            <span class="fw-bold">自分もファンも嬉しい同人グッズ製作に！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/monitor/monitor-acrylic-stand14.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    同人イベントや通販で頒布するオリジナルグッズに、新しい魅力を加えたい方におすすめなのがモニターアクスタです。オリジナルのキャラクターやイラストを、ふとしたときに視界に入るPCモニターの上に取り付け。自分の作品や創作キャラクターを、ファンの日常のデスクまわりに飾ってもらえます。
                                </p>
                                <br>
                                <p class="new-text">
                                    イベント会場で手に取ったときのかわいさはもちろん、実際に使う・飾る楽しさまで届けられるのがモニターアクスタの魅力。推しキャラや創作キャラを、作業中のPCモニター上やキーボード横に飾れるため、ファンにとっては「いつも見える場所に置ける」満足感の高いグッズになります。
                                </p>
                                <br>
                                <h3 class="h3-new fw-bold">従来のアクスタよりも一歩進んだモニターアクスタ</h3>
                                <p class="new-text">定番の同人グッズとして人気のアクリルスタンドは、キャラクターをスタンドとしてデスクや棚の上に飾ることができるアイテムです。その一方で、モニターアクスタは従来のアクスタに「モニターにも取り付けられる」という新しい楽しみ方を加えたオリジナルグッズ。デスクのスペースを取らずに、いつでも目に留まる場所に飾れることが魅力です。</p>
                                <br>
                                <h3 class="h3-new fw-bold">2通りのディスプレイ方法で満足感◎</h3>
                                <p class="new-text">モニターアクスタの大きな魅力は、モニターに取り付けて飾ることも、デスクや棚の上に置いて飾ることも可能である点です。PCモニターの上部に設置すれば、作業中や配信視聴中、ゲーム中など、日常的に目に入る場所に推しキャラを飾れます。デスクまわりの推し活グッズとして存在感がありながら、机の作業スペースを圧迫しにくいのも嬉しいポイントです。</p>
                                <br>
                                <p class="new-text">飾る場所を選ばないため、ファンにとって使いやすく、楽しみ方が広がります。い同人グッズになります。自宅のPCまわりに置いたり、職場のデスクにさりげなく飾ったり、コレクション棚に並べたりなど、ディスプレイ方法は無限大。ファンの満足度をぐっとアップできるアクリルグッズです。</p>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="cnc-toggle" class="accordion-header">
                            <span class="fw-bold">ハイクオリティのなめらかなエッジ加工を実現！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img style="width: 100%;" onclick="openSimpleModal(this, 1)"
                                        src="/products/acrylic/img/monitor/monitor-acrylic-stand15.webp"
                                        alt="Poster 1" />
                                    <div class="camera-left"
                                        style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                        📷<?= lang('クリックすると拡大します') ?>
                                ...
                                <br>
                                <p class="new-text">
                                    アクリルグッズのカットはレーザーが使用されることが多いです。しかし、レーザーを使ったカットは、カット面に不自然な突起ができてしまいます。ごく小さな突起なので目立ちませんが、カット面に手で触ってみると引っかかりがあるのがわかるでしょう。当店のジオラマアクリルスタンドは、アクリルのカットにCNC加工機を使用しております。レーザーとは異なり、突起のない整ったカット面になるため、手で触れても引っかかりがなく、なめらかな手触りなのが特長です。
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="factory-toggle" class="accordion-header">
                            <span class="fw-bold">完全自社生産のモニターアクスタ</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="https://hotmobily.jp/products/acrylic/ownfactory"><img src="/products/acrylic/img/monitor/monitor-acrylicstand-banner07.webp" alt="" width="100%" loading="lazy"></a>
                                </div>
                                <br>
                                <p class="new-text">
                                    モニターアクリルスタンドを含め、当店のアクリル製品はすべて自社生産です。デザインの印刷、アクリル板のカット、包装まですべて自社工場で完結しています。自社生産のためマージンなどが発生せず、お客様のお求めの製品を低コストで製作することができます。製品のクオリティにも責任をもってこだわっております。お客様のデザインを活かした高品質のモニターアクリルスタンド（モニターアクスタ）をお届けいたします。
                                </p>
                                <br>
                            ...
                            <div class="plan-section">
                                <table class="table_rubber" cellpadding="5" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td><?= lang('名称') ?></td>
                                            <td style="text-align: left;">モニターアクリルスタンド</td>
                                        </tr>

                                        <tr>
                                            <td><?= lang('素材') ?></td>
                                            <td style="text-align: left;">アクリル板3mm厚</td>
                                        </tr>

                                        <tr>
                                            <td><?= lang('サイズ') ?></td>
                                            <td style="text-align: left;">
                                                50X50mm / 75x75mm (台座等を除く本体部分)
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><?= lang('納期') ?></td>
                                            <td style="text-align: left;">10営業日/6営業日</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
-->
    ...
    <script type="text/javascript" src="/products/acrylic/js/calculate-monitor.js?v=<?php echo date('is'); ?>" defer></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            const imageList = [
                "/products/acrylic/img/monitor/monitor-acrylic-stand01.webp",
                "/products/acrylic/img/monitor/monitor-acrylic-stand02.webp",
                "/products/acrylic/img/monitor/monitor-acrylic-stand03.webp",
                "/products/acrylic/img/monitor/monitor-acrylic-stand04.webp",
                "/products/acrylic/img/monitor/monitor-acrylic-stand05.webp",
                "/products/acrylic/img/monitor/monitor-acrylic-stand06.webp"
            ];
