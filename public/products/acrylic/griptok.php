...
// *************************************************************
$product_name = "【ホットモバイリー】オリジナルアクリルグリップホルダー";
$product_description = "オリジナルアクリルグリップホルダーをオーダーメイドで製作。最短6営業日で出荷可能。小ロット1個から製作。最安単価267円。便利なスマホグッズを低価格のアクリルで1個から作成できる！";
$product_image_url = "https://hotmobily.jp/products/acrylic/img/detail-griptok-3.webp";
$product_sku = "HM-AGH-2024";
$product_price = 267;
$product_currency = "JPY";
$product_availability = "InStock";
$product_url = "https://hotmobily.jp/products/acrylic/griptok";
...
<head>
  ...
  <meta name="keywords" content="アクリル,グリップホルダー(グリップトック:Grip Tok),オリジナル,名入れ,製作,作成,アクキー,剥がれない,1個から">
  <meta name="description" content="オリジナルのアクリルグリップホルダー(グリップトック:Grip Tok)が1個から注文可。剥がれない印刷。丈夫なアクキー。激安価格で、小ロット、短納期を実現">
  <title>アクリルスマホグリップトック （グリップホルダー）の製作。1個から注文可。保護フィルムで、印刷が剥がれません。</title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1>アクリルスマホグリップトック （グリップホルダー）の製作。1個から注文可。保護フィルムで、印刷が剥がれません(2026年版)</h1>
      <div class="social-time">
        <span class="social-content">
          <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのアクリルバッジが製作できます。剥がれない印刷。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/badge" title="Share by Email" target="_blank">シェアする</a><a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aオリジナルのアクリルバッジが製作できます。剥がれない印刷。激安価格で、小ロット、短納期を実現%0A%0A詳細はこちら:https://hotmobily.jp/products/acrylic/badge" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
          <a href="https://www.facebook.com/share.php?u=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fbadge" target="_blank"><i class="fab fa-facebook-square"></i></a>
          <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2facrylic%2fbadge&amp;text=オリジナルのアクリルバッジが製作できます。剥がれない印刷。激安価格で、小ロット、短納期を実現" target="_blank"><i class="fab fa-twitter-square"></i></a>
        </span>
          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_01" src="img/griptok-8.webp" data-zoom-image="img/griptok-8.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_02" src="img/griptok-7.webp" data-zoom-image="img/griptok-7.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_03" src="img/griptok-6.webp" data-zoom-image="img/griptok-6.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_04" src="img/griptok-5.webp" data-zoom-image="img/griptok-5.webp" itemprop="thumbnail" width="376" height="231">
                  </a>
                </figure>
              </div>
            </div>
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="img/griptok-8.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="img/griptok-7.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="img/griptok-6.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="img/griptok-5.webp" width="93" height="57" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
        ...
        <div class="flex-item item">
          <table class="table_rubber" style="padding: 0;">
            <tr>
              ...
              <td>アクリル板3mm厚+グリップホルダー7mm</td>
            </tr>
            <tr>
              <td class="TableLeft">サイズ</td>
              <td>【アクリル板】 50x50mm/75x75mm<br>
                【グリップホルダー】 直径40mm、厚さ5mm～22mm</td>
            </tr>
            <tr>
              <td class="TableLeft">色数</td>
              <td>【アクリル板】 フルカラーUVインクジェット印刷+白押さえが基本となります。<br>
                【グリップホルダー】 白色、黒色</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>既製品：50種類のデータから選択可 <br> オリジナル印刷：お客様の入稿データを使用し、印刷します <br> 支給された台紙封入、JANシール貼り等の軽作業は、@22円（税込）でお受けしております。
              </td>
            </tr>
            <tr>
              <td class="TableLeft">特徴</td>
              <td>印刷面をフィルム保護。CNCカット</td>
            </tr>
            <tr>
      ...
      <!-- <div class="flex-container">
        ...
        <div class="flex-item item">
          <div class="btn-container item_btn" style="display: flex;justify-content: space-between;">
            ...
            <a class="btn-a btn-yellow" href="/contact/index.php?item=アクリルグリップホルダー">
              <span>無料サンプル</span>
            </a>
          </div>
        </div>
      ...
      <br><br>
      <a class="new-text" href="/contact/?item=アクリルスマホグリップトック" >無料サンプルの送付をリクエスト</a>

      <div id="download_templete" class="download_templete">
        <div class="modal-content">
          <span class="close">&times;</span>
          <h3>アクリルグリップホルダー【Illustrator／Photoshop】</h3>
          <table class="table_rubber">
            <tbody>
              <tr>
                <td>50×50mm</td>
                <td>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-griptok_50x50mm.ai">
                    <div><img src="img/ai-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-griptok_50x50mm.psd">
              ...
              <tr>
                <td>75×75mm</td>
                <td>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-griptok_75x75mm.ai">
                    <div><img src="img/ai-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                  <a class="btn-a btn-yellow" href="../download/download.php?fname=template-griptok_75x75mm.psd">
                    <div><img src="img/psd-icon.webp" width="20" height="20"> テンプレートダウンロード</div>
                  </a>
                </td>
              </tr>
        ...
        <div class="modal-content data">
          ...
          <table class="table_rubber">
            <tbody>
              <tr>
                <td>
                  <a class="btn-a btn-yellow" href="/products/data-acrylic-griptok.php" target="_blank">
      ...
      <img src="img/banner-acrylic-griptok.webp" style="margin-top: 10px;max-width: 770px;" width="100%" height="388">
      <hr />
      <div class="videoWrapper" style="margin-bottom: 10px;">
        <img src="img/ag-yt.webp" data-src="RAnF7FdyxZ0" class="iframe" width="100%" height="434">
        <div class="playbtn">
          <div class="tri"></div>
        </div>
      </div>
      <div class="videoWrapper">
        <img src="img/ak-yt.webp" data-src="hLBw57972LM" class="iframe" width="100%" height="434">
        <div class="playbtn">
          <div class="tri"></div>
        </div>
      </div>
      ...
      <div class="flex-container" style="margin-top: 10px;">
        <div class="flex-item item" style="text-align: center;">
          <a href="img/detail-griptok-1b.webp" data-lightbox="griptok-a01" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/detail-griptok-1.webp" width="380" height="388">
          </a>
        </div>
        <div class="flex-item item" style="text-align: center;">
          <a href="img/detail-griptok-2b.webp" data-lightbox="griptok-a02" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/detail-griptok-2.webp" width="380" height="388">
          </a>
        </div>
      </div>
      <div class="flex-container">
        <div class="flex-item item" style="text-align: center;">
          <a href="img/detail-griptok-3b.webp" data-lightbox="griptok-a03" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/detail-griptok-3.webp" width="380" height="388">
          </a>
        </div>
        <div class="flex-item item" style="text-align: center;">
          <a href="img/detail-griptok-4b.webp" data-lightbox="griptok-a04" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/detail-griptok-4.webp" width="380" height="388">
          </a>
        </div>
      </div>
      <div style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
      <hr />
      <h2>製作事例紹介</h2>
        ...
        <div class="swiper-container swiper2">
          <div class="swiper-wrapper swiper-bt">
            <div class="swiper-slide">
              <a href="/products/acrylic/img/griptok-1a.webp" data-lightbox="acrylic-a1" style="text-decoration:none;" data-title="">
                <img data-src="/products/acrylic/img/griptok-1a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/griptok-1c.webp" data-lightbox="acrylic-a1" data-title=""></a>
              <a href="/products/acrylic/img/griptok-1b.webp" data-lightbox="acrylic-a1" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/griptok-2a.webp" data-lightbox="acrylic-a2" style="text-decoration:none;" data-title="">
                <img data-src="/products/acrylic/img/griptok-2a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/griptok-2b.webp" data-lightbox="acrylic-a2" data-title=""></a>
              <a href="/products/acrylic/img/griptok-2c.webp" data-lightbox="acrylic-a2" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/griptok-3a.webp" data-lightbox="acrylic-a3" style="text-decoration:none;" data-title="">
                <img data-src="/products/acrylic/img/griptok-3a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/griptok-3b.webp" data-lightbox="acrylic-a3" data-title=""></a>
              <a href="/products/acrylic/img/griptok-3c.webp" data-lightbox="acrylic-a3" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/griptok-4a.webp" data-lightbox="acrylic-a4" style="text-decoration:none;" data-title="">
                <img data-src="/products/acrylic/img/griptok-4a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/griptok-4b.webp" data-lightbox="acrylic-a4" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/products/acrylic/img/griptok-5a.webp" data-lightbox="acrylic-54" style="text-decoration:none;" data-title="">
                <img data-src="/products/acrylic/img/griptok-5a.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/products/acrylic/img/griptok-4b.webp" data-lightbox="acrylic-54" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/146.webp" data-lightbox="acrylic-56" style="text-decoration:none;" data-title="">
                <img data-src="/gallery/img-acrylic/2023-acrylic-gallery/146.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
              </a>
              <a href="/gallery/img-acrylic/2023-acrylic-gallery/147.webp" data-lightbox="acrylic-56" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="img/DSC02170.webp" data-lightbox="acrylic-a7" style="text-decoration:none;" data-title="">
                <img data-src="img/DSC02170.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="img/DSC02171.webp" data-lightbox="acrylic-a7" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="img/DSC02176.webp" data-lightbox="acrylic-a8" style="text-decoration:none;" data-title="">
                <img data-src="img/DSC02176.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="img/DSC02177.webp" data-lightbox="acrylic-a8" data-title=""></a>
            </div>
            <div class="swiper-slide">
              <a href="img/DSC02180.webp" data-lightbox="acrylic-a9" style="text-decoration:none;" data-title="">
                <img data-src="img/DSC02180.webp" class="picpro lazy" width="229" height="229">
                <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷<?= lang('クリックすると拡大します') ?>
                </div>
              </a>
              <a href="img/DSC02181.webp" data-lightbox="acrylic-a9" data-title=""></a>
            </div>
          </div>
        </div>
        <div class="swiper-button-next"></div>
        <div style="text-align: center; margin: 15px auto 0; display: none;">
          <a href="/gallery/acrylic_key"><img class="btn_z lazy" data-src="/products/images/but3-02.webp" width="266" height="167"></a>
        </div>
        <div class="read-more1" style="display: none;"><a href="#" class="btn"><img class="btn_z lazy" data-src="/products/images/but3-02.webp" width="266" height="167"></a></div>
      </div>
      <hr>
      <?php include("four_reason-v2.php") ?>
      <h2 style="margin-top: 5px;">アクキーができるまで</h2>
      <div class="videoWrapper">
        <img src="img/ac-yt.webp" data-src="g6wha8kIsc0" class="iframe" width="100%" height="434">
        <div class="playbtn">
          <div class="tri"></div>
        </div>
      </div>
      ...
      <p class="new-text">なお、「カットパス・白押さえも自分で細かく設定したい」という方向けに、入稿データ作成のテンプレート及びアクリル製品の入稿データ作成ガイドもご用意しております。</p>
        ...
        <br>
      <a class="new-text" href="/products/acrylic/template/template-acrylic-griptok.zip" download>入稿データテンプレートをダウンロード</a>
      <br><br>
       <a class="new-text" href="/lp/acrylic-guide.php?sec=data">入稿データ作成ガイド</a>

      <!-- <a href="/products/data-acrylic-badge.php" target="_blank"><img class="lazy" data-src="img/banner_design_data.webp" width="100%" height="388" style="max-width: 770px;"></a> -->
      ...
      <div class="part-container">
        <div class="part-content" style="display: flex;">
          <label class="part-name">
            <input type="radio" name="prc_delivery" value="10" checked="" onclick="writePriceTable('del');">10営業日 <span class="checkmark"></span>
          </label>
          <label class="part-name">
            <input type="radio" name="prc_delivery" value="6" onclick="writePriceTable('del');">6営業日 <span class="checkmark"></span>
          </label>
        </div>
      </div>
      ...
      <div style="overflow: unset!important;">
        <div class="fixed-contrainer">
          <h3 class="red">【アクリルスマホグリップトック （グリップホルダー）】</h3>
        ...
        <div class="step-container line1" style="padding: 5px;border: 1px solid lightgray;margin-bottom: 5px;">
          ...
          <div class="step-box line2" style="text-align: center;">
            <img data-src="/products/images/HM_part1-2.webp" id="sample-part-pic" class="picpro lazy" width="320" height="320"><br />
            <span id="sample-part-name">アタッチメント:なし</span>
          </div>
          <div class="step-box line2" style="text-align: center;">
            <img data-src="img/coming-soon.webp" style="display: none;" id="sample-paper-pic" class="picpro lazy" width="500" height="500"><br />
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="アクリルスマホグリップトック" />
          ...
          <div class="estimate-content" id="step1">
            ...
            <div style="display: table-column;">
              ...
              <div class="part-container">
                <div class="part-content">
                  <label class="part-name"><input type="radio" name="acy_screen" value="片面印刷" onclick="check_val('next')" checked>片面印刷 <span class="checkmark"></span></label>
                </div>
              </div>
            </div>
            <h3>数量</h3>
                ...
                <div class="preview-sub flex-container">
                  ...
                  for ($i = 0; $i < count($attachment); $i++) {
                    echo '
										...
										<img data-src="' . $attachment[$i]["part_pic"] . '" width="95" height="95" class="picpro lazy">
              ...
              <div class="flex-item">
                ...
                <table class="table_rubber">
                  <tbody>
                    <tr>
                      <td class="TableLeft">納期</td>
                      <td id="prd_production" style="text-align: left;"></td>
                    </tr>
                    <tr>
                      <td class="TableLeft">サイズ</td>
                      <td id="prd_size" style="text-align: left;"></td>
                    </tr>
                    <tr>
              ...
              <div class="flex-item">
                ...
                <table class="table_rubber total_price_tbl">
                  <tbody>
                    ...
                    <tr>
                      <td class="TableLeft">台紙</td>
                      <td><input id="prd_paper_price" type="text" name="prd_paper_price" readonly>円</td>
                    </tr>
                    <tr>
                      <td class="TableLeft">試作品</td>
          ...
          <table class="table_rubber" style="display: table;">
            <tbody>
              <tr>
                ...
                <td><input name="Name_S" id="sname" type="text" maxlength="100" value=""></td>
              </tr>
              <tr>
                <td class="TableLeft">お名前（名）</td>
                <td><input name="Name_F" id="fname" type="text" maxlength="100" value=""></td>
              </tr>
              <tr>
                <td class="TableLeft">法人名</td>
                <td><input name="Corp_Name" id="Corp_Name" type="text" value="" size="45" maxlength="100"></td>
              </tr>
              <tr>
                <td class="TableLeft">郵便番号 </td>
                <td><input type="text" id="zip" name="zip" maxlength="8" size="15" value="">&nbsp;<input type="button" id="src_btn" onclick="address_fn();" value="住所に変換"><br><span id="error" style="color:red"></span>
                </td>
              </tr>
              <tr>
                <td class="TableLeft">都道府県</td>
                <td><input type="text" id="address1" name="prefc" value=""></td>
              </tr>
              <tr>
                <td class="TableLeft">以降の住所</td>
                <td><input id="address2" name="address" type="text" class="contact_text1" value=""></td>
              </tr>
              <tr>
                <td class="TableLeft">番地、建物名、部屋番号</td>
                <td><input id="address_street" name="address_street" type="text" class="contact_text1" value=""></td>
              </tr>
              <tr>
                <td class="TableLeft">TELハイフンなし</td>
                <td><input name="tel" id="tel" type="text" maxlength="11" value=""></td>
              </tr>
              <tr>
                <td class="TableLeft">お客様メモ欄</td>
                <td><input name="comment" id="comment" type="text" size="45" value=""></td>
              </tr>
              <tr>
      ...
      <div>
        <div style="margin-bottom: 10px;">
          ...
          <div id="panel1" class="a-detail new-text">
            アクリルグリップホルダーの注文画面はカート形式となっております。この場合、まずAデザインのご注文をカートに入れていただき、その後「買い物を続ける」ボタンをクリックしてください。アクリル製品一覧画面に移行しますので、再度アクリルグリップホルダーのページに行き、注文画面からBデザインのご注文をカートに入れてください。カートに2つの注文が入っていることをご確認後「購入へ」ボタンをクリックし、ご購入のステップにお進みください。例えば、表面のデザインは同じで、裏面のデザインだけが異なる場合も、別々の注文として2件のご注文をカートに入れていただく必要がございます。
          </div>
        </div>
        <div style="margin-bottom: 10px;">
          <div class="quest">Q</div>
      ...
      <hr />
      <h2 style="margin-top: 5px;">カットパスと白押さえ</h2>
      <h3>カットパスとは？</h3>
      <p>
        自分のデザインをアクリルキーホルダーにしたい時、どういう形にするか？を決めるのがカットパスです。『カット』は切る、『パス』は線という意味で、日本語にすると切断線という意味です。1枚のアクリル板からキーホルダーを作る時、どういう切断線にするのかを決めているのがカットパスです。
      </p><br />
      <p>
        自分が作りたいデザインがあって、それをどういう形にするのかを指定して下さいという事。例えば、下の青いヒーローのデザイン。これをアクキーにしたい時、色々な形が考えられますよね。そのアクリル板の切断線を決めるのがカットパスです。ちなみに、多くのお客様は、デザインに沿った、Aのカットパスを選択されています。
      </p>
      <div style="text-align:center;"><img class="lazy" data-src="img/acrylc_banner_design_data.webp" width="100%" height="191" style="max-width:760px;"></div>
      <div style="clear: both;">&nbsp;</div>
      <div class="row">
        <div class="mt-10-part">
          <a href="img/acylic-cutting1b.webp" data-lightbox="acrylic-a01" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/acylic-cutting1.webp" width="250" height="165">
            <div>A:デザインの形に沿ったカットライン</div>
            <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
          </a>
        </div>
        <div class="mt-10-part">
          <a href="img/acylic-cutting2b.webp" data-lightbox="acrylic-a02" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/acylic-cutting2.webp" width="250" height="165">
            <div>B:デザインよりも大きいカットライン</div>
            <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
          </a>
        </div>
        <div class="mt-10-part">
          <a href="img/acylic-cutting3b.webp" data-lightbox="acrylic-a03" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/acylic-cutting3.webp" width="250" height="165">
            <div>C:お好きな形状でのカットライン</div>
            <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
          </a>
        </div>
      </div>
      <h3>白押さえとは？</h3>
      <p>
        下の２つの写真を見てください。白押さえありと、白押さえ無しです。『白』というのは、白色インクの事。押さえは、皆さんのデザインを印刷したその上から重ねて白色インクで印刷するので、皆さんのデザインを白色インクで押さえると言う意味かと思います。（印刷の業界で良く使われている言葉です）
      </p><br />
      <p>この白色インクの押さえが無い場合、赤色とか青色で印刷されている部分は問題無いのですが、白色で印刷したい部分は、透明になって透けてしまいます。ですので、それを防ぐ為に一度印刷したデザインの上から再度印刷します。</p>
      <div class="flex-container">
        <div class="flex-item item" style="text-align: center;">
          <a href="img/acrylic_frontback_Ab.webp" data-lightbox="acrylic-a04" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/acrylic_frontback_A.webp" class="picpro lazy" width="380" height="730">
            <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
          </a>
        </div>
        <div class="flex-item item" style="text-align: center;">
          <a href="img/acrylic_frontback_Bb.webp" data-lightbox="acrylic-a05" style="text-decoration:none;" data-title="">
            <img class="lazy" data-src="img/acrylic_frontback_B.webp" class="picpro lazy" width="380" height="730">
            <div class="camera-left" style="text-decoration:none; font-size: 10px;">📷クリックすると拡大します </div>
          </a>
        </div>
      </div>
      ...
      <!-- <div class="flex-container">
        ...
        <div class="flex-item item" style="text-align: center;">
          <a href="/products/acrylic/figure"><img class="lazy" data-src="img/go_to_figure.webp" width="380" height="165"></a>
        </div>
      </div>
      <div class="flex-container">
        <div class="flex-item item" style="text-align: center;">
  ...
  <!-- <script type="text/javascript" src="<?= $cal_acrylic_griptok_js ?>"></script> -->
  <script type="text/javascript" src="/products/acrylic/js/calculate-griptok.js?v=<?php echo date('is') ?>"></script>
            ...
            <?php echo $json_ld_output; ?>, {
                ...
                "itemListElement": [{
                    ...
                    },
                    {
                        ...
                        "position": 3,
                        "name": "アクリルグリップホルダー",
                        "item": "https://hotmobily.jp/products/acrylic/griptok"
                    }
                ]
            }
        ]
