...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <?php if(date('Y-m-d')>= "2026-08-10" && date('Y-m-d') <= "2026-08-16") { ?>
      <br>
      <div>
        <a href="https://hotmobily.jp/news-detail.php?id=47"><img src="/img/acrylic-keychain-simulator-10off-0811-pcsize.webp" alt=""></a>
      </div>
      <?php } ?>
      ...
      if (isset($favor) && $favor == 'acrylic') {
        include '../product-faq-2026.php';
      }
      ?>
      <hr />

      <h2><?= lang('アクキー製作ガイドをご用意') ?></h2>
      <div>
          <img class="" src="https://hotmobily.jp/img/all-acrylic/Acrylic_guide_top.webp?n=1" alt="" loading="lazy">
          <br><br>
          <p class="new-text">ホットモバイリーでは、初めてオリジナルアクキーを製作する方に向けた必見の解説ページをご用意。同社製品の品質と独自の特徴を詳しく紹介しています。最大の強みは、印刷面を透明なPETフィルムで覆い、デザインを傷や摩擦から守る「印刷が剥がれない保護構造」です。さらに、一般的なレーザーカットではなくCNC（切削）加工による「面取り」を採用し、断面が滑らかで安全な美しいエッジを実現しています。難しい白版データの作成サポートなど、初心者でも安心して高品質なアクリルグッズを作れるプロのノウハウが分かりやすくまとめられています。</p>
          <br>
          <div style="text-align:right;">
            <a class="new-text" href="https://hotmobily.jp/lp/acrylic-guide" target="_blank">アクリルグッズの完全ガイド</a>
          </div>
      </div>
...
<!-- addnew -->
  ...
  <!-- <script type="text/javascript" src="<?= $cal_acrylic_js ?>"></script> -->
   <script type="text/javascript" src="/products/acrylic/js/calculate3.js?zxd=<?= date('is') ?>"></script>
