...
<head>
    ...
    <meta name="keywords" content="オーロラアクリルスタンド（オーロラアクスタ）,オリジナル">
    <meta name="description"
        content="オリジナルのオーロラアクリルスタンド（オーロラアクスタ）を格安・短納期で制作！1個から注文可、見る角度などで色が変わる特別なアクスタ。印刷が剥がれないフィルム保護構造とCNC加工による滑らかな断面で高品質。同人グッズやノベルティに。最短6営業日出荷。">
    <meta name="robots" content="index,follow" />
    <title>オリジナルオーロラアクリルスタンド（オーロラアクスタ）制作｜格安・短納期</title>
...
<body id="top">
    ...
    <div id="wrapper">
        ...
        <div id="content_wrapper" class="scrollingPanel">
            ...
            ?>
            <div id="">
                <h1 class="h1-new">オーロラアクリルスタンド（オーロラアクスタ）（2026年版）</h1>
            ...
            <div class="container">
                <div class="product-gallery" id="">
                    ...
                    <div class="pdp-v2-main-viewport">
                        <div class="pdp-v2-image-strip" id="pdp-v2-js-strip">
                            ...
                            <div class="pdp-v2-main-link" data-index="0">
                                ...
                                <img src="/products/acrylic/img/figure-aurora/aurora_stand01.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="1">
                                ...
                                <img src="/products/acrylic/img/figure-aurora/aurora_stand02.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="2">
                                ...
                                <img src="/products/acrylic/img/figure-aurora/aurora_stand03.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="3">
                                ...
                                <img src="/products/acrylic/img/figure-aurora/aurora_stand04.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="4">
                                ...
                                <img src="/products/acrylic/img/figure-aurora/aurora_stand05.webp"
                            ...
                            <div class="pdp-v2-main-link" data-index="5">
                                ...
                                <img src="/products/acrylic/img/figure-aurora/aurora_stand06.webp?v=1"
                    ...
                    <div class="pdp-v2-thumb-grid" id="pdp-v2-js-grid-pc">
                        ...
                        <img src="/products/acrylic/img/figure-aurora/aurora_stand05.webp" alt="ラバーストラップ制作事例（ロゴ）"
                ...
                <div class="product-details" id="">
                    ...
                    <h2 class="promo-title" style="color: #cc3f44; !important;">
                        光の角度で色が変わる！特別感あふれるオーロラアクスタ！</h2>

                    <div class="info-card">
                        <h3 class="lpc">光と色の演出でスペシャルに！</h3>
                        <a onclick="GotoDiv(6)" href="javascript:void(0)"><img
                                src="/products/acrylic/img/figure-aurora/aurora_banner01.webp?v=1" alt="業界最短7日出荷"
                                width="660" height="auto" loading="lazy"></a>
                        <p class="new-text">オーロラアクリルスタンド（オーロラアクスタ）は、光の角度などによって色が変わるエフェクト付き。スペシャルな仕上がりのアクスタになります。</p>
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(3)"><img
                                src="/products/acrylic/img/figure-aurora/aurora_banner02.webp?c=1" alt="業界最安値価格" width="660"
                    ...
                    <div class="info-card">
                        <h3 class="lpc">はがれない強い印刷！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(7)"><img
                                src="/products/acrylic/img/figure-aurora/aurora_banner03.webp?k=1" alt="汚れ防止加工" width="660"
                                height="auto" loading="lazy"></a>
                        <p class="new-text">印刷デザインが保護フィルムでカバーされているので、こすれたり引っかいたりしても印刷がはがれません。</p>
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text"
                                 onclick="GotoDiv(7)">保護フィルムの詳細</a>
                        </div>
                    </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="type-toggle" class="accordion-header" id="type-g">
                            <span class="fw-bold">ピンクベース加工とブルーベース加工をご用意</span>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <div class="poster-grid">
                                        <div class="poster-item">
                                            <div class="text-center" style="text-align:center;"><p class="new-text">左がピンクベース <br> 右がブルーベース</p></div>
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/figure-aurora/aurora_stand07.webp"
                                                    alt="Poster 1" />
                                        ...
                                        <div class="poster-item">
                                            ...
                                            <div>
                                                <img loading="lazy" onclick="openSimpleModal(this, 1)"
                                                    src="/products/acrylic/img/figure-aurora/aurora_stand02.webp"
                                                    alt="Poster 2" />
                                                <div class="camera-left"
                                                    style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                                    📷<?= lang('クリックすると拡大します') ?>
                                ...
                                <br>
                                <div>
                                    <p class="new-text">オーロラアクリルスタンド（オーロラアクスタ）は、光の当たる角度や見る角度などによって、まるで表情を変えるかのように色彩が変化していきます。この点が最大の魅力です。見る角度や照明などの条件によって、ピンク、ブルー、グリーン、オレンジなどさまざまな色が現れ、同じデザインでも見るたびに違う印象を楽しむことができます。写真やイラストをただ再現するだけでなく、色と光の演出までデザインの一部にできる、ワンランク上のアクリルスタンドです。</p>
                                    <br>
                                    <p class="new-text">このオーロラ素材を活かしたオリジナル製作サービスとして、ピンクベース加工タイプとブルーベース加工タイプの2種類をご用意しています。どちらも光の角度によって色が変化する特性は共通していますが、色の変化のパターンが異なります。</p>
                                    <br>
                                    <p class="new-text">なお、白押さえ（印刷デザインがアクリルスタンド（オーロラアクスタ）の反対側の面に透けるのを防ぐ白色の印刷）を入れた部分にはオーロラ加工の効果が出ません。ご注意ください。</p>
                                </div>
                                <br>
                                <div>
                                    <iframe width="100%" height="388" src="https://www.youtube.com/embed/0FQZiYeWz-o?si=IphnYI6TS6FkuxlT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="acc-price">
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">納期を選択してください。サイズ別の製作単価表が表示されます。ここは価格表のみです。見積・注文は<a class="new-text" onclick="GotoDiv(1)">こちら</a>です。</p>
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                ...
                                <!-- <div class="flex-container">
                                    ...
                                    <div class="flex-item item">
                                        <div class="btn-container item_btn" style="display: flex; justify-content: space-between">
                                            ...
                                            <a class="btn-a btn-yellow" href="/contact/?item=アクリルスタンド（オーロラアクスタ）">
                                ...
                                <br><br>
                                <a class="new-text" href="/contact/?item=オーロラアクリルスタンド" >無料サンプルの送付をリクエスト</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="/products/acrylic/cutline_white"><img src="/products/acrylic/img/figure-aurora/cutpath_aurora.webp" alt="" loading="lazy"></a>
                                </div>
                                <br>
                                <div>
                                    <p class="new-text">オーロラアクリルスタンド（オーロラアクスタ）の製作にあたって、カットパスや白押さえなど、専用の入稿データの作成にお悩みの方もいるでしょう。当店では無料のデータ作成補助サービスをご用意。お客様の代わりに入稿データを無料で作成いたします。イラストや写真の画像（JPG、PNG）、PDFなどをお送りください。</p>
                                    <br>
                                    ...
                                    <br><br>
                                    <a href="/products/acrylic/template/template-aurora-acrylic-stand.zip" class="new-text" download>テンプレートをダウンロード</a>
                                    <!-- <div>
                                        <a href="https://hotmobily.jp/products/data-acrylic-figure.php">
                                            <img src="/products/acrylic/img/figure-aurora/banner_guide_acrylic_aurora.webp" alt="" loading="lazy"></a>
                                    </div> -->
                                </div>
                            </div>
                        </div>
            ...
            <div id="order-form">
                ...
                <div>
                    ...
                    <div style="overflow: unset!important;">
                        ...
                        <h3 class="red">【<?= lang('オーロラアクリルスタンド（オーロラアクスタ）') ?>】</h3>
                        ...
                        <div class="step-box line2" style="text-align: center;">
                            <img data-src="https://hotmobily.jp/products/acrylic/img/base01.webp" id="sample-part-pic" class="picpro lazy" width="250" height="160"><br />
                            <span id="sample-part-name"></span>
                        </div>
                        <div class="step-box line2" style="text-align: center;">
                            <img data-src="https://hotmobily.jp/products/acrylic/img/coming-soon.webp" id="sample-paper-pic" class="picpro lazy" width="500" height="500"><br />
                        ...
                        <div style="display: table-column;">
                            <input type="text" name="ItemType" id="strap" value="オーロラアクリルスタンド" />
                        ...
                        <div class="estimate-content" id="step1">
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_cat" value="ピンクベース加工" <?= $cat1 ?>><?= lang('ピンクベース加工') ?> <span class="checkmark"></span></label>
                                </div>
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="acy_cat" value="ブルーベース加工" <?= $cat2 ?>><?= lang('ブルーベース加工') ?> <span class="checkmark"></span></label>
                                </div>
                            </div>
                            <h3><?= lang('印刷面') ?></h3>
                            <div class="part-container">
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="rainbow01-toggle" class="accordion-header">
                            <span class="fw-bold">光と色の演出でワンランク上の仕上がりに！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                   <img src="/products/acrylic/img/figure-aurora/オーロラアクスタPR02.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    「いつものアクスタでは物足りない」「ワンランク上の仕上がりを目指したい」「デザインに動きや変化を持たせたい」といったクリエイター様・企業様の想いに応えるのが、このオーロラアクリルスタンド（オーロラアクスタ）です。
                                </p>
                                <br>
                                <p class="new-text">最大の特徴は、光の角度や周囲の環境によってカラーが変化するきらめき。見る位置が変わるたびに、ブルー、グリーン、ピンク、オレンジなど多彩な表情が浮かび上がり、ひとつのデザインが何通りもの印象を生み出します。静止したアクリルスタンドでありながら、まるで光とともに呼吸しているかのような存在感を放ち、こだわりのオリジナルデザインの価値を一段と高めます。</p>
                                <br>
                                <p class="new-text">オーロラ素材特有の透明感と反射効果を活かせば、キャラクターの可愛らしさをより強調して演出したり、クールなビジュアルに近未来的なニュアンスを加えたりと、世界観の再現度を大きく引き上げることが可能です。背景全体にオーロラの輝きをまとわせることで奥行きと立体感を強調することも、デザインを工夫することで瞳やアクセサリーにオーロラの光を透過させてアクセントにすることもできます。光が当たるたびにさりげなく色が変わる演出は、写真では伝わりきらないリアルな感動を生み出します。</p>
                                <br>
                                <p class="new-text">さらに、オーロラアクリルスタンド（オーロラアクスタ）は「普通のグッズ」を超えた存在へと変身させる力を持っています。見るたびに違う色を楽しめるため、ファンにとっては飾る時間そのものが体験価値になります。限定ビジュアルや特別衣装との組み合わせはもちろん、周年記念やコラボ企画、数量限定アイテムとして展開すれば、グッズそのものにプレミアムな意味を持たせることができます。</p>
                                <br>
                                <p class="new-text">イベント会場で光を浴びて輝く姿、部屋の窓辺で自然光に反応して色を変える姿。その一瞬一瞬が、手に取った人に特別な高揚感を与えます。ただ飾るためのアクスタではなく、光によって完成するアートピースへ。オーロラアクリルスタンド（オーロラアクスタ）は、デザインの可能性を広げ、ファンの心に残る特別な一個を形にするアイテムです。</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/figure-aurora/aurora_banner_memory.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    オーロラアクリルスタンド（オーロラアクスタ）は、思い出の写真を美しく立体化し、光によって表情を変える特別なメモリアルアイテムへと生まれ変わらせます。
                                </p>
                                <br>
                                <p class="new-text">日常の何気ないワンシーンの写真にも、卒業式や旅行などの特別な瞬間の写真にも、それぞれの思い出が詰まっています。友人たちとの集合写真や、家族みんなの笑顔、一生に一度の卒業式、大切なペットを迎えた日。そんな二度とない大切な瞬間を、スマホの中だけに眠らせておくのはもったいないかもしれません。いつでも目に見える形で、しかも特別な色と光の演出を付けて残すことができたら、素敵だと思いませんか？</p>
                                <br>
                                <p class="new-text">透明感あふれるアクリル素材に、角度や光の当たり方によって色彩が移ろうオーロラの輝き。ブルーやグリーン、ピンク、オレンジなど、さまざまな光のニュアンスが重なり合い、写真の中の笑顔や風景に奥行きを与えます。見るたびに少しずつ違う色味をまとい、その瞬間の記憶をより印象深く、あざやかに彩ります。</p>
                                <br>

                                <p class="new-text">・卒業式の友人との集合写真を、永遠の絆と未来へ踏み出す一歩の記念として。</p>
                                <p class="new-text">・旅先で撮影した家族写真を、色と光の演出でパッと目につくインテリアとして。</p>
                                <p class="new-text">・大切なペットの写真を、見るたびに心あたたまるメモリアルとして。</p>
                                <p class="new-text">・結婚式や成人式など人生の節目の写真を、家族の貴重な記録として。</p>
                                <br>

                                <p class="new-text">写真をオーロラアクリルスタンド（オーロラアクスタ）にすることで、思い出は「しまっておくもの」から「日常の中にあるもの」へと変わります。デスクやリビング、玄関やベッドサイドにそっと置くだけで、自然光や照明に反応して色を変え、その瞬間の記憶を何度でも呼び起こしてくれます。オーロラ仕様ならではの光と演出の輝きは、贈り物としてもひときわ印象的です。ご友人とのメモリアル製作、卒業や入学など人生の節目のお祝い、家族への贈り物、大切なペットの記録として、言葉を超えた想いを届けることができます。</p>
                                <br>
                                <p class="new-text">思い出の大切な瞬間を、色あせない透明感と光と色の演出の力でより彩りあふれたメモリアルに生まれ変わらせます。いつでも目に留まり、いつまでもそばに置いておける形に。オーロラアクリルスタンド（オーロラアクスタ）は、あなたの大切な思い出を、変化する色合いできらめく新しいメモリアルのかたちにします。</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/figure-aurora/オーロラ1個から.webp" alt=""
                                        width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    当店のオーロラアクリルスタンド（オーロラアクスタ）は、1個だけの製作も可能です。「配布したり販売するわけじゃないけど、自分のイラストをオーロラアクリルスタンド（オーロラアクスタ）にしたい」「親友への贈り物として唯一無二のオーロラアクリルスタンド（オーロラアクスタ）を作りたい」など、個々人の希望も叶えることができます。一つだけの製作であっても、製作するオーロラアクリルスタンド（オーロラアクスタ）の品質は最高レベルです。光を反射して移り変わる色のきらめきが、お客様だけの写真やイラストをアート作品のようなアクスタへと変身させ、あなただけの宝物として、あるいはオンリーワンのギフトとして、最高の逸品にします。1個だけのオーロラアクリルスタンド（オーロラアクスタ）製作も、大ロットのご注文もホットモバイリーまで。
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/acrylic/img/figure-aurora/acrylic-protection-compare-aurora.webp" alt="" width="100%" loading="lazy">
                                </div>
                                <br>
                                <p class="new-text">
                                    他社とは一線を画す当店のオーロラアクリルスタンド（オーロラアクスタ）の強みのひとつとして、お客様の大切なデザインを保護する保護フィルムがあります。
                                </p>
                                <br>
                                <p class="new-text">一般的なオーロラアクリルスタンド（オーロラアクスタ）は保護フィルムがなく、固いものがこすれたり爪で引っかいたりすると、印刷されたデザインがはがれる恐れがあります。しかし、当店のアクリルスタンド（オーロラアクスタ）は印刷デザインを保護フィルムで覆っています。このため、印刷がむき出しにならず保護フィルムによって保護され、印刷がはがれる恐れがありません。</p>
                                <br>
                                <p class="new-text">せっかく製作したオーロラアクリルスタンド（オーロラアクスタ）なら、長くキレイに保ちたい方も多いかと思います。当店のオーロラアクリルスタンド（オーロラアクスタ）なら、お客様のご希望を叶えることが可能です。</p>
                                <br>
                            ...
                            <div class="plan-section">
                                <div>
                                    <img onclick="openSimpleModal(this, 1)"
                                        src="/products/acrylic/img/figure-aurora/edit-56.webp"
                                        alt="Poster 1" />
                                    <div class="camera-left"
                                        style="text-decoration:none; font-size: 10px; color: #1a0dab; margin: 0;">
                                        📷<?= lang('クリックすると拡大します') ?>
                                ...
                                <br>
                                <p class="new-text">
                                    オーロラアクリルスタンド（オーロラアクスタ）を含め、アクリル製品のカットにはレーザーが使用されることが多いです。しかし、レーザーを使ってアクリル板をカットすると、カット面に不自然な突起ができます。ごく小さな突起なので目で見るだけではわかりにくいですが、手でカット面に触ると、引っかかりがあるのがわかるかと思います。当店のアクリル製品は、アクリル板のカットにCNC加工機を使用しております。レーザーとは異なり、不自然な突起のない整ったカット面になります。手で触れても引っかかりのない、なめらかな手触りのカット面に仕上がるのが特長です。
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <label for="factory-toggle" class="accordion-header">
                            <span class="fw-bold">当店のオーロラアクリルスタンド（オーロラアクスタ）はすべて自社生産！</span>
                            <span class="arrow-dove"></span>
                        </label>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <a href="/products/acrylic/ownfactory"><img src="/products/acrylic/img/figure-aurora/オーロラアクスタ工場.webp" alt="" width="100%" loading="lazy"></a>
                                </div>
                                <br>
                                <p class="new-text">
                                    オーロラアクリルスタンド（オーロラアクスタ）を含め、当店のアクリル製品はすべて自社生産です。デザインの印刷、アクリル板のカット、できあがった製品の包装まですべて自社で実施しております。自社生産のためマージンなどが発生せず、お客様のお求めの製品を低コストで製作することが可能です。製品の品質にも責任をもってこだわっております。お客様のデザインを活かした高品質のオーロラアクリルスタンド（オーロラアクスタ）をお届けいたします。
                                </p>
                                <br>
                                <div style="text-align: left;">
                            ...
                            <div class="plan-section">
                                <table class="table_rubber" cellpadding="5" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td><?= lang('名称') ?></td>
                                            <td style="text-align: left;"><?= lang('オーロラアクリルスタンド（オーロラアクスタ）') ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('素材') ?></td>
                                        ...
                                        <tr>
                                            <td><?= lang('色数') ?></td>
                                            <td style="text-align: left;">
                                                フルカラーUVインクジェット印刷+白押さえが基本となります。<br>片面印刷：UV印刷+白押さえ
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('台座') ?></td>
            ...
            <div id="download_templete" class="download_templete">
                <div class="modal-content">
                    ...
                    <h3><?= lang('アクリルスタンド（オーロラアクスタ）') ?>【Illustrator／Photoshop】</h3>
                    <table class="table_rubber">
                        <tbody>
                            <tr>
                                <td>50×50mm</td>
...
-->
    ...
    <script type="text/javascript" src="/products/acrylic/js/calculate-figure-aurora-ver2.js?v=<?php echo date('is'); ?>" defer></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            const imageList = [
                "/products/acrylic/img/figure-aurora/aurora_stand01.webp",
                "/products/acrylic/img/figure-aurora/aurora_stand02.webp",
                "/products/acrylic/img/figure-aurora/aurora_stand03.webp",
                "/products/acrylic/img/figure-aurora/aurora_stand04.webp",
                "/products/acrylic/img/figure-aurora/aurora_stand05.webp",
                "/products/acrylic/img/figure-aurora/aurora_stand06.webp?v=1"
            ];
