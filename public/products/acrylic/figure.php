          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x1665">
                    <img class="zoom-img" id="zoom_04" src="img/Acrylic Standees-01-1.webp" width="376" height="458" data-zoom-image="img/Acrylic Standees-01XL.webp?v=1.01" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x1665">
                    <img class="zoom-img" id="zoom_01" src="img/acyl-figure-2022-1s.webp" width="376" height="458" data-zoom-image="img/acyl-figure-2022-1.webp" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x1665">
                    <img class="zoom-img" id="zoom_02" src="img/acyl-figure-2022-2s.webp" width="376" height="458" data-zoom-image="img/acyl-figure-2022-2.webp" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x1665">
                    <img class="zoom-img" id="zoom_03" src="img/acyl-figure-2022-3s.webp" width="376" height="458" data-zoom-image="img/acyl-figure-2022-3.webp" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
            </div>
            ...
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="img/Acrylic Standees-01-1.webp" width="93" height="113" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="img/acyl-figure-2022-2-btn.webp" width="93" height="113" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="img/acyl-figure-2022-3-btn.webp" width="93" height="113" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="img/acyl-figure-2022-4-btn.webp" width="93" height="113" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
