...
<body id="top">
    ...
    <div id="wrapper">
        ...
        <div id="content_wrapper" class="scrollingPanel">
            ...
            <div id="C">
                <h1 class="h1-new Mb-A-Contents">オリジナル印刷ラバーコースター（2026年版）</h1>
                <div class="social-sns Mb-A-Contents">
                    <p>シェアする</p>
            ...
            <div class="container">
                <div class="product-gallery" id="B">
                ...
                <div class="product-details" id="A">
                    <div class="price-box Mb-B-Contents">
                    ...
                    <h2 class="promo-title Mb-B-Contents" style="color: #cc3f44; !important;">
                        業界最速・最安！1個から製作可能な自社生産の印刷ラバーコースター</h2>

                    <div class="info-card Mb-B-Contents">
            ...
            <div id="acc-shape">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="shape-toggle" class="accordion-input">
            ...
            <div id="acc-color">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="color-toggle" class="accordion-input">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">
                                    全10色の印刷ラバーコースター用の本体色をご用意しております。お選び頂いた色のラバー本体の表面に、お客様のデザインを印刷するかたちになります。</p>
                                <br>
                                <div class="main-col">
                                    <div class="sub-col">
            ...
            <div id="acc-print_type">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="print_type-toggle" class="accordion-input">
            ...
            <div id="acc-shipping">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="shipping-toggle" class="accordion-input">
            ...
            <div id="acc-num_days">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="num_days-toggle" class="accordion-input">
            ...
            <div id="acc-data">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="template-toggle" class="accordion-input">
            ...
            <div id="acc-option">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="option-toggle" class="accordion-input">
            ...
            <div id="acc-print">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="print-toggle" class="accordion-input">
            ...
            <div id="acc-flow">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="flow-toggle" class="accordion-input">
            ...
            <div id="acc-safety">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="security-toggle" class="accordion-input">
            ...
            <div id="acc-specifications">
                <div class="accordion-container">
                    <div class="accordion-item">
                        <input type="checkbox" id="spec-toggle" class="accordion-input">
...
-->
    <!-- Swiper JS -->
    <script type="text/javascript" src="/js/_setToInput_printedrubbercoaster.js?ver=1.5"></script>
    ...
    <script>
        $(document).ready(function () {
            ...
            function initGallery() {
                ...
                <img src="${item.src}" alt="${item.alt}" loading="eager" class="pdp-v2-slide-img">
            `;
                    // Add event directly
