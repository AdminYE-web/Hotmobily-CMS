...
<head>
    ...
    <link rel="canonical" href="https://hotmobily.jp/products/printedrubbercoaster/">
...
.side_link{
  letter-spacing: 0;
    font-feature-settings: normal;
        ...
        .prod-table-ui thead th {
            background-color: #f8f9fa;
            font-weight: 700;
            font-size: .95rem
        }

        .prod-table-ui td.prod-label {
            text-align: center;
            font-weight: 500;
            width: 45%
        }
            ...
            <div class="container">
                ...
                <div class="product-details" id="">
                    ...
                    <div class="info-card">
                        ...
                        <img src="/products/images/printed-rubber-coaster-protect-v2.webp" alt=""
                            loading="lazy">
                        <p class="new-text">うっかりコースターを汚してしまっても安心な汚れ防止加工オプションをご用意。1個当たり99円（税込）！</p><br>
                        <div style="text-align:right;">
                                        ...
                                        <table class="prod-sched-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="" style="background-color:white;">@99円</th>
                                                </tr>
                                                <tr>
                                                    <th class="fw-bold">裏面印刷</th>
                                                    <th class="" style="background-color:white;">@55円</th>
                                                </tr>
                                                <tr>
                    ...
                    <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                        ...
                        <div class="estimate-content" id="step1">
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name">
                                        <input type="radio" name="silk_print" id="nashiprint" value="裏面印刷なし" <?php echo $printing1_checked ?> onclick="clearValue();" /><?= lang('裏面印刷なし') ?>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="part-content">
                                    <label class="part-name">
                                        <input type="radio" name="silk_print" id="byprint" value="裏面印刷あり" <?php echo $printing4_checked ?> onclick="clearValue();" /><?= lang('裏面印刷あり') ?>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <!-- <div class="part-content">
...
-->
    <!-- Swiper JS -->
    <script type="text/javascript" src="/js/_setToInput_printedrubbercoaster_2026s.js?ver=<?php echo date('is') ?>"></script>
    ...
    <script type="text/javascript" src="/products/js/pdf_rubber_ver2.js?ds=<?php echo date('is') ?>"></script>
    <script>
        $(document).ready(function() {
