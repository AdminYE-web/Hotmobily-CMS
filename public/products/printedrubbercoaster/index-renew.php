...
//Read Modules
require_once('../../control/Control_Rubber_Renew.php');
                                ...
                                <div class="flex-item">
                                    ...
                                    <table class="table_rubber total_price_tbl">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="TableLeft"><?= lang('小計') ?></td>
                                                <td class=""><input style="text-align: right;" type="text" size="16"
                                                        name="BeforeTax" readonly="readonly" id="textfield9"
                                                        class="right" value="<?= $BeforeTax ?>">円</td>
                                            </tr>
                                            <tr>
                                                <td class="TableLeft"><?= lang('消費税(10%)') ?></td>
                                                <td class=""><input style="text-align: right;" type="text" size="16"
                                                        name="Tax" readonly="readonly" id="textfield_tax"
                                                        class="right" value="<?= $Tax ?>">円</td>
                                            </tr>
                                            <tr>
...
-->
    <!-- Swiper JS -->
    <script type="text/javascript" src="/products/printedrubbercoaster/js/renew-calculater.js?ver=<?php echo time() ?>"></script>
    ...
    <script type="text/javascript" src="<?= $pdf_rubber_renew_js ?>"></script>
    <script>
        $(document).ready(function() {
