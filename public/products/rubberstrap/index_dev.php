...
$planDisableStart = new DateTimeImmutable('2026-08-10 00:00:00', new DateTimeZone('Asia/Tokyo'));
                ...
                <div style="overflow: unset!important;">
                    ...
                    <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                        ...
                        <div class="estimate-content" id="step1">
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name"><input type="radio" name="ItemDesignRepeat" value="いいえ"
                                            onclick="$('.repeat').hide();" <?= $RepeatSelected_1 ?>>いいえ <span
                            ...
                            <h3><?= lang('ご注文タイプ') ?></h3><a class="btn-details inline" href="javascript:void(0)"
                                ...
                                <div class="modal__inner modal1">
                                    ...
                                    <div class="flex-container b-bottom p-bottom">
                                        ...
                                        <div class="icon-text">
                                            ...
                                            <p>
                                                <?= lang('通常のラバーストラップのご注文はスタンダートプランをご利用下さい。来店されたお客様への景品や粗品、イベントでの販売などに最適です。玩具や、趣味としての販売にお使い頂くのに十分な品質を確保しております。また、業界最速での納期をご提供しながら、コストパフォーマンスの高さを実現。特に法人のお客様の大ロット・短納期へのご要望、台紙や同梱する書類などへの対応も含めて専任の担当者がご希望にお応えできる体制を構築しております。'); ?><br /><a
                                                    href="https://hotmobily.jp/products/quality.html#quality-check1"><?= lang('スタンダートの品質基準'); ?></a>
                                            </p>
                                            <div>&nbsp;</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-container b-bottom p-bottom">
                                        ...
                                        <div class="icon-text">
                                            ...
                                            <p>
                                                <?= lang('原稿確定日より、7営業日後に出荷いたします。例）月曜日に原稿確定の場合、翌週火曜日に出荷<br/>スタンダードと同じ品質とコストパフォーマンスで、納期を縮めることができます。「とにかく早く作りたい！」とお考えのお客様に最適。このプランは、200個までのご注文で選択いただけます。'); ?><br /><a
                                                    href="https://hotmobily.jp/products/quality.html#quality-check1"><?= lang('スタンダード（スピード発送）の品質基準はスタンダートの品質基準をご覧ください'); ?></a>
                                            </p>
                                            <div>&nbsp;</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-container b-bottom p-bottom">
                                        ...
                                        <div class="icon-text">
                                            ...
                                            <p>
                                                <?= lang('物販サイトや店頭での販売や限られた大切なお客様への配布などに最適です。スタンダートプランとの一番の違いは品質の高さです。通常の玩具やノベルティ製品に要求される品質をはるかに超えた卓越した逸品としての品質を確保しております。海外での検査に加え、日本国内の専門検査会社での検査を行い品質を保証致します。<br/>また、ハイスペックな製品をお求めのお客様に対応する為、製作可能な色数や裏面印刷へのこだわりなど、専任の担当者が細部までヒアリングを行い、対応させて頂きます。'); ?><br /><a
                                                    href="https://hotmobily.jp/products/quality.html#quality-check2"><?= lang('プレミアムの品質基準'); ?></a>
                                            </p>
                                            <div>&nbsp;</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-container p-bottom">
                                        ...
                                        <div class="icon-text">
                                            ...
                                            <p>
                                                <?= lang('10個9,900円（税込)。ラバスト製作の初心者向け入門プランです。ラバストと他の製品の大きな違いは、事前に金型を作る必要があるので、ラバスト独特のデザインに変更しないといけない点です。こういった所を、できる限り小予算で体験して頂いたり、これから本格的にラバストを含めたグッズ製作をやってみようという方を念頭に置いたプランです。'); ?><br /><span
                                                    class="font_s"><?= lang('・このサービスは、個人のお客様専用のサービスです。<br/>・このサービスをご注文頂くお客様は、ホットモバイリーのツイッター(@GoodsYe)のフォローをお願いしております。<br/>・データトレースも製作料金に含まれますので、どの様なデータでも大丈夫です。<br/>・ご納期の指定はできません。<br/>・見積書、請求書、領収書の発行はできません。WEBサイトからのご注文のみとなります。<br/>ホットモバイリーファンの品質基準は'); ?><a
                                                        href="https://hotmobily.jp/products/quality.html#quality-check1"><?= lang('スタンダートの品質基準をご覧ください'); ?></a></span>
                                            </p>
                                            <div>&nbsp;</div>
                                        </div>
                                    </div>
                            ...
                            <div class="part-container">
                                <div class="part-content"><label class="part-name"><input type="radio" name="ItemPCS"
                                            ...
                                            <?= $lsSelected_1pcs ?>><?= lang('スタンダード') ?> <span
                                ...
                                <div class="part-content" <?= $delivery_disabled ?>><label class="part-name"><input
                                            ...
                                            onclick="click_typeorder_enabled();clearValue();" <?= $lsSelected_4pcs ?> <?= $planDisabled ?>><?= lang('スタンダード（スピード7営業日発送）') ?> <span class="checkmark"></span></label>
                                </div>
                                <div class="part-content"><label class="part-name"><input type="radio" name="ItemPCS"
                                            id="pcs2" value="プレミアム" onclick="click_typeorder_disabled();clearValue();"
                                            <?= $lsSelected_2pcs ?> <?= $planDisabled ?>><?= lang('プレミアム') ?> <span
                                            class="checkmark"></span></label></div>
                                <div class="part-content"><label class="part-name"><input type="radio" name="ItemPCS"
                                            id="pcs3" value="ホットモバイリーファン"
                                            onclick="type_special_disabled('t1');clearValue();" <?= $lsSelected_3pcs ?> <?= $planDisabled ?>><?= lang('ホットモバイリーファン (10個 9,900円税込)') ?><span
                                            class="checkmark"></span></label>
                                </div>
                            ...
                            <h3><?= lang('ベース厚さ') ?></h3><a class="btn-details inline" href="javascript:void(0)"
                            ...
                            <div class="part-container">
                                <div class="part-content"><label class="part-name"><input type="radio" id="normal_size"
                                            name="ItemSize" value="通常（80*80/3mm厚）" <?php echo $tickness0_checked ?>
                                            onclick="clearValue();" /><?= lang('通常（3mm厚）') ?> <span
                                            class="checkmark"></span></label></div>
                                <div class="part-content"><label class="part-name"><input type="radio" id="big_size"
                                            name="ItemSize" value="ハイインパクト（80*80/5mm厚）" <?php echo $tickness1_checked ?>
                                            onclick="clearValue();" /><?= lang('ハイインパクト（5mm厚）') ?> <span
                                            class="checkmark"></span></label></div>
                            </div>
                            ...
                            <div class="part-container">
                                <div class="part-content"><label class="part-name"><input type="radio"
                                            name="ItemMaterial" value="特殊素材なし" <?php echo $material0_checked ?>
                                            onclick="clearValue();" /><?= lang('特殊素材なし') ?> <span
                                            class="checkmark"></span></label></div>
                                <div class="part-content"><label class="part-name"><input type="radio"
                                            name="ItemMaterial" value="特殊素材あり" <?php echo $material1_checked ?>
                                            onclick="clearValue();" /><?= lang('特殊素材あり') ?> <span
                                            class="checkmark"></span></label></div>
                            </div>
                            ...
                            <div class="part-container">
                                <div class="part-content"><label class="part-name"><input type="radio" name="silk_print"
                                            id="nashiprint" value="印刷なし" <?php echo $printing1_checked ?>
                                            onclick="clearValue();" /><?= lang('印刷なし') ?> <span
                                            class="checkmark"></span></label></div>
                                <div class="part-content"><label class="part-name"><input type="radio" name="silk_print"
                                            id="ariprint" value="単色（シルク）印刷" <?php echo $printing2_checked ?>
                                            onclick="clearValue();" /><?= lang('単色（シルク）印刷') ?> <span
                                            class="checkmark"></span></label></div>
                                <div class="part-content"><label class="part-name"><input type="radio" name="silk_print"
                                            id="fcprint" value="フルカラー印刷" <?php echo $printing3_checked ?>
                                            onclick="clearValue();" /><?= lang('フルカラー印刷') ?>
                                        <span class="checkmark"></span></label></div>
                                <span style="color: red" id="error_print"></span>
                                <font color="red">※<?= lang('プレミアムは裏面印刷が無料') ?></font>
                            </div>
                            <h3><?= lang('汚れ防止加工') ?></h3><a class="btn-details inline" href="javascript:void(0)"
                            ...
                            <div class="part-container">
                                <div class="part-content"><label class="part-name"><input type="radio" name="coating"
                                            id="coating0" value="汚れ防止加工なし" <?php echo $coating0_checked ?>
                                            onclick="clearValue();" /><?= lang('汚れ防止加工なし') ?>
                                        <span class="checkmark"></span></label></div>
                                <div class="part-content"><label class="part-name"><input type="radio" name="coating"
                                            id="coating1" value="汚れ防止加工あり" <?php echo $coating1_checked ?>
                                            onclick="clearValue();" /><?= lang('汚れ防止加工あり (納期+3～5営業日）') ?> <span
                                            class="checkmark"></span></label>
                                </div>
                            ...
                            <div class="part-container">
                                <div class="part-content">
                                    <label class="part-name" id="label-qty"><?= lang('ご注文・御見積数量') ?>&nbsp;&nbsp;<input
                                            type="number" name="numberOf" id="no_of_order" class="right qty-inp"
                                            onchange="this.value=format_number(this.value);"
                                            value="<?php echo $numberOf ?>" style="text-align: right;"><br /></label>
                                        ...
                                        <td colspan="2" style="background: unset;border: unset;">
                                            <div class="flex-container btn-container">
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-back"
                                                    onclick="valid_chk_btn('step1');$('#cus_detail').hide();"><?= lang('製作条件修正') ?></a>
                                                <a href="javascript:void(0)" class="btn btn-back"
                                                    onclick="valid_chk_btn('step2');$('#cus_detail').hide();"><?= lang('ｱﾀｯﾁﾒﾝﾄ修正') ?></a>
                                                <input type="button" class="btn est-btn flex-item"
                                                    value="<?= lang('見積書') ?>" id="button_pdf2"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input type="text" id="zip" name="zip" maxlength="8" size="15"
                                            ...
                                            value="<?= lang('住所に変換') ?>"><br><span id="error" style="color:red"></span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center"
                                        ...
                                        <input id="button_pdf" type="button"
                                            ...
                                            value="<?= lang('御社情報確定（PDF出力）') ?>" />
                                        <div class="remark">&nbsp;<?= lang('※社名や会社名の入力は任意です') ?></div><span
                            ...
                            <div class="plan-section">
                                <table class="table_rubber" cellpadding="5" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td><?= lang('名称') ?></td>
                                            <td style="text-align: left;"><?= lang('オリジナルラバーストラップ') ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('素材') ?></td>
                                        ...
                                        <tr>
                                            <td><?= lang('大きさ') ?></td>
                                            <td style="text-align: left;">
                                                <?= lang('縦80mmX横80mm以内。（このサイズを超える製品は、別途費用がかかります）') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('厚さ') ?></td>
                                            <td style="text-align: left;"><?= lang('3mmもしくは5mm。注文時に指定。指定肉厚可。') ?></td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('色数') ?></td>
                                            <td style="text-align: left;">
                                                <?= lang('スタンダードの場合12色まで、プレミアムの場合18色までご使用頂けます。') ?><br><?= lang('印刷物ではないため、グラデーションは表現できません。') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('色指定') ?></td>
                                            <td style="text-align: left;">
                                                <?= lang('以下2通りのいづれか。①PANTONE(パントーン)もしくは、DIC(ディック)番号によるご指定。②弊社もしくは、お客様が印刷された、色見本（カラーペーパー）によるご指定。') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('裏面印刷') ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left;">
                                                <?= lang('100個より製作します。（ホットモバイリーファンは、10個9,900円です。）') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('試作品（実物校正サンプル）') ?></td>
                                            <td style="text-align: left;">
                                                <?= lang('スタンダードの場合、+8,800円（税込）、プレミアムの場合無料。') ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><?= lang('台紙') ?></td>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                ...
                                if (isset($favor) && $favor) {
                                    include '../product-review-new-v2.php';
                                }
                                ?>
                            </div>
                        </div>
            ...
            <div id="blog">
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <?php include '../product-blog-new-v2.php'; ?>
                            </div>
                        </div>
                    </div>
                </div>
...
-->
    <!-- Swiper JS -->
    <script type="text/javascript" src="/js/_setToInput_2026.js?d=<?php echo date('is') ?>" defer></script>
    <script src="/js/validation_new.js?v=1.11" defer></script>
    <script type="text/javascript" src="/products/js/calendar_n2.js?v=3.17" defer></script>
    <script type="text/javascript" src="/products/js/date.js" defer></script>
    <script type="text/javascript" src="<?= $pdf_rubber_js ?>" defer></script>
    <script>
