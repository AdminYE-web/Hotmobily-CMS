...
<head>
    ...
    <meta name="keywords" content="立体チャーム">
    <meta name="description" content="オリジナル立体ラバーキーホルダー・フィギュアを明瞭価格で製作！100個〜の小ロット対応（1,000個時単価797円）。3Dデータがなくても画像・イラストから作成可能です。立体造形×高精彩印刷で細部まで忠実再現。推し活グッズや法人ノベルティに最適。">
    <meta name="robots" content="index,follow" />
    <title>立体ラバーキーホルダー・フィギュア製作｜明瞭価格・100個〜</title>
    <link rel="canonical" href="https://hotmobily.jp/products/pvc_hariawase/">
            ...
            <div class="container">
                ...
                <div class="product-details" id="">
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(5)"><img src="/products/pvc_hariawase/images/3D-rubber-banner01.webp" alt="ぷくぷく立体シールの価格" loading="lazy"></a>
                    ...
                    <div class="info-card">
                        <h3 class="lpc">キャラクターやマスコットが立体に！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(9)"><img src="/products/pvc_hariawase/images/3D-rubber-banner02.webp" alt="ぷくぷく立体シールの価格" loading="lazy"></a>
                        <p class="new-text">オリジナルのキャラクターやマスコットが立体キーホルダーや立体フィギュアに変身！</p>
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text" onclick="GotoDiv(9)" style="color: black;">立体ラバーの詳細</a>
                        </div>
                    </div>

                    <div class="info-card">
                        <h3 class="lpc">選べるアタッチメント！</h3>
                        <a href="javascript:void(0)" onclick="GotoDiv(8)"><img src="/products/pvc_hariawase/images/3D-rubber-banner03.webp" alt="オリジナルデザインでぷくぷく立体シール製作" loading="lazy"></a>
                        <p class="new-text">キーリングやボールチェーンなど、各種アタッチメントを付けられます！</p>
                        <div style="text-align:right;">
                            <a href="javascript:void(0)" class="new-text" onclick="GotoDiv(8)" style="color: black;">アタッチメントの詳細</a>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/pvc_hariawase/images/3D-rubber-banner04.webp" alt="オリジナルデザインでキャンディシール製作" width="100%" loading="lazy">
                                </div>
                                <br>
            ...
            <div id="attachment">
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <p class="new-text">ご希望の場合はアタッチメントを付けることも可能です。各種アタッチメントをご用意しております。</p>
                                <br>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    ...
                                    <br>
                                    <p class="new-text">
                                        六面図とは、対象のキャラクターなどを六方向（正面・背面・上面・右側面・左側面・下面）から映したそれぞれの図です。
                                    </p>
                                    <br>
                                    <div>
                                        <img src="/products/pvc_hariawase/images/3D-rubber-rokumenzu.webp" alt="オリジナルデザインでキャンディシール製作" width="100%" loading="lazy">
                                    </div>
                                    <br>
                                    <p class="new-text">
                                    ...
                                    <br>
                                    <div>
                                        <img src="/products/pvc_hariawase/images/3D-rubber-sanmenzu.webp" alt="オリジナルデザインでキャンディシール製作" width="100%" loading="lazy">
                                    </div>
                                    <br>
                                </div>
                            </div>
                    ...
                    <div style="overflow: unset!important;">
                        ...
                        <div class="step-container line1" style="padding: 5px;border: 1px solid lightgray;margin-bottom: 5px;">
                            ...
                            <div class="step-box line2" style="text-align: center;">
                                <img class="picpro lazy" data-src="/products/images/HM_part1-2.webp" id="sample-part-pic" style="display: none;" width="320" height="320"><br />
                        ...
                        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
                            <div style="display: table-column;"><input type="text" name="ItemType" id="strap" value="3D立体チャーム" /></div>
                            <?php
                            switch ($ItemPCS) {
                                case "スタンダード":
                            ...
                            <div class="estimate-content" id="step2">
                                ...
                                <div class="flex-container">
                                    <div class="preview-container">
										...
										<div class="flex-item">
										<label class="part-name">
										<input type="radio" name="acy_part" value="' . $attachment[$i]["part_name"] . '" onclick="getPartData(\'' . $attachment[$i]["part_name"] . '\')" required ' . (isset($acy_part) && $acy_part == $attachment[$i]["part_name"] ? 'checked' : '') . '>
                                ...
                                <h3>3Dデータ作成補助（STLデータ、CADデータ等の3Dデータをお持ちでない方はご選択）</h3>
                                <div class="part-container">
                                    <div class="part-content">
                                        <label class="part-name">
                                            <div class="switch_off_button b2 switch_off">
                                                <input type='hidden' value='なし' name='DeFormat'>
                                                <input type="checkbox" class="checkbox" name="DeFormat" value="あり" onclick="setToInput();" <?= ($DeFormat == 'あり' ? 'checked' : '') ?>>
                                                <div class="knobs">
                                                    <span></span>
                                                </div>
                                                <div class="layer"></div>
                                    ...
                                    <div class="flex-item">
                                        ...
                                        <table class="table_rubber">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="TableLeft"><?= lang('3Dデータ作成補助') ?></td>
                    ...
                    <div class="accordion-container">
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <div class="plan-section">
                                    <div>
                                        <img src="/products/pvc_hariawase/images/3D-rubber-banner05.webp" alt="ぷくぷく立体シールでデコレーション" width="100%" loading="lazy">
                                    </div>
                                    <br>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/pvc_hariawase/images/3D-rubber-banner06.webp" alt="ぷくぷく立体シールで推し活" width="100%" loading="lazy">
                                </div>
                                <br>
                            ...
                            <div class="plan-section">
                                <table class="table_rubber" cellpadding="5" cellspacing="0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= lang('試作品') ?></td>
                                            <td style="text-align: left;">試作品 : 9営業日後＋1～2配送日 <br> 試作後の量産品 : 15営業日後＋１～2配送日</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
-->
    ...
    <script>
        $(document).ready(function() {
            ...
            const imageList = [{
                    src: "/products/pvc_hariawase/images/3D-rubber-01.webp",
                    targetId: "processing",
                    alt: "貝殻のぷくぷく立体シール"
                },
                {
                    src: "/products/pvc_hariawase/images/3D-rubber-02.webp",
                    targetId: "special",
                    alt: "キャラクターのぷくぷく立体シール"
                },
                {
                    src: "/products/pvc_hariawase/images/3D-rubber-03.webp",
                    targetId: "plans",
                    alt: "ぷくぷく立体シールの拡大図"
                },
                {
                    src: "/products/pvc_hariawase/images/3D-rubber-04.webp",
                    targetId: "production",
                    alt: "海の生き物のぷくぷく立体シール"
                },
                {
                    src: "/products/pvc_hariawase/images/3D-rubber-05.webp",
                    targetId: "production",
                    alt: "果物のぷくぷく立体シール"
                },
                {
                    src: "/products/pvc_hariawase/images/3D-rubber-06.webp",
                    targetId: "production",
                    alt: "ロゴのぷくぷく立体シール"
                }
            ];
            ...
            fetchHolidayData("24days", function(date) {
                productionDate(date);
                productionDate28Days(date);
            });
        ...
        function openAttachmentAccordion() {
            $('#attachment-toggle').prop('checked', true);
            document.getElementById('acc-attachment')?.scrollIntoView({
                behavior: 'smooth',
                block: 'start'
            });
        }
