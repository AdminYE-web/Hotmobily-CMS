	var price_1 = [869,649,605,572,517,484];
	var price_2 = [781,583,550,517,462,440];
	...
	function setToInput(){
		...
		if (ItemType == "オリジナルテンチャックケース") {
			if (size1.checked) {
				if (vno_of_order.value >= 50) order_pcs = price_1[5];
			...
			if (size2.checked) {
				if (vno_of_order.value >= 50) order_pcs = price_2[5];
