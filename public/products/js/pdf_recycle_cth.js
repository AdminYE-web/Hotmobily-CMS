...
function validate(tmp){
  ...
  var date = y+"年"+m+"月"+d+"日";
    ...
    if(document.getElementsByName("ItemType")[0].checked){
      Item = "メガネクリーナー(リサイクル原糸) (昇華転写片面印刷)";
    }else if(document.getElementsByName("ItemType")[1].checked){
      Item = "メガネクリーナー(リサイクル原糸) (昇華転写両面印刷)";
    }    
    //B
    if($("#ItemSize").val() == "1"){
    ...
    delivery = "量産品製作期間：100個まで9営業日、300個まで11営業日、500個まで13営業日、1000個まで16営業日、3000個まで20営業日、5000個まで23営業日 配送期間：1～2日／試作品製作期間：8営業日";
    ...
    var ai_file_price = 0,back_print_price = 0;
