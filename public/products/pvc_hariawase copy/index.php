            ...
            <div class="container">
                ...
                <div class="product-details" id="">
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(5)"><img src="/products/3d-rubber/images/3D-rubber-banner01.webp" alt="ぷくぷく立体シールの価格" loading="lazy"></a>
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(9)"><img src="/products/3d-rubber/images/3D-rubber-banner02.webp" alt="ぷくぷく立体シールの価格" loading="lazy"></a>
                    ...
                    <div class="info-card">
                        ...
                        <a href="javascript:void(0)" onclick="GotoDiv(8)"><img src="/products/3d-rubber/images/3D-rubber-banner03.webp" alt="オリジナルデザインでぷくぷく立体シール製作" loading="lazy"></a>
                    ...
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/3d-rubber/images/3D-rubber-banner04.webp" alt="オリジナルデザインでキャンディシール製作" width="100%" loading="lazy">
                                </div>
                                <br>
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    ...
                                    <br>
                                    <div>
                                        <img src="/products/3d-rubber/images/3D-rubber-rokumenzu.webp" alt="オリジナルデザインでキャンディシール製作" width="100%" loading="lazy">
                                    </div>
                                    <br>
                                    <p class="new-text">
                                    ...
                                    <br>
                                    <div>
                                        <img src="/products/3d-rubber/images/3D-rubber-sanmenzu.webp" alt="オリジナルデザインでキャンディシール製作" width="100%" loading="lazy">
                                    </div>
                                    <br>
                                </div>
                            </div>
                    ...
                    <div class="accordion-container">
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <div class="plan-section">
                                    <div>
                                        <img src="/products/3d-rubber/images/3D-rubber-banner05.webp" alt="ぷくぷく立体シールでデコレーション" width="100%" loading="lazy">
                                    </div>
                                    <br>
                ...
                <div class="accordion-container">
                    <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                            <div class="plan-section">
                                <div>
                                    <img src="/products/3d-rubber/images/3D-rubber-banner06.webp" alt="ぷくぷく立体シールで推し活" width="100%" loading="lazy">
                                </div>
                                <br>
...
-->
    ...
    <script>
        $(document).ready(function() {
            ...
            const imageList = [{
                    src: "/products/3d-rubber/images/3D-rubber-01.webp",
                    targetId: "processing",
                    alt: "貝殻のぷくぷく立体シール"
                },
                {
                    src: "/products/3d-rubber/images/3D-rubber-02.webp",
                    targetId: "special",
                    alt: "キャラクターのぷくぷく立体シール"
                },
                {
                    src: "/products/3d-rubber/images/3D-rubber-03.webp",
                    targetId: "plans",
                    alt: "ぷくぷく立体シールの拡大図"
                },
                {
                    src: "/products/3d-rubber/images/3D-rubber-04.webp",
                    targetId: "production",
                    alt: "海の生き物のぷくぷく立体シール"
                },
                {
                    src: "/products/3d-rubber/images/3D-rubber-05.webp",
                    targetId: "production",
                    alt: "果物のぷくぷく立体シール"
                },
                {
                    src: "/products/3d-rubber/images/3D-rubber-06.webp",
                    targetId: "production",
                    alt: "ロゴのぷくぷく立体シール"
                }
            ];
