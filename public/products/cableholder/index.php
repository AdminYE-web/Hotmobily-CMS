...
<head>
  ...
  <meta name="keywords" content="<?= lang('イヤホンホルダー,オリジナル,作成,製作,同人') ?>">
  <meta name="description" content="<?= lang('業界最安・最速のオリジナルイヤホンホルダーの製作。100個から製作。短納期、最短7営業日で出荷。同人からイベント、ノベルティまで。') ?>">
  <meta name="robots" content="index,follow" />
  <title><?= lang('イヤホンホルダーをオリジナルの形状で製作。業界最速7営業日出荷。同人/イベントグッズ、販促ノベルティ向け。') ?></title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1>イヤホンホルダーをオリジナルで作成できます。半立体製。 (2026年版)</h1>
      <div class="social-time">
        <span class="social-content">
          <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aイヤホンホルダーをオリジナルで作成。同人からイベント、ノベルティまで激安で製作。販促、グッズ、記念品に使えるラバスト。%0A%0A詳細はこちら:https://hotmobily.jp/products/cableholder/" title="Share by Email" target="_blank">シェアする</a>
          <a href="mailto:?subject=ホットモバイリーのこの商品を推薦したいと思います&amp;body=ホットモバイリーのこの商品を推薦したいと思います%0A%0Aイヤホンホルダーをオリジナルで作成。同人からイベント、ノベルティまで激安で製作。販促、グッズ、記念品に使えるラバスト。%0A%0A詳細はこちら:https://hotmobily.jp/products/cableholder/" title="Share by Email" target="_blank"><i class="far fa-envelope"></i></a>
          <a href="https://www.facebook.com/share.php?u=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2fcableholder%2f" target="_blank"><i class="fab fa-facebook-square"></i></a>
          <a href="https://www.twitter.com/share?url=https%3A%2F%2Fwww.hotmobily.jp%2fproducts%2fcableholder%2f&amp;text=イヤホンホルダーをオリジナルで作成。同人からイベント、ノベルティまで激安で製作。販促、グッズ、記念品に使えるラバスト。" target="_blank"><i class="fab fa-twitter-square"></i></a>
        </span>
        ...
        <div class="flex-item item">
          <div class="preview-container">
            ...
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="img/rubber-1.webp" width="93" height="58" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="img/rubber-2.webp" width="93" height="58" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item" style="width: 24.8%"></div>
              <div class="flex-item" style="width: 24.8%"></div>
            </div>
          </div>
        ...
        <div class="flex-item item">
          <table class="table_rubber" style="padding: 0">
            <tr>
              ...
              <td class="">ATBC-PVC（非フタル酸エステル系）のPVC(塩ビ)</td>
            </tr>
            <tr>
              <td class="TableLeft">サイズ</td>
              <td class="">縦70mmX横70mm以内。（このサイズを超える製品は、別途費用がかかります）</td>
            </tr>
            <tr>
              <td class="TableLeft">色数</td>
              <td class="">スタンダードの場合12色まで、プレミアムの場合18色まで。</td>
            </tr>
            <tr>
      ...
      <div style="clear:both;"></div>
        ...
        <div>
            <p class="new-text">ラバー製品を初めて製作する場合、「ラバー製品で何がどこまで再現可能なのか」「どんな素材なのか」などをしっかり把握した上で製作に着手したい方もいますよね。</p><br>
            <p class="new-text">そんな方のために、ラバー製品の素材や加工、デザインなどについての完全ガイドページをご用意しました。
            </p><br>
            <p class="new-text">最高のラバーイヤホンホルダー製作にぜひともお役立てください。</p>
            <br>
      ...
      <div style="clear:both;"></div>
      <h2>ラバーイヤホンホルダー製作事例</h2>
      <p class="d_TEXT1 new-text">
        当店にご注文頂きました、オリジナルラバーイヤホンホルダーの製作事例の中より、掲載許可を頂きましたお客様の作品をご紹介させて頂きます。
      </p>
      <div class="tag-menu">
        タグで絞込み：
        <a href='/gallery/cableholder?tag=個人' class='tag-name' target="_blank">個人</a>
        <a href='/gallery/cableholder?tag=会社' class='tag-name' target="_blank">会社</a>
        <a href='/gallery/cableholder?tag=赤色' class='tag-name' target="_blank">赤色</a>
        <a href='/gallery/cableholder?tag=青色' class='tag-name' target="_blank">青色</a>
        <a href='/gallery/cableholder?tag=黄色' class='tag-name' target="_blank">黄色</a>
        <a href='/gallery/cableholder?tag=紫色' class='tag-name' target="_blank">紫色</a>
        <a href='/gallery/cableholder?tag=緑色' class='tag-name' target="_blank">緑色</a>
        <a href='/gallery/cableholder?tag=黒色' class='tag-name' target="_blank">黒色</a>
        <a href='/gallery/cableholder?tag=1人' class='tag-name' target="_blank">1人</a>
        <a href='/gallery/cableholder?tag=複数人' class='tag-name' target="_blank">複数人</a>
      </div>
      <div class="ex-row">
        <div class="gall_pro">
          <div class="gallbox">
            <div class="prodate">2017年8月ご注文</div>
            <a href="/gallery/img-cable/cable-110121-1a.webp" data-lightbox="img-set-01" data-title="2017年8月" style="text-decoration:none;">
              <img src="/gallery/img-cable/cable-110121-1a.webp" class="picpro" width="229" height="229"><br />
              <div class="camera-left" style="font-size: 10px;">📷クリックすると拡大します</div>
            </a>
            <a href="/gallery/img-cable/cable-110121-1b.webp" data-lightbox="img-set-01" data-title="2017年8月" style="text-decoration:none;"></a>
            <a href="/gallery/img-cable/cable-110121-1c.webp" data-lightbox="img-set-01" data-title="2017年8月" style="text-decoration:none;"></a>
          </div>
          <div class="gallbox">
            <div class="prodate">2017年9月ご注文</div>
            <a href="/gallery/img-cable/cable-110121-2a.webp" data-lightbox="img-set-02" data-title="2017年9月" style="text-decoration:none;">
              <img src="/gallery/img-cable/cable-110121-2a.webp" class="picpro" width="229" height="229"><br />
              <div class="camera-left" style="font-size: 10px;">📷クリックすると拡大します</div>
            </a>
            <a href="/gallery/img-cable/cable-110121-2b.webp" data-lightbox="img-set-02" data-title="2017年9月" style="text-decoration:none;"></a>
            <a href="/gallery/img-cable/cable-110121-2c.webp" data-lightbox="img-set-02" data-title="2017年9月" style="text-decoration:none;"></a>
          </div>
          <div class="gallbox">
            <div class="prodate">2017年4月ご注文</div>
            <a href="/gallery/img-cable/cable-110121-3a.webp" data-lightbox="img-set-03" data-title="2017年4月" style="text-decoration:none;">
              <img src="/gallery/img-cable/cable-110121-3a.webp" class="picpro" width="229" height="229"><br />
              <div class="camera-left" style="font-size: 10px;">📷クリックすると拡大します</div>
            </a>
            <a href="/gallery/img-cable/cable-110121-3b.webp" data-lightbox="img-set-03" data-title="2017年4月" style="text-decoration:none;"></a>
            <a href="/gallery/img-cable/cable-110121-3c.webp" data-lightbox="img-set-03" data-title="2017年4月" style="text-decoration:none;"></a>
          </div>
          <div class="gallbox">
            <div class="prodate">2018年10月ご注文</div>
            <a href="/gallery/img-cable/cable-110121-4a.webp" data-lightbox="img-set-04" data-title="2018年10月" style="text-decoration:none;">
              <img src="/gallery/img-cable/cable-110121-4a.webp" class="picpro" width="229" height="229"><br />
              <div class="camera-left" style="font-size: 10px;">📷クリックすると拡大します</div>
            </a>
            <a href="/gallery/img-cable/cable-110121-4b.webp" data-lightbox="img-set-04" data-title="2018年10月" style="text-decoration:none;"></a>
            <a href="/gallery/img-cable/cable-110121-4c.webp" data-lightbox="img-set-04" data-title="2018年10月" style="text-decoration:none;"></a>
          </div>
        </div>
        <div style="text-align: center; margin: 15px auto 0;" class="">
          <button class="but3"><a href="/gallery/rubberkeyholder" style="text-decoration: none; color: black; font-size: 16px; padding: 10px 40px;" class="">もっと製作事例を見る <i class="fas fa-arrow-circle-right"></i></a></button>
        </div>
      </div>
      <div style="clear: both;">&nbsp;</div>
      <h2>ケーブル挿入用の溝</h2>
      <p class="d_TEXT1 new-text">
        規定の溝の大きさを推奨。<a href="download/download.php?fname=template-ear phone-final.rar">デザインテンプレート</a>で確認してください。溝の大きさが表面と裏面で若干異なってしまいます。詳細は<a href="//hotmobily.jp/howtodesign/#option">貫通部分</a>についての注意をお読みください。
      </p>
      <p align="center"><img src="images/earphone_04_1.webp" width="100%" height="188" style="max-width: 500px;"></p>
      <h2>ラバーイヤホンホルダーの用途</h2>
      <p class="d_TEXT1 new-text">
        販促アイテムとしてはやや特殊なイヤホンケーブルホルダーですが、音楽関連業界でのノベルティーとして採用頂いております。
        お客様の都合上、ほとんどの製品は非公開扱いです。製作実績として公開できる製品が少ないこと、ご勘弁ください。
      </p>
      <h2><?= lang('ラバーイヤホンホルダーの製作工程のご紹介') ?></h2>
      ...
      <!-- <div>
        ...
        <table class="table_rubber" cellpadding="5" cellspacing="0">
          <tbody>
            <tr>
              <td><?= lang('名称') ?></td>
              <td><?= lang('ラバーイヤホンホルダー') ?></td>
            </tr>
            <tr>
              <td><?= lang('素材') ?></td>
              <td><?= lang('ATBC-PVC（非フタル酸エステル系）のPVC(塩ビ)。熱や経年劣化による変形や変色が少なく、PVC特有のゴムの臭いが少ない材料。詳細は') ?><a href="/products/foodproducts.php?data=cableholder" target="_blank">こちら</a>。</td>
            </tr>
            <tr>
              <td><?= lang('大きさ') ?></td>
      ...
      <div class="flex-container">
        ...
        <a href="/products/new-template/template-ear phone-final_20260324.zip" class="resource-button" style="color: #233c4a">
        ...
        <a href="/contact/?item=ラバーイヤホンホルダー" class="resource-button" style="color: #233c4a">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
      ...
      <div class="font_s" style="text-align: right;">
        ※<?= lang('プレミアムの料金表です。') ?><br />
        ※<?= lang('上記価格は税込み価格です。') ?><br />
        ※<?= lang('プレミアムでは、試作品、シルク印刷、トレース代金は無料です。') ?><br />
      </div>
      <div style="clear: both;">&nbsp;</div>
      <hr />
      ...
      <div style="text-align:center;"><a class="img-hover" href="/products/foodproducts.php?data=cableholder" target="_blank"><img class="lazy" data-src="/img/safety-banner.webp" width="745" height="70"></a></div>
      <div style="clear:both;">&nbsp;</div>
      ...
      <div style="overflow: unset!important;">
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="ラバーイヤホンホルダー" />
          </div>
          <?php
          switch ($ItemPCS) {
            case "スタンダード":
          ...
          <div class="estimate-content" id="step1">
            ...
            <div class="part-container">
              ...
              <font color="red">※プレミアムはシルク印刷代金が無料</font>
            </div>
                ...
                <tr id="">
                  <td colspan="2" style="background: unset;border: unset;">
                    <div class="flex-container btn-container">
                      ...
                      <a href="javascript:void(0)" class="btn btn-back" onclick="valid_chk_btn2('step1');$('#cus_detail').hide();">製作条件修正</a>
                      <a href="javascript:void(0)" class="btn btn-back" onclick="valid_chk_btn2('step2');$('#cus_detail').hide();">オプション修正</a>
          ...
          <div id="acrylic-btn" class="btn-container">
            <a href="javascript:void(0)" id="back" class="btn btn-back" onclick="valid_chk_btn2('back')">戻る</a>
            <a href="javascript:void(0)" id="next" class="btn btn-next" onclick="valid_chk_btn2('next')">オプション入力へ</a>
          </div>
        </form>
      ...
      <hr>
      <?php $fd_type = "cableholder";
      $favor = "cableholder";
      include '../rubber_product_detail_test.php'; ?>
      <h2>営業担当が直接御社にお伺いし、製品やサービスのご提案・ご説明をさせて頂きます。</h2>
      <center><a href="//hotmobily.jp/meeting_date/"><img src="../../img/btn_meetingdate_1.webp" title="ノベルティー営業担当呼び出しフォーム" width="100%" height="82" /></a></center><br />
    </div>
    <!-- :: content_wrapper end :: -->
  </div>
  <!-- :: wrapper end :: -->
...
--------------------------------------------------->
  ...
  <script type="text/javascript" src="/js/_setToInput_2026.js?e=<?php echo date('is') ?>"></script>
