...
<head>
  ...
  <meta name="keywords" content="<?= lang('キーホルダー,刺繍,刺繍キーホルダー,製作,デザイン,制作,名入れ,オリジナル') ?>">
  <meta name="description" content="<?= lang('刺繍キーホルダーをオリジナルデザインで製作できます。名入れ可能な完全オーダーメイド。細かいデザインでも安価に制作可能です。最短15営業日出荷の短納期。50枚からご注文いただけます。') ?>">
  <meta name="robots" content="index,follow">
  <title><?= lang('オリジナル刺繍キーホルダーの製作　50個から') ?></title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1><?= lang('オリジナル刺繍キーホルダーの製作　50枚から') ?></h1>
          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_01" src="images/flight_tag/K_-01.webp" data-zoom-image="images/flight_tag/K_-01-L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_02" src="images/flight_tag/K_-02.webp" data-zoom-image="images/flight_tag/K_-02-L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_03" src="images/flight_tag/K_-03.webp" data-zoom-image="images/flight_tag/K_-03-L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_04" src="images/flight_tag/K_-04.webp" data-zoom-image="images/flight_tag/K_-04-L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
            </div>
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="images/flight_tag/K_-01.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="images/flight_tag/K_-02.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="images/flight_tag/K_-03.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="images/flight_tag/K_-04.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
        ...
        <div class="flex-item item">
          <table class="table_rubber" style="padding: 0 ;">
            ...
            <tr>
              ...
              <td class="">デザインあり・デザインなし（クレジット印字・加工なし）</td>
            </tr>
            <tr>
      ...
      <p>
        刺繍キーホルダーをオリジナルデザインで製作できます。社名やロゴ、オリジナルイラストを入れて、ノベルティやイベントグッズとしてもご活用いただけます。最短15営業日出荷の短納期、50枚からご注文いただけます。
      </p>
      <div>&nbsp;</div>
      <p>
        刺繍とジャガード織から選べる、名入れ可能な完全オーダーメイドです。裏面も表面と同じようにデザインすることが可能です。また、クレジット表記などを1色で印字することもできます。
      </p>
      <div>&nbsp;</div>
      ...
      <div class="d-flex">
        ...
        <div class="flex-item">
          <a href="images/flight_tag/K_-06.webp?v=1.01" data-lightbox="sample_1_2" data-title="" style="text-decoration:none;">
            <img class="lazy" data-src="images/flight_tag/K_-06.webp?v=1.01">
            <div class="plus"><i class="fas fa-search-plus"></i></div>
          </a>
          <h3>▲ジャガード織事例</h3>
        </div>
      ...
      <p>
        刺繍の場合、少し光沢のあるツイル生地と、暖かみのあるフェルト生地をお選びいただけます。生地色は、表と裏それぞれ22色からお選びください。その他の色も、ご希望の色に合わせてお選びいただけます。刺繍糸色は、お客様のデザインをもとに工場にて選定した色を使用いたします。（基本8色までとなっております）
      </p>
      <div>&nbsp;</div>
      ...
      <h2 class="feature3">フチ加工や裏面加工も選択肢豊富</h2>
      <p>
        フチ加工は、オーバーロック仕上げとヒートカット仕上げからお選びいただけます。裏面は、表面と同様に刺繍やジャガード織でデザインを入れることはもちろん、1色でクレジット表記などを印字することもできます。
      </p>
      <div>&nbsp;</div>
      <div class="d-flex">
        <div class="flex-item">
      ...
      <div class="">
        <table class="table-border">
          ...
          <tr>
            <td>フチ加工</td>
            <td>オーバーロック仕上げ・ヒートカット仕上げ</td>
          </tr>
          <tr>
            <td>裏面加工</td>
            <td>
              デザインあり・デザインなし（クレジット印字・加工なし）
            </td>
          </tr>
          <tr>
            <td>アタッチメント</td>
          ...
          <tr>
            <td>試作品</td>
            <td>5,500円（税込）<br />但し、300個以上ご注文の場合は無料になります。</td>
          </tr>
          <tr>
            <td>包装</td>
            <td>
      ...
      <div>&nbsp;</div>
      <img class="lazy" data-src="images/flight_tag/keyholder_patch_size.webp?v=1.00" style="width:100%;">

      <h2 class="toggle-header"><?= lang('フチ加工・裏面加工') ?><span>+</span></h2>
      <div class="toggle-container">
        ...
        <div>&nbsp;</div>
        <p>裏面は、表面と同様に刺繍やジャガード織でデザインを入れることはもちろん、クレジット表記などを1色で印字することも可能です。</p>
        <div>&nbsp;</div>
        <div class="d-flex">
          <div class="flex-item">
            <a href="images/flight_tag/K_-08.webp?v=1.01" data-lightbox="sample_3_1" data-title="" style="text-decoration:none;">
              <img class="lazy" data-src="images/flight_tag/K_-08.webp?v=1.01">
              <div class="plus"><i class="fas fa-search-plus"></i></div>
            </a>
          </div>
          <div class="flex-item">
            <a href="images/flight_tag/K_-12.webp?v=1.01" data-lightbox="sample_3_2" data-title="" style="text-decoration:none;">
              <img class="lazy" data-src="images/flight_tag/K_-12.webp?v=1.01">
              <div class="plus"><i class="fas fa-search-plus"></i></div>
            </a>
          </div>
        </div>
      ...
      <div class="toggle-container">
        <p>アタッチメントは種類豊富。一部、有料のものもございます。</p>
        <div class="">
        ...
        <p>アタッチメントの取り付け部分は、ハトメ方式とタグベルト方式からお選びいただけます。</p>
        <div>&nbsp;</div>
        <div class="d-flex">
          <div class="flex-item">
            <a href="images/flight_tag/K_-10.webp?v=1.01" data-lightbox="sample_4_1" data-title="" style="text-decoration:none;">
              <img class="lazy" data-src="images/flight_tag/K_-10.webp?v=1.01">
              <div class="plus"><i class="fas fa-search-plus"></i></div>
            </a>
            <h3>▲ハトメ方式</h3>
          </div>
          <div class="flex-item">
            <a href="images/flight_tag/K_-11.webp?v=1.01" data-lightbox="sample_4_2" data-title="" style="text-decoration:none;">
              <img class="lazy" data-src="images/flight_tag/K_-11.webp?v=1.01">
              <div class="plus"><i class="fas fa-search-plus"></i></div>
            </a>
            <h3>▲タグベルト方式</h3>
          </div>
      ...
      <div class="toggle-container">
        <div class="flex-container justify-between">
          <a class="btn-a btn-yellow download_temp" href="download/download?fname=template-flighttag_20231214.zip">
            <span>刺繍キーホルダー</span>
          </a>
        </div>
      </div>
            ...
            <?php for ($i = 5; $i <= 30; $i++) : ?>
              <tr>
                ...
                <?php foreach ($prices as $key => $price) : ?>
                  <td data-size="<?= $i ?>" data-qty="<?= $key ?>" data-side="1" onclick="pre_set(this);"><?= floor(($price + (15 * ($i - 5))) * 1.1) ?></td>
                <?php endforeach; ?>
              </tr>
            <?php endfor; ?>
          </tbody>
          ...
          <tbody>
            <?php for ($i = 5; $i <= 30; $i++) : ?>
              <tr>
                <td><?= $i ?></td>
                <?php foreach ($prices as $key => $price) : ?>
                  <td data-size="<?= $i ?>" data-qty="<?= $key ?>" data-side="0" onclick="pre_set(this);"><?= floor(((floor($price) + (15 * ($i - 5))) * 1.4) * 1.1) ?></td>
                <?php endforeach; ?>
              </tr>
            <?php endfor; ?>
          </tbody>
      ...
      <div style="overflow: unset!important;">
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="刺繍キーホルダー" />
          </div>
          <?php
          switch ($ft_type) {
            case '刺繍':
          ...
          <div class="estimate-content" id="step1">
                ...
                <div class="preview-sub flex-container strap-color">
                  <div class="normal_c">
                    <div class="show_c">
                      ...
                      <span id="txt-show-Insatsu2"></span>
                    </div>
                    <div class="choose_c">
                      <table>
                        <tbody>
                          <tr>
                            <td>
                              <input type="radio" id="2-0" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T184（赤色）' : '108（赤色）') ?>" <?= ($ft_fabric_color2 == '108（赤色）' || $ft_fabric_color2 == 'T184（赤色）' ? 'checked' : ($ft_fabric_color2 == '' ? 'checked' : '')) ?>>
                              <label for="2-0"><img src="images/flight_tag/icon-01.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-1" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T223（緑色）' : '63（緑）') ?>" <?= ($ft_fabric_color2 == '63（緑）' || $ft_fabric_color2 == 'T223（緑色）' ? 'checked' : "") ?>>
                              <label for="2-1"><img src="images/flight_tag/icon-02.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-2" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T47（紺藍）' : '83（紺藍）') ?>" <?= ($ft_fabric_color2 == '83（紺藍）' || $ft_fabric_color2 == 'T47（紺藍）' ? 'checked' : "") ?>>
                              <label for="2-2"><img src="images/flight_tag/icon-03.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-3" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T244（紅赤）' : '76（紅赤）') ?>" <?= ($ft_fabric_color2 == 'T244（紅赤）' || $ft_fabric_color2 == 'T244（紅赤）' ? 'checked' : "") ?>>
                              <label for="2-3"><img src="images/flight_tag/icon-04.webp"></label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <input type="radio" id="2-4" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T142（オレンジ色）' : '30（オレンジ色）') ?>" <?= ($ft_fabric_color2 == '30（オレンジ色）' || $ft_fabric_color2 == 'T142（オレンジ色）'   ? 'checked' : "") ?>>
                              <label for="2-4"><img src="images/flight_tag/icon-05.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-5" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T95（えんじ）' : '131（えんじ）') ?>" <?= ($ft_fabric_color2 == '131（えんじ）' || $ft_fabric_color2 == 'T95（えんじ）' ? 'checked' : "") ?>>
                              <label for="2-5"><img src="images/flight_tag/icon-06.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-6" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T202（藤紫）' : '78（藤紫）') ?>" <?= ($ft_fabric_color2 == '78（藤紫）' || $ft_fabric_color2 == 'T202（藤紫）' ? 'checked' : "") ?>>
                              <label for="2-6"><img src="images/flight_tag/icon-07.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-7" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T258（紫色）' : '74（紫色）') ?>" <?= ($ft_fabric_color2 == '74（紫色）' || $ft_fabric_color2 == 'T258（紫色）' ? 'checked' : "") ?>>
                              <label for="2-7"><img src="images/flight_tag/icon-08.webp"></label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <input type="radio" id="2-8" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T214（山吹色）' : '135（山吹色）') ?>" <?= ($ft_fabric_color2 == '135（山吹色）' || $ft_fabric_color2 == 'T214（山吹色）' ? 'checked' : "") ?>>
                              <label for="2-8"><img src="images/flight_tag/icon-09.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-9" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T54（黄色）' : '32（黄色）') ?>" <?= ($ft_fabric_color2 == '32（黄色）' || $ft_fabric_color2 == 'T54（黄色）' ? 'checked' : "") ?>>
                              <label for="2-9"><img src="images/flight_tag/icon-10.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-10" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T122（ピンク）' : '9（ピンク）') ?>" <?= ($ft_fabric_color2 == '9（ピンク）' || $ft_fabric_color2 == 'T122（ピンク）' ? 'checked' : "") ?>>
                              <label for="2-10"><img src="images/flight_tag/icon-11.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-11" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T219（茶色）' : '94（茶色）') ?>" <?= ($ft_fabric_color2 == '94（茶色）' || $ft_fabric_color2 == 'T219（茶色）' ? 'checked' : "") ?>>
                              <label for="2-11"><img src="images/flight_tag/icon-12.webp"></label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <input type="radio" id="2-12" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T24（黄緑色）' : '35（黄緑色）') ?>" <?= ($ft_fabric_color2 == '35（黄緑色）' || $ft_fabric_color2 == 'T24（黄緑色）' ? 'checked' : "") ?>>
                              <label for="2-12"><img src="images/flight_tag/icon-13.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-13" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T218（ビリジアン）' : '66（ビリジアン）') ?>" <?= ($ft_fabric_color2 == '66（ビリジアン）' || $ft_fabric_color2 == 'T218（ビリジアン）' ? 'checked' : "") ?>>
                              <label for="2-13"><img src="images/flight_tag/icon-14.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-14" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T32（スカイブルー）' : '46（スカイブルー）') ?>" <?= ($ft_fabric_color2 == '46（スカイブルー）' || $ft_fabric_color2 == 'T32（スカイブルー）' ? 'checked' : "") ?>>
                              <label for="2-14"><img src="images/flight_tag/icon-15.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-15" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T37（青色）' : '52（青色）') ?>" <?= ($ft_fabric_color2 == '52（青色）' || $ft_fabric_color2 == 'T37（青色）' ? 'checked' : "") ?>>
                              <label for="2-15"><img src="images/flight_tag/icon-16.webp"></label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <input type="radio" id="2-16" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T198（牡丹色）' : '12（牡丹色）') ?>" <?= ($ft_fabric_color2 == '12（牡丹色）' || $ft_fabric_color2 == 'T198（牡丹色）' ? 'checked' : "") ?>>
                              <label for="2-16"><img src="images/flight_tag/icon-17.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-17" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T256（灰色）' : '129（灰色）') ?>" <?= ($ft_fabric_color2 == '129（灰色）' || $ft_fabric_color2 == 'T256（灰色）' ? 'checked' : "") ?>>
                              <label for="2-17"><img src="images/flight_tag/icon-18.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-18" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? '1.2mmBLACA（黒色）' : '123（黒色）') ?>" <?= ($ft_fabric_color2 == '123（黒色）' || $ft_fabric_color2 == '1.2mmBLACA（黒色）' ? 'checked' : "") ?>>
                              <label for="2-18"><img src="images/flight_tag/icon-19.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="2-19" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T01B（白）' : '1（白）') ?>" <?= ($ft_fabric_color2 == '1（白）' || $ft_fabric_color2 == 'T01B（白）' ? 'checked' : "") ?>>
                              <label for="2-19"><img src="images/flight_tag/icon-20.webp"></label>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <input type="radio" id="2-20" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T199（ネイビー）' : '88（ネイビー）') ?>" <?= ($ft_fabric_color2 == '88（ネイビー）' || $ft_fabric_color2 == 'T199（ネイビー）' ? 'checked' : "") ?>>
                              <label for="2-20"><img src="images/flight_tag/icon-21.webp"></label>
                            </td>
                            <td>
                              <input type="radio" id="21" class="STD_printing_color2" name="ft_fabric_color2" value="<?= ($ft_option == "フェルト生地" ? 'T108（ダークブルー）' : '126（ダークブルー）') ?>" <?= ($ft_fabric_color2 == '126（ダークブルー）' || $ft_fabric_color2 == 'T108（ダークブルー）' ? 'checked' : "") ?>>
                              <label for="2-21"><img src="images/flight_tag/icon-22.webp"></label>
                            </td>
                            <td>
            ...
            <div class="part-container">
              <div class="part-content">
                <label class="part-name"><input type="radio" name="ft_backside" value="デザインあり" onclick="check_val('next')" <?= ($ft_backside == "" ? "checked" : ($ft_backside == "デザインあり" ? "checked" : "")) ?>><?= lang('デザインあり') ?> <span class="checkmark"></span></label>
              </div>
              <div class="part-content">
                <label class="part-name"><input type="radio" name="ft_backside" value="デザインなし" onclick="check_val('next')" <?= ($ft_backside == "デザインなし" ? "checked" : "") ?>><?= lang('デザインなし') ?> <span class="checkmark"></span></label>
              </div>

              <div class="part-content prd-selection no-designs">
                <label class="part-name ">
                  <select name="ft_backside_type" onchange="check_val('next')">
          ...
          <div class="estimate-content" id="step2">
            ...
            <div class="flex-container">
              <div class="preview-container">
                <div class="preview-sub flex-container">
                  <?php
                  include('part_flight_tag_keyholder.php');
                  $i = 0;
            ...
            <h3><?= lang('アタッチメント取り付け部分') ?></h3>
            <div class="part-container">
              <div class="part-content">
                <label class="part-name p-normal"><input type="radio" name="ft_attach_type" value="ハトメ方式" onclick="check_val('next')" <?= ($ft_attach_type == "" ? "checked" : ($ft_attach_type == "ハトメ方式" ? "checked" : "")) ?>><?= lang('ハトメ方式') ?> <span class="checkmark"></span></label>
              </div>
              <div class="part-content">
                <label class="part-name p-normal"><input type="radio" name="ft_attach_type" value="タグベルト方式" onclick="check_val('next')" <?= ($ft_attach_type == "タグベルト方式" ? "checked" : "") ?>><?= lang('タグベルト方式') ?> <span class="checkmark"></span></label>
              </div>
            </div>
                ...
                <table class="table_rubber total_price_tbl">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class=""><input id="delivery_price" type="text" name="delivery_price" readonly value="0">円</td>
                    </tr>
                    <tr>
      ...
      <hr>
      <h2 class="toggle-header"><?= lang('刺繍キーホルダーに関するFAQ') ?><span>+</span></h2>
      <div class="toggle-container">
        ...
        <p>【変更について】</p>
        <p>
          ご注文確定前でしたら、ご注文の取消（キャンセル）が可能です。<br />
          ご入金が完了している場合、かかった費用を差し引いて、ご指定の銀行口座にご返金致します。<br />
          ご注文確定後かつ量産開始前の場合は、キャンセル料がかかります。<br />
          ご注文確定後かつ量産開始後は、誠に申し訳ございませんが、ご注文の取消（キャンセル）をお受けできません。
        </p>
        <p>【変更について】</p>
  ...
  <script language="JavaScript" src="/js/calculater_ftc.js?v=<?php echo date('is') ?>" type="text/javascript"></script>
