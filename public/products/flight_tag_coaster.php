...
<head>
  ...
  <meta name="keywords" content="<?= lang('コースター,刺繍,刺繍コースター,製作,デザイン,制作,名入れ,オリジナルコースター') ?>">
  <meta name="description" content="<?= lang('オリジナルコースターを刺繍デザインで製作できます。名入れ可能な完全オーダーメイド。細かいデザインでも安価に制作可能です。最短15営業日出荷の短納期。50枚からご注文いただけます。') ?>">
  <meta name="robots" content="index,follow">
  <title><?= lang('オリジナル刺繍コースターの製作　50枚から') ?></title>
...
<body id="top">
  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <h1><?= lang('オリジナル刺繍コースターの製作　50枚から') ?></h1>
          ...
          <div class="preview-container">
            <div class="preview-top my-gallery">
              <div id="box-show-id-1">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_01" src="images/flight_tag/ft_coaster_01_S.webp?v=1.01" data-zoom-image="images/flight_tag/ft_coaster_01_L.webp?v=1.01" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-2">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_02" src="images/flight_tag/ft_coaster_02_S.webp" data-zoom-image="images/flight_tag/ft_coaster_02_L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-3">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_03" src="images/flight_tag/ft_coaster_03_S.webp" data-zoom-image="images/flight_tag/ft_coaster_03_L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
              <div id="box-show-id-4">
                <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                  <a href="javascript:void(0)" itemprop="contentUrl" data-size="1365x840">
                    <img class="zoom-img" id="zoom_04" src="images/flight_tag/ft_coaster_04_S.webp" data-zoom-image="images/flight_tag/ft_coaster_04_L.webp" width="376" height="231" itemprop="thumbnail">
                  </a>
                </figure>
              </div>
            </div>
            <div class="preview-sub flex-container">
              <div class="flex-item"><img src="images/flight_tag/ft_coaster_01_S.webp?v=1.01" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-1').show();">
              </div>
              <div class="flex-item"><img src="images/flight_tag/ft_coaster_02_S.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-2').show();">
              </div>
              <div class="flex-item"><img src="images/flight_tag/ft_coaster_03_S.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-3').show();">
              </div>
              <div class="flex-item"><img src="images/flight_tag/ft_coaster_04_S.webp" onclick="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();" onmouseover="$('.preview-top div').each(function(){$(this).hide()});$('#box-show-id-4').show();">
              </div>
            </div>
          </div>
        ...
        <div class="flex-item item">
          <table class="table_rubber" style="padding: 0 ;">
            <tr>
              ...
              <td class=""><?= lang('刺繍コースター') ?></td>
            </tr>
            <tr>
              <td class="TableLeft"><?= lang('サイズ') ?></td>
              <td class="">90mm×90mm以内（このサイズを超える場合はご相談ください）</td>
            </tr>
            <tr>
      ...
      <p>
        オリジナルコースターを、高級感あふれる刺繍デザインで製作できます。社名やロゴ、オリジナルイラストを入れて、飲食店のオリジナルグッズやイベントのノベルティ等としてご活用いただけます。最短15営業日出荷の短納期、50枚からご注文いただけます。
      </p>
      <div>&nbsp;</div>
      <p>
        刺繍とジャガード織から選べる、名入れ可能な完全オーダーメイド。紙コースターと異なり、繰り返し使えるためエコで経済的な製品です。
      </p>
      <div>&nbsp;</div>
      ...
      <div class="d-flex">
        ...
        <div class="flex-item">
          <a href="images/flight_tag/ft_badge_09.webp?v=1.01" data-lightbox="sample_1_2" data-title="" style="text-decoration:none;">
            <img class="lazy" data-src="images/flight_tag/ft_badge_09.webp?v=1.01">
            <div class="plus"><i class="fas fa-search-plus"></i></div>
          </a>
          <h3>▲ジャガード織事例</h3>
        </div>
      ...
      <div class="d-flex">
        <div class="flex-item">
          <a href="/products/images/wappen_overlock.webp?v=1.01" data-lightbox="sample_3_1" data-title="" style="text-decoration:none;">
      ...
      <div class="">
        <table class="table-border">
          ...
          <tr>
            <td>サイズ</td>
            <td>
              <p>90mm×90mm以内（このサイズを超える場合はご相談ください）</p>
            </td>
          </tr>
          <tr>
            <td>印刷加工</td>
      ...
      <div class="toggle-container">
        ...
        <div class="d-flex">
          <div class="flex-item">
            <a href="images/flight_tag/ft_coaster_05.webp?v=1.01" data-lightbox="sample_1_1" data-title="" style="text-decoration:none;">
              <img class="lazy" data-src="images/flight_tag/ft_coaster_05.webp?v=1.01">
              <div class="plus"><i class="fas fa-search-plus"></i></div>
            </a>
          </div>
          <div class="flex-item">
            <a href="images/flight_tag/ft_coaster_06.webp?v=1.01" data-lightbox="sample_1_2" data-title="" style="text-decoration:none;">
              <img class="lazy" data-src="images/flight_tag/ft_coaster_06.webp?v=1.01">
              <div class="plus"><i class="fas fa-search-plus"></i></div>
            </a>
          </div>
        </div>
      ...
      <div class="toggle-container">
        <div class="flex-container justify-between">
          <a class="btn-a btn-yellow download_temp" href="download/download?fname=template-flighttag-coaster_20231215.zip">
            <span>刺繍コースター</span>
          </a>
        </div>
      </div>
      ...
      <div style="overflow: unset!important;">
        ...
        <form action="" method="post" name="form" id="form" enctype="multipart/form-data">
          <div style="display: table-column;">
            <input type="text" name="ItemType" id="strap" value="刺繍コースター" />
          </div>
          <?php
          switch ($ft_type) {
            case '刺繍':
      ...
      <hr>
      <h2 class="toggle-header"><?= lang('刺繍コースターに関するFAQ') ?><span>+</span></h2>
      <div class="toggle-container">
