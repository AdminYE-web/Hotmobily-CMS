  ...
  <div id="wrapper">
    ...
    <div id="content_wrapper">
      ...
      <div class="social-time">
        ...
        <span class="time-content"><?= lang('更新日') ?> 2026年1月5日</span>
      </div>
        ...
        <div class="new-text">
            ...
            <table width="100%" class="tb-w12 txt-center" border-solid="1" bordercolor="#cccccc" border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="A2サイズ">2,089</td>
                        <td data-label="B2サイズ">2,173</td>
                    </tr>
                    <tr>
                        <td data-label="数量" style="background-color: #f0f0f0;">200</td>
                        <td data-label="A2サイズ">1,976</td>
                        <td data-label="B2サイズ">2,087</td>
                    </tr>
                    <tr>
                        <td data-label="数量" style="background-color: #f0f0f0;">300</td>
                        <td data-label="A2サイズ">1,878</td>
                        <td data-label="B2サイズ">2,010</td>
                    </tr>
                    <tr>
                        <td data-label="数量" style="background-color: #f0f0f0;">500</td>
                        <td data-label="A2サイズ">1,789</td>
                        <td data-label="B2サイズ">1,921</td>
                    </tr>
                    <tr>
                        <td data-label="数量" style="background-color: #f0f0f0;">1000</td>
                        <td data-label="A2サイズ">1,700</td>
                        <td data-label="B2サイズ">1,833</td>
                    </tr>
                    <tr>
                        <td data-label="数量" style="background-color: #f0f0f0;">2000</td>
                        <td data-label="A2サイズ">1,620</td>
                        <td data-label="B2サイズ">1,758</td>
                    </tr>
                </tbody>
            </table>
            <br>
            ...
            <br>
            <p class="new-text">最小ロットは100個です。また、当Webページの注文フォームから注文可能な最大数量は2,000個となっております。2,000個を超える個数のご注文をご希望の方は、個別にお問い合わせください。</p>
        </div>
...
-->
  <!-- Swiper JS -->
  <script type="text/javascript" src="/js/calculater_tumbler.js?v=<?php echo date('is') ?>"></script>
